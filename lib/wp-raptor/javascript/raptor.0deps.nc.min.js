...
*/
window.rangy=function(){function m(a,c){var d=typeof a[c];return d==b||!!(d==g&&a[c])||"unknown"==d}function w(a,b){return!!(typeof a[b]==g&&a[b])}function a(a,b){return typeof a[b]!=k}function c(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function d(a){return a&&r(a,p)&&x(a,n)}function f(a){window.alert("Rangy not supported in your browser. Reason: "+a);q.initialized=!0;q.supported=!1}function e(){if(!q.initialized){var a,b=!1,c=!1;m(document,"createRange")&&
(a=document.createRange(),r(a,o)&&x(a,l)&&(b=!0),a.detach());if((a=w(document,"body")?document.body:document.getElementsByTagName("body")[0])&&m(a,"createTextRange"))a=a.createTextRange(),d(a)&&(c=!0);!b&&!c&&f("Neither Range nor TextRange are implemented");q.initialized=!0;q.features={implementsDomRange:b,implementsTextRange:c};b=A.concat(B);c=0;for(a=b.length;c<a;++c)try{b[c](q)}catch(g){w(window,"console")&&m(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
g)}}}function h(a){this.name=a;this.supported=this.initialized=!1}var g="object",b="function",k="undefined",l="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),o="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
n="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),p="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),r=c(m),s=c(w),x=c(a),q={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:m,isHostObject:w,isHostProperty:a,areHostMethods:r,areHostObjects:s,areHostProperties:x,isTextRange:d},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
q.fail=f;q.warn=function(a){a="Rangy warning: "+a;q.config.alertOnWarn?window.alert(a):typeof window.console!=k&&typeof window.console.log!=k&&window.console.log(a)};({}).hasOwnProperty?q.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:f("hasOwnProperty not supported");var B=[],A=[];q.init=e;q.addInitListener=function(a){q.initialized?a(q):B.push(a)};var C=[];q.addCreateMissingNativeApiListener=function(a){C.push(a)};q.createMissingNativeApi=function(a){a=a||window;e();
for(var b=0,c=C.length;b<c;++b)C[b](a)};h.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};h.prototype.warn=function(a){q.warn("Module "+this.name+": "+a)};h.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};q.createModule=function(a,b){var c=new h(a);q.modules[a]=c;A.push(function(a){b(a,c);c.initialized=!0;c.supported=!0})};q.requireModules=function(a){for(var b=0,c=a.length,d,g;b<
c;++b){g=a[b];d=q.modules[g];if(!d||!(d instanceof h))throw Error("Module '"+g+"' not found");if(!d.supported)throw Error("Module '"+g+"' not supported");}};var E=!1,s=function(){E||(E=!0,q.initialized||e())};if(typeof window==k)f("No window found");else if(typeof document==k)f("No document found");else return m(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),m(window,"addEventListener")?window.addEventListener("load",s,!1):m(window,"attachEvent")?window.attachEvent("onload",
s):f("Window does not have required addEventListener or attachEvent method"),q}();
rangy.createModule("DomUtil",function(m,w){function a(a){for(var b=0;a=a.previousSibling;)b++;return b}function c(a,b){var c=[],d;for(d=a;d;d=d.parentNode)c.push(d);for(d=b;d;d=d.parentNode)if(r(c,d))return d;return null}function d(a,b,c){for(c=c?a:a.parentNode;c;){a=c.parentNode;if(a===b)return c;c=a}return null}function f(a){a=a.nodeType;return 3==a||4==a||8==a}function e(a,b){var c=b.nextSibling,d=b.parentNode;c?d.insertBefore(a,c):d.appendChild(a);return a}function h(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=o)return a.ownerDocument;if(typeof a.document!=o)return a.document;if(a.parentNode)return h(a.parentNode);throw Error("getDocument: no document found for node");}function g(a){return!a?"[No node]":f(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function b(a){this._next=this.root=a}function k(a,b){this.node=a;this.offset=b}function l(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var o="undefined",n=m.util;n.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||w.fail("document missing a Node creation method");n.isHostMethod(document,"getElementsByTagName")||w.fail("document missing getElementsByTagName method");var p=document.createElement("div");n.areHostMethods(p,["insertBefore","appendChild","cloneNode"])||w.fail("Incomplete Element implementation");n.isHostProperty(p,"innerHTML")||w.fail("Element is missing innerHTML property");p=document.createTextNode("test");
n.areHostMethods(p,["splitText","deleteData","insertData","appendData","cloneNode"])||w.fail("Incomplete Text Node implementation");var r=function(a,b){for(var c=a.length;c--;)if(a[c]===b)return!0;return!1};b.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,b;if(this._current){b=a.firstChild;if(!b)for(b=null;a!==this.root&&!(b=a.nextSibling);)a=a.parentNode;this._next=b}return this._current},detach:function(){this._current=this._next=this.root=
null}};k.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+g(this.node)+":"+this.offset+")]"}};l.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};l.prototype.toString=function(){return this.message};m.dom={arrayContains:r,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==o||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:a,getNodeLength:function(a){var b;return f(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:c,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:d,isCharacterDataNode:f,insertAfter:e,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);e(c,a);return c},getDocument:h,getWindow:function(a){a=h(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return n.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(b,g,e,f){var k;if(b==e)return g===f?0:g<f?-1:1;if(k=d(e,b,!0))return g<=a(k)?-1:1;if(k=d(b,e,!0))return a(k)<f?-1:1;g=c(b,e);b=b===g?g:d(b,g,!0);e=e===g?g:d(e,g,!0);if(b===e)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(g=g.firstChild;g;){if(g===b)return-1;if(g===e)return 1;g=g.nextSibling}throw Error("Should not be here!");},inspectNode:g,fragmentFromNodeChildren:function(a){for(var b=h(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new b(a)},DomPosition:k};m.DOMException=l});
rangy.createModule("DomRange",function(m){function w(a,b){return 3!=a.nodeType&&(t.isAncestorOf(a,b.startContainer,!0)||t.isAncestorOf(a,b.endContainer,!0))}function a(a){return t.getDocument(a.startContainer)}function c(a,b,c){if(b=a._listeners[b])for(var d=0,j=b.length;d<j;++d)b[d].call(a,{target:a,args:c})}function d(a){return new R(a.parentNode,t.getNodeIndex(a))}function f(a){return new R(a.parentNode,t.getNodeIndex(a)+1)}function e(a,b,c){var d=11==a.nodeType?a.firstChild:a;t.isCharacterDataNode(b)?
c==b.length?t.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:t.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function h(b){for(var c,d,j=a(b.range).createDocumentFragment();d=b.next();){c=b.isPartiallySelectedSubtree();d=d.cloneNode(!c);c&&(c=b.getSubtreeIterator(),d.appendChild(h(c)),c.detach(!0));if(10==d.nodeType)throw new P("HIERARCHY_REQUEST_ERR");j.appendChild(d)}return j}function g(a,b,c){for(var d,j,c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),g(d,b,c),d.detach(!0),c.stop)break}else for(d=t.createIterator(d);j=d.next();)if(!1===b(j)){c.stop=!0;return}}function b(a){for(var c;a.next();)a.isPartiallySelectedSubtree()?(c=a.getSubtreeIterator(),b(c),c.detach(!0)):a.remove()}function k(b){for(var c,d=a(b.range).createDocumentFragment(),j;c=b.next();){b.isPartiallySelectedSubtree()?(c=c.cloneNode(!1),j=b.getSubtreeIterator(),c.appendChild(k(j)),j.detach(!0)):b.remove();if(10==c.nodeType)throw new P("HIERARCHY_REQUEST_ERR");
d.appendChild(c)}return d}function l(a,b,c){var d=!(!b||!b.length),j,e=!!c;d&&(j=RegExp("^("+b.join("|")+")$"));var f=[];g(new n(a,!1),function(a){(!d||j.test(a.nodeType))&&(!e||c(a))&&f.push(a)});return f}function o(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+t.inspectNode(a.startContainer)+":"+a.startOffset+", "+t.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function n(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
this.so=a.startOffset;this.ec=a.endContainer;this.eo=a.endOffset;var c=a.commonAncestorContainer;this.sc===this.ec&&t.isCharacterDataNode(this.sc)?(this.isSingleCharacterDataNode=!0,this._first=this._last=this._next=this.sc):(this._first=this._next=this.sc===c&&!t.isCharacterDataNode(this.sc)?this.sc.childNodes[this.so]:t.getClosestAncestorIn(this.sc,c,!0),this._last=this.ec===c&&!t.isCharacterDataNode(this.ec)?this.ec.childNodes[this.eo-1]:t.getClosestAncestorIn(this.ec,c,!0))}}function p(a){this.code=
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function r(a,b,c){this.nodes=l(a,b,c);this._next=this.nodes[0];this._position=0}function s(a){return function(b,c){for(var d,j=c?b:b.parentNode;j;){d=j.nodeType;if(t.arrayContains(a,d))return j;j=j.parentNode}return null}}function x(a,b){if(j(a,b))throw new p("INVALID_NODE_TYPE_ERR");}function q(a){if(!a.startContainer)throw new P("INVALID_STATE_ERR");}function B(a,b){if(!t.arrayContains(b,a.nodeType))throw new p("INVALID_NODE_TYPE_ERR");
}function A(a,b){if(0>b||b>(t.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new P("INDEX_SIZE_ERR");}function C(a,b){if(X(a,!0)!==X(b,!0))throw new P("WRONG_DOCUMENT_ERR");}function E(a){if(S(a,!0))throw new P("NO_MODIFICATION_ALLOWED_ERR");}function y(a,b){if(!a)throw new P(b);}function F(a){return!!a.startContainer&&!!a.endContainer&&!(!t.arrayContains(G,a.startContainer.nodeType)&&!X(a.startContainer,!0))&&!(!t.arrayContains(G,a.endContainer.nodeType)&&!X(a.endContainer,!0))&&a.startOffset<=
(t.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(t.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function D(a){q(a);if(!F(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function Q(){}function J(a){a.START_TO_START=Y;a.START_TO_END=ca;a.END_TO_END=$;a.END_TO_START=ka;a.NODE_BEFORE=oa;a.NODE_AFTER=pa;a.NODE_BEFORE_AND_AFTER=la;a.NODE_INSIDE=
ma}function v(a){J(a);J(a.prototype)}function V(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,j=this.commonAncestorContainer,e=new n(this,!0);c!==j&&(c=t.getClosestAncestorIn(c,j,!0),d=f(c),c=d.node,d=d.offset);g(e,E);e.reset();j=a(e);e.detach();b(this,c,d,c,d);return j}}function M(a,c,j){function g(a,b){return function(c){q(this);B(c,I);B(W(c),G);c=(a?d:f)(c);(b?e:i)(this,c.node,c.offset)}}function e(a,b,d){var j=a.endContainer,g=a.endOffset;if(b!==a.startContainer||
d!==a.startOffset){if(W(b)!=W(j)||1==t.comparePoints(b,d,j,g))j=b,g=d;c(a,b,d,j,g)}}function i(a,b,d){var j=a.startContainer,g=a.startOffset;if(b!==a.endContainer||d!==a.endOffset){if(W(b)!=W(j)||-1==t.comparePoints(b,d,j,g))j=b,g=d;c(a,j,g,b,d)}}a.prototype=new Q;m.util.extend(a.prototype,{setStart:function(a,b){q(this);x(a,!0);A(a,b);e(this,a,b)},setEnd:function(a,b){q(this);x(a,!0);A(a,b);i(this,a,b)},setStartBefore:g(!0,!0),setStartAfter:g(!1,!0),setEndBefore:g(!0,!1),setEndAfter:g(!1,!1),collapse:function(a){D(this);
a?c(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):c(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){q(this);x(a,!0);c(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){q(this);x(a,!1);B(a,I);var b=d(a),a=f(a);c(this,b.node,b.offset,a.node,a.offset)},extractContents:V(k,c),deleteContents:V(b,c),canSurroundContents:function(){D(this);E(this.startContainer);E(this.endContainer);var a=new n(this,!0),b=a._first&&
w(a._first,this)||a._last&&w(a._last,this);a.detach();return!b},detach:function(){j(this)},splitBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,d=this.endContainer,j=this.endOffset,g=a===d;t.isCharacterDataNode(d)&&0<j&&j<d.length&&t.splitDataNode(d,j);t.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=t.splitDataNode(a,b),g?(j-=b,d=a):d==a.parentNode&&j>=t.getNodeIndex(a)&&j++,b=0);c(this,a,b,d,j)},normalizeBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,
d=this.endContainer,j=this.endOffset,g=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(d=a,j=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},e=function(c){var g=c.previousSibling;if(g&&g.nodeType==c.nodeType){a=c;var e=c.length;b=g.length;c.insertData(0,g.data);g.parentNode.removeChild(g);a==d?(j+=b,d=a):d==c.parentNode&&(g=t.getNodeIndex(c),j==g?(d=c,j=e):j>g&&j--)}},f=!0;t.isCharacterDataNode(d)?d.length==j&&g(d):(0<j&&(f=d.childNodes[j-1])&&t.isCharacterDataNode(f)&&g(f),
f=!this.collapsed);f?t.isCharacterDataNode(a)?0==b&&e(a):b<a.childNodes.length&&(g=a.childNodes[b])&&t.isCharacterDataNode(g)&&e(g):(a=d,b=j);c(this,a,b,d,j)},collapseToPoint:function(a,b){q(this);x(a,!0);A(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&c(this,a,b,a,b)}});v(a)}function i(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:t.getCommonAncestor(a.startContainer,
a.endContainer)}function T(a,b,d,j,g){var e=a.startContainer!==b||a.startOffset!==d,f=a.endContainer!==j||a.endOffset!==g;a.startContainer=b;a.startOffset=d;a.endContainer=j;a.endOffset=g;i(a);c(a,"boundarychange",{startMoved:e,endMoved:f})}function H(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};i(this)}m.requireModules(["DomUtil"]);var t=m.dom,R=t.DomPosition,P=m.DOMException;n.prototype={_current:null,_next:null,_first:null,
_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next;a&&(this._next=a!==this._last?a.nextSibling:null,t.isCharacterDataNode(a)&&this.clonePartiallySelectedTextNodes&&(a===this.ec&&(a=a.cloneNode(!0)).deleteData(this.eo,a.length-this.eo),this._current===this.sc&&(a=a.cloneNode(!0)).deleteData(0,this.so)));return a},remove:function(){var a=this._current,b,c;t.isCharacterDataNode(a)&&
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return w(this._current,this.range)},getSubtreeIterator:function(){var b;if(this.isSingleCharacterDataNode)b=this.range.cloneRange(),b.collapse();else{b=new H(a(this.range));var c=this._current,d=c,j=0,g=c,e=t.getNodeLength(c);t.isAncestorOf(c,this.sc,!0)&&(d=this.sc,j=this.so);t.isAncestorOf(c,this.ec,!0)&&(g=
this.ec,e=this.eo);T(b,d,j,g,e)}return new n(b,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};p.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};p.prototype.toString=function(){return this.message};r.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var I=[1,3,4,5,7,8,10],G=[2,9,11],O=[1,3,4,5,7,8,10,11],N=[1,3,4,5,7,8],W=t.getRootContainer,X=s([9,11]),S=s([5,6,10,12]),j=s([6,10,12]),u=document.createElement("style"),z=!1;try{u.innerHTML="<b>x</b>",z=3==u.firstChild.nodeType}catch(L){}m.features.htmlParsingConforms=z;var U="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),Y=0,ca=1,$=2,ka=3,oa=0,pa=1,la=2,ma=3;Q.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){D(this);C(this.startContainer,b.startContainer);var c=a==ka||a==Y?"start":"end",d=a==ca||a==Y?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){D(this);B(a,O);E(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new P("HIERARCHY_REQUEST_ERR");this.setStartBefore(e(a,this.startContainer,this.startOffset))},cloneContents:function(){D(this);
var b,c;if(this.collapsed)return a(this).createDocumentFragment();if(this.startContainer===this.endContainer&&t.isCharacterDataNode(this.startContainer))return b=this.startContainer.cloneNode(!0),b.data=b.data.slice(this.startOffset,this.endOffset),c=a(this).createDocumentFragment(),c.appendChild(b),c;c=new n(this,!0);b=h(c);c.detach();return b},canSurroundContents:function(){D(this);E(this.startContainer);E(this.endContainer);var a=new n(this,!0),b=a._first&&w(a._first,this)||a._last&&w(a._last,
this);a.detach();return!b},surroundContents:function(a){B(a,N);if(!this.canSurroundContents())throw new p("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);e(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){D(this);for(var b=new H(a(this)),c=U.length,d;c--;)d=U[c],b[d]=this[d];return b},toString:function(){D(this);var a=this.startContainer;if(a===this.endContainer&&t.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new n(this,!0);g(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){D(this);var b=a.parentNode,c=t.getNodeIndex(a);if(!b)throw new P("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?la:oa:0<b?pa:ma},comparePoint:function(a,b){D(this);y(a,"HIERARCHY_REQUEST_ERR");C(a,this.startContainer);return 0>t.comparePoints(a,
b,this.startContainer,this.startOffset)?-1:0<t.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:z?function(a){var b=this.startContainer,c=t.getDocument(b);if(!b)throw new P("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:t.isCharacterDataNode(b)&&(d=t.parentElement(b));d=null===d||"HTML"==d.nodeName&&t.isHtmlNamespace(t.getDocument(d).documentElement)&&t.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return t.fragmentFromNodeChildren(d)}:
function(b){q(this);var c=a(this).createElement("body");c.innerHTML=b;return t.fragmentFromNodeChildren(c)},toHtml:function(){D(this);var b=a(this).createElement("div");b.appendChild(this.cloneContents());return b.innerHTML},intersectsNode:function(b,c){D(this);y(b,"NOT_FOUND_ERR");if(t.getDocument(b)!==a(this))return!1;var d=b.parentNode,j=t.getNodeIndex(b);y(d,"NOT_FOUND_ERR");var g=t.comparePoints(d,j,this.endContainer,this.endOffset),d=t.comparePoints(d,j+1,this.startContainer,this.startOffset);
return c?0>=g&&0<=d:0>g&&0<d},isPointInRange:function(a,b){D(this);y(a,"HIERARCHY_REQUEST_ERR");C(a,this.startContainer);return 0<=t.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=t.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(b,c){D(this);if(a(b)!=a(this))throw new P("WRONG_DOCUMENT_ERR");var d=t.comparePoints(this.startContainer,this.startOffset,b.endContainer,b.endOffset),j=t.comparePoints(this.endContainer,this.endOffset,b.startContainer,b.startOffset);
return c?0>=d&&0<=j:0>d&&0<j},intersection:function(a){if(this.intersectsRange(a)){var b=t.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),c=t.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),d=this.cloneRange();-1==b&&d.setStart(a.startContainer,a.startOffset);1==c&&d.setEnd(a.endContainer,a.endOffset);return d}return null},union:function(a){if(this.intersectsRange(a,!0)){var b=this.cloneRange();-1==t.comparePoints(a.startContainer,a.startOffset,
this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==t.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new p("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==ma},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,t.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){D(this);return new r(this,a,b)},getNodes:function(a,b){D(this);return l(this,a,b)},getDocument:function(){return a(this)},collapseBefore:function(a){q(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){q(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return H.rangesEqual(this,a)},isValid:function(){return F(this)},inspect:function(){return o(this)}};M(H,T,function(a){q(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;c(a,"detach",null);a._listeners=null});m.rangePrototype=Q.prototype;H.rangeProperties=U;H.RangeIterator=n;H.copyComparisonConstants=v;H.createPrototypeRange=M;H.inspect=o;H.getRangeDocument=a;H.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};m.DomRange=H;m.RangeException=p});
rangy.createModule("WrappedRange",function(m){function w(a,b,c,e){var h=a.duplicate();h.collapse(c);var n=h.parentElement();d.isAncestorOf(b,n,!0)||(n=b);if(!n.canHaveHTML)return new f(n.parentNode,d.getNodeIndex(n));var b=d.getDocument(n).createElement("span"),p,r=c?"StartToStart":"StartToEnd";do n.insertBefore(b,b.previousSibling),h.moveToElementText(b);while(0<(p=h.compareEndPoints(r,a))&&b.previousSibling);r=b.nextSibling;if(-1==p&&r&&d.isCharacterDataNode(r)){h.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(r.data)){n=h.duplicate();c=n.text.replace(/\r\n/g,"\r").length;for(c=n.moveStart("character",c);-1==n.compareEndPoints("StartToEnd",n);)c++,n.moveStart("character",1)}else c=h.text.length;n=new f(r,c)}else r=(e||!c)&&b.previousSibling,n=(c=(e||c)&&b.nextSibling)&&d.isCharacterDataNode(c)?new f(c,0):r&&d.isCharacterDataNode(r)?new f(r,r.length):new f(n,d.getNodeIndex(b));b.parentNode.removeChild(b);return n}function a(a,b){var c,e,f=a.offset,h=d.getDocument(a.node),p=h.body.createTextRange(),
r=d.isCharacterDataNode(a.node);r?(c=a.node,e=c.parentNode):(c=a.node.childNodes,c=f<c.length?c[f]:null,e=a.node);h=h.createElement("span");h.innerHTML="&#feff;";c?e.insertBefore(h,c):e.appendChild(h);p.moveToElementText(h);p.collapse(!b);e.removeChild(h);if(r)p[b?"moveStart":"moveEnd"]("character",f);return p}m.requireModules(["DomUtil","DomRange"]);var c,d=m.dom,f=d.DomPosition,e=m.DomRange;if(m.features.implementsDomRange&&(!m.features.implementsTextRange||!m.config.preferTextRange))(function(){function a(b){for(var c=
f.length,d;c--;)d=f[c],b[d]=b.nativeRange[d]}var b,f=e.rangeProperties,h;c=function(b){if(!b)throw Error("Range must be specified");this.nativeRange=b;a(this)};e.createPrototypeRange(c,function(a,b,c,d,g){var e=a.endContainer!==d||a.endOffset!=g;if(a.startContainer!==b||a.startOffset!=c||e)a.setEnd(d,g),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=f.length,c;b--;)c=f[b],a[c]=null});b=c.prototype;b.selectNode=function(b){this.nativeRange.selectNode(b);a(this)};b.deleteContents=
...
var o=document.createTextNode("test");d.getBody(document).appendChild(o);var n=document.createRange();n.setStart(o,0);n.setEnd(o,0);try{n.setStart(o,1),b.setStart=function(b,c){this.nativeRange.setStart(b,c);a(this)},b.setEnd=function(b,c){this.nativeRange.setEnd(b,c);a(this)},h=function(b){return function(c){this.nativeRange[b](c);a(this)}}}catch(p){b.setStart=function(b,c){try{this.nativeRange.setStart(b,c)}catch(d){this.nativeRange.setEnd(b,c),this.nativeRange.setStart(b,c)}a(this)},b.setEnd=function(b,
c){try{this.nativeRange.setEnd(b,c)}catch(d){this.nativeRange.setStart(b,c),this.nativeRange.setEnd(b,c)}a(this)},h=function(b,c){return function(d){try{this.nativeRange[b](d)}catch(e){this.nativeRange[c](d),this.nativeRange[b](d)}a(this)}}}b.setStartBefore=h("setStartBefore","setEndBefore");b.setStartAfter=h("setStartAfter","setEndAfter");b.setEndBefore=h("setEndBefore","setStartBefore");b.setEndAfter=h("setEndAfter","setStartAfter");n.selectNodeContents(o);b.selectNodeContents=n.startContainer==
o&&n.endContainer==o&&0==n.startOffset&&n.endOffset==o.length?function(b){this.nativeRange.selectNodeContents(b);a(this)}:function(a){this.setStart(a,0);this.setEnd(a,e.getEndOffset(a))};n.selectNodeContents(o);n.setEnd(o,3);h=document.createRange();h.selectNodeContents(o);h.setEnd(o,4);h.setStart(o,2);b.compareBoundaryPoints=-1==n.compareBoundaryPoints(n.START_TO_END,h)&1==n.compareBoundaryPoints(n.END_TO_START,h)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};m.util.isHostMethod(n,"createContextualFragment")&&(b.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});d.getBody(document).removeChild(o);n.detach();h.detach()})(),m.createNativeRange=function(a){return(a||document).createRange()};else if(m.features.implementsTextRange){c=function(a){this.textRange=a;this.refresh()};
c.prototype=new e(document);c.prototype.refresh=function(){var a,b,c=this.textRange;a=c.parentElement();var e=c.duplicate();e.collapse(!0);b=e.parentElement();e=c.duplicate();e.collapse(!1);c=e.parentElement();b=b==c?b:d.getCommonAncestor(b,c);b=b==a?b:d.getCommonAncestor(a,b);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?b=a=w(this.textRange,b,!0,!0):(a=w(this.textRange,b,!0,!1),b=w(this.textRange,b,!1,!1));this.setStart(a.node,a.offset);this.setEnd(b.node,b.offset)};e.copyComparisonConstants(c);
var h=function(){return this}();"undefined"==typeof h.Range&&(h.Range=c);m.createNativeRange=function(a){return(a||document).body.createTextRange()}}m.features.implementsTextRange&&(c.rangeToTextRange=function(c){if(c.collapsed)return a(new f(c.startContainer,c.startOffset),!0);var b=a(new f(c.startContainer,c.startOffset),!0),e=a(new f(c.endContainer,c.endOffset),!1),c=d.getDocument(c.startContainer).body.createTextRange();c.setEndPoint("StartToStart",b);c.setEndPoint("EndToEnd",e);return c});c.prototype.getName=
function(){return"WrappedRange"};m.WrappedRange=c;m.createRange=function(a){return new c(m.createNativeRange(a||document))};m.createRangyRange=function(a){return new e(a||document)};m.createIframeRange=function(a){return m.createRange(d.getIframeDocument(a))};m.createIframeRangyRange=function(a){return m.createRangyRange(d.getIframeDocument(a))};m.addCreateMissingNativeApiListener(function(a){a=a.document;if(typeof a.createRange=="undefined")a.createRange=function(){return m.createRange(this)};a=
a=null})});
rangy.createModule("WrappedSelection",function(m,w){function a(a){return(a||window).getSelection()}function c(a){return(a||window).document.selection}function d(a,b,c){var d=c?"end":"start",c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function f(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function e(a){var b;a instanceof x?(b=a._selectionNativeRange,b||
(b=m.createNativeRange(r.getDocument(a.startContainer)),b.setEnd(a.endContainer,a.endOffset),b.setStart(a.startContainer,a.startOffset),a._selectionNativeRange=b,a.attachListener("detach",function(){this._selectionNativeRange=null}))):a instanceof q?b=a.nativeRange:m.features.implementsDomRange&&a instanceof r.getWindow(a.startContainer).Range&&(b=a);return b}function h(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!r.isAncestorOf(b[0],b[c])){c=
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function g(a,b){var c=new q(b);a._ranges=[c];d(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function b(a){a._ranges.length=0;if("None"==a.docSelection.type)f(a);else{var b=a.docSelection.createRange();if(b&&"undefined"!=typeof b.text)g(a,b);else{a.rangeCount=b.length;for(var c,e=r.getDocument(b.item(0)),j=0;j<a.rangeCount;++j)c=m.createRange(e),c.selectNode(b.item(j)),
a._ranges.push(c);a.isCollapsed=1==a.rangeCount&&a._ranges[0].collapsed;d(a,a._ranges[a.rangeCount-1],!1)}}}function k(a,c){for(var d=a.docSelection.createRange(),e=h(c),j=r.getDocument(d.item(0)),j=r.getBody(j).createControlRange(),g=0,f=d.length;g<f;++g)j.add(d.item(g));try{j.add(e)}catch(i){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}j.select();b(a)}function l(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function o(a,c){for(var d=r.getDocument(c[0].startContainer),d=r.getBody(d).createControlRange(),e=0,j;e<rangeCount;++e){j=h(c[e]);try{d.add(j)}catch(g){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();b(a)}function n(a,b){if(a.anchorNode&&r.getDocument(a.anchorNode)!==r.getDocument(b))throw new B("WRONG_DOCUMENT_ERR");}function p(a){var b=[],c=new A(a.anchorNode,a.anchorOffset),
d=new A(a.focusNode,a.focusOffset),j="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var e=0,g=a.rangeCount;e<g;++e)b[e]=x.inspect(a.getRangeAt(e));return"["+j+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}m.requireModules(["DomUtil","DomRange","WrappedRange"]);m.config.checkSelectionRanges=!0;var r=m.dom,s=m.util,x=m.DomRange,q=m.WrappedRange,B=m.DOMException,A=r.DomPosition,C,E,y=m.util.isHostMethod(window,"getSelection"),
F=m.util.isHostObject(document,"selection"),D=F&&(!y||m.config.preferTextRange);D?(C=c,m.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||r.getDocument(b.createRange().parentElement())==a}):y?(C=a,m.isSelectionValid=function(){return!0}):w.fail("Neither document.selection or window.getSelection() detected.");m.getNativeSelection=C;var y=C(),Q=m.createNativeRange(document),J=r.getBody(document),v=s.areHostObjects(y,s.areHostProperties(y,["anchorOffset","focusOffset"]));
m.features.selectionHasAnchorAndFocus=v;var V=s.isHostMethod(y,"extend");m.features.selectionHasExtend=V;var M="number"==typeof y.rangeCount;m.features.selectionHasRangeCount=M;var i=!1,T=!0;s.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof y.rangeCount&&m.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";J.appendChild(a);var b=r.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=r.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);T=c.rangeCount==1;c.removeAllRanges();var j=b.cloneRange();b.setStart(d,0);j.setEnd(d,2);c.addRange(b);c.addRange(j);i=c.rangeCount==2;b.detach();j.detach();J.removeChild(a)}();m.features.selectionSupportsMultipleRanges=i;m.features.collapsedNonEditableSelectionsSupported=T;var H=!1,t;J&&s.isHostMethod(J,"createControlRange")&&(t=J.createControlRange(),
s.areHostProperties(t,["item","add"])&&(H=!0));m.features.implementsControlRange=H;E=v?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var R;s.isHostMethod(y,"getRangeAt")?R=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:v&&(R=function(a){var b=r.getDocument(a.anchorNode),b=m.createRange(b);b.setStart(a.anchorNode,a.anchorOffset);b.setEnd(a.focusNode,a.focusOffset);if(b.collapsed!==
this.isCollapsed){b.setStart(a.focusNode,a.focusOffset);b.setEnd(a.anchorNode,a.anchorOffset)}return b});m.getSelection=function(a){var a=a||window,b=a._rangySelection,d=C(a),e=F?c(a):null;if(b){b.nativeSelection=d;b.docSelection=e;b.refresh(a)}else{b=new l(d,e,a);a._rangySelection=b}return b};m.getIframeSelection=function(a){return m.getSelection(r.getIframeWindow(a))};t=l.prototype;if(!D&&v&&s.areHostMethods(y,["removeAllRanges","addRange"])){t.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
f(this)};var P=function(a,b){var c=x.getRangeDocument(b),c=m.createRange(c);c.collapseToPoint(b.endContainer,b.endOffset);a.nativeSelection.addRange(e(c));a.nativeSelection.extend(b.startContainer,b.startOffset);a.refresh()};t.addRange=M?function(a,b){if(H&&F&&this.docSelection.type=="Control")k(this,a);else if(b&&V)P(this,a);else{var c;if(i)c=this.rangeCount;else{this.removeAllRanges();c=0}this.nativeSelection.addRange(e(a));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==c+1){if(m.config.checkSelectionRanges)(c=
R(this.nativeSelection,this.rangeCount-1))&&!x.rangesEqual(c,a)&&(a=new q(c));this._ranges[this.rangeCount-1]=a;d(this,a,O(this.nativeSelection));this.isCollapsed=E(this)}else this.refresh()}}:function(a,b){if(b&&V)P(this,a);else{this.nativeSelection.addRange(e(a));this.refresh()}};t.setRanges=function(a){if(H&&a.length>1)o(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(y,"empty")&&s.isHostMethod(Q,"select")&&H&&D)t.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=r.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=r.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}f(this)},t.addRange=function(a){if(this.docSelection.type=="Control")k(this,a);else{q.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;d(this,a,false)}},t.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?o(this,a):b&&this.addRange(a[0])};else return w.fail("No means of selecting a Range or TextRange was found"),!1;t.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new B("INDEX_SIZE_ERR");return this._ranges[a]};var I;if(D)I=function(a){var c;if(m.isSelectionValid(a.win))c=a.docSelection.createRange();else{c=r.getBody(a.win.document).createTextRange();c.collapse(true)}a.docSelection.type==
"Control"?b(a):c&&typeof c.text!="undefined"?g(a,c):f(a)};else if(s.isHostMethod(y,"getRangeAt")&&"number"==typeof y.rangeCount)I=function(a){if(H&&F&&a.docSelection.type=="Control")b(a);else{a._ranges.length=a.rangeCount=a.nativeSelection.rangeCount;if(a.rangeCount){for(var c=0,e=a.rangeCount;c<e;++c)a._ranges[c]=new m.WrappedRange(a.nativeSelection.getRangeAt(c));d(a,a._ranges[a.rangeCount-1],O(a.nativeSelection));a.isCollapsed=E(a)}else f(a)}};else if(v&&"boolean"==typeof y.isCollapsed&&"boolean"==
typeof Q.collapsed&&m.features.implementsDomRange)I=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=R(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=E(a)}else f(a)};else return w.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;t.refresh=function(a){var b=a?this._ranges.slice(0):null;I(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!x.rangesEqual(b[a],this._ranges[a]))return false;return true}};var G=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var j=0,e=c.length;j<e;++j)d||b!==c[j]?a.addRange(c[j]):d=true;a.rangeCount||f(a)};t.removeRange=H?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=h(a),d=r.getDocument(c.item(0)),d=r.getBody(d).createControlRange(),e,j=false,g=0,f=c.length;g<f;++g){e=c.item(g);e!==a||j?d.add(c.item(g)):j=true}d.select();
b(this)}else G(this,a)}:function(a){G(this,a)};var O;!D&&v&&m.features.implementsDomRange?(O=function(a){var b=false;a.anchorNode&&(b=r.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},t.isBackwards=function(){return O(this)}):O=t.isBackwards=function(){return false};t.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};t.collapse=function(a,b){n(this,a);var c=m.createRange(r.getDocument(a));c.collapseToPoint(a,
b);this.removeAllRanges();this.addRange(c);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new B("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new B("INVALID_STATE_ERR");};t.selectAllChildren=function(a){n(this,a);var b=m.createRange(r.getDocument(a));b.selectNodeContents(a);this.removeAllRanges();
this.addRange(b)};t.deleteFromDocument=function(){if(H&&F&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};t.getAllRanges=function(){return this._ranges.slice(0)};t.setSingleRange=function(a){this.setRanges([a])};t.containsNode=function(a,b){for(var c=
0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return true;return false};t.toHtml=function(){var a="";if(this.rangeCount){for(var a=x.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};t.getName=function(){return"WrappedSelection"};t.inspect=function(){return p(this)};t.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};l.inspect=
p;m.Selection=l;m.selectionPrototype=t;m.addCreateMissingNativeApiListener(function(a){if(typeof a.getSelection=="undefined")a.getSelection=function(){return m.getSelection(this)};a=null})});
rangy.createModule("CssClassApplier",function(m,w){function a(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function c(b,c){b.className?a(b,c)||(b.className+=" "+c):b.className=c}function d(a){return a.split(/\s+/).sort().join(" ")}function f(a,b){return d(a.className)==d(b.className)}function e(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function h(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
d=d?d.toString():"";c.detach();return""!=d}function g(a){return a.getNodes([3],function(b){return h(a,b)})}function b(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,e,g;c<d;++c)if(e=a.attributes[c],g=e.name,"class"!=g&&(g=b.attributes.getNamedItem(g),e.specified!=g.specified||e.specified&&e.nodeValue!==g.nodeValue))return!1;return!0}function k(a,b){for(var c=0,d=a.attributes.length,e;c<d;++c)if(e=a.attributes[c].name,(!b||!B.arrayContains(b,e))&&a.attributes[c].specified&&
"class"!=e)return!0;return!1}function l(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||E(a)&&!E(a.parentNode))}function o(a){return(E(a)||1!=a.nodeType&&E(a.parentNode))&&!l(a)}function n(a){return a&&1==a.nodeType&&!y.test(C(a,"display"))}function p(a){if(0==a.data.length)return!0;if(F.test(a.data))return!1;switch(C(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return n(a.previousSibling)||
n(a.nextSibling)}function r(a,b,c,d){var e,g=0==c;if(B.isAncestorOf(b,a))return a;if(B.isCharacterDataNode(b))if(0==c)c=B.getNodeIndex(b),b=b.parentNode;else if(c==b.length)c=B.getNodeIndex(b)+1,b=b.parentNode;else throw w.createError("splitNodeAt should not be called with offset in the middle of a data node ("+c+" in "+b.data);if(B.isCharacterDataNode(b)?0==c?b.previousSibling:c==b.length?b.nextSibling:1:0<c&&c<b.childNodes.length){if(!e){e=b.cloneNode(!1);for(e.id&&e.removeAttribute("id");g=b.childNodes[c];)e.appendChild(g);
B.insertAfter(e,b)}return b==a?e:r(a,e.parentNode,B.getNodeIndex(e),d)}return a!=b?(e=b.parentNode,b=B.getNodeIndex(b),g||b++,r(a,e,b,d)):a}function s(a){var c=a?"nextSibling":"previousSibling";return function(d,e){var g=d.parentNode,h=d[c];if(h){if(h&&3==h.nodeType)return h}else if(e&&(h=g[c])&&1==h.nodeType&&g.tagName==h.tagName&&f(g,h)&&b(g,h))return h[a?"firstChild":"lastChild"];return null}}function x(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function q(a,b,c){this.cssClass=a;var e,g,f=null;if("object"==typeof b&&null!==b){c=b.tagNames;f=b.elementProperties;for(e=0;g=J[e++];)b.hasOwnProperty(g)&&(this[g]=b[g]);e=b.normalize}else e=b;this.normalize="undefined"==typeof e?!0:e;this.attrExceptions=[];e=document.createElement(this.elementTagName);this.elementProperties={};for(var h in f)f.hasOwnProperty(h)&&(v.hasOwnProperty(h)&&(h=v[h]),e[h]=f[h],this.elementProperties[h]=e[h],this.attrExceptions.push(h));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
d(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];e=0;for(a=c.length;e<a;++e)"*"==c[e]?this.applyToAnyTagName=!0:this.tagNames.push(c[e].toLowerCase())}else this.tagNames=[this.elementTagName]}m.requireModules(["WrappedSelection","WrappedRange"]);var B=m.dom,A=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),C;"undefined"!=typeof window.getComputedStyle?C=function(a,b){return B.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?C=function(a,b){return a.currentStyle[b]}:w.fail("No means of obtaining computed style properties found");var E;(function(){E="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||E(a.parentNode)}})();var y=/^inline(-block|-table)?$/i,F=/[^\r\n\t\f \u200B]/,D=s(!1),Q=s(!0);x.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var J=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],v={"class":"className"};q.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(b){return 1==b.nodeType&&B.arrayContains(this.tagNames,b.tagName.toLowerCase())&&a(b,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||o(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&p(a)},postApply:function(a,b,c){for(var d=a[0],e=a[a.length-1],g=[],f,h=d,k=e,n=0,p=e.length,l,r,o=0,s=a.length;o<s;++o)if(l=a[o],r=D(l,!c)){if(f||(f=new x(r),g.push(f)),f.textNodes.push(l),l===d&&(h=f.firstTextNode,
n=h.length),l===e)k=f.firstTextNode,p=f.getLength()}else f=null;if(a=Q(e,!c))f||(f=new x(e),g.push(f)),f.textNodes.push(a);if(g.length){o=0;for(s=g.length;o<s;++o)g[o].doMerge();b.setStart(h,n);b.setEnd(k,p)}},createContainer:function(a){a=a.createElement(this.elementTagName);m.util.extend(a,this.elementProperties);c(a,this.cssClass);return a},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&B.arrayContains(this.tagNames,b.tagName.toLowerCase())?c(b,this.cssClass):(b=this.createContainer(B.getDocument(a)),
a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=d(a.className)==this.elementSortedClassName){var c;a:{b=this.elementProperties;for(c in b)if(b.hasOwnProperty(c)&&a[c]!==b[c]){c=!1;break a}c=!0}b=c&&!k(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,c){b.containsNode(c)||(a=b.cloneRange(),a.selectNode(c),a.isPointInRange(b.endContainer,b.endOffset)&&(r(c,b.endContainer,b.endOffset,
[b]),b.setEndAfter(c)),a.isPointInRange(b.startContainer,b.startOffset)&&(c=r(c,b.startContainer,b.startOffset,[b])));this.isRemovable(c)?e(c):A(c,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var b=g(a);if(b.length){for(var c,d=0,e=b.length;d<e;++d)c=b[d],!this.isIgnorableWhiteSpaceNode(c)&&!this.getSelfOrAncestorWithClass(c)&&this.isModifiable(c)&&this.applyToTextNode(c);a.setStart(b[0],0);c=b[b.length-1];a.setEnd(c,c.length);this.normalize&&this.postApply(b,a,!1)}},applyToSelection:function(a){var a=
m.getSelection(a||window),b,c=a.getAllRanges();a.removeAllRanges();for(var d=c.length;d--;)b=c[d],this.applyToRange(b),a.addRange(b)},undoToRange:function(a){a.splitBoundaries();var b=g(a),c,d,e=b[b.length-1];if(b.length){for(var f=0,h=b.length;f<h;++f)c=b[f],(d=this.getSelfOrAncestorWithClass(c))&&this.isModifiable(c)&&this.undoToTextNode(c,a,d),a.setStart(b[0],0),a.setEnd(e,e.length);this.normalize&&this.postApply(b,a,!0)}},undoToSelection:function(a){var a=m.getSelection(a||window),b=a.getAllRanges(),
c;a.removeAllRanges();for(var d=0,e=b.length;d<e;++d)c=b[d],this.undoToRange(c),a.addRange(c)},getTextSelectedByRange:function(a,b){var c=b.cloneRange();c.selectNodeContents(a);var d=c.intersection(b),d=d?d.toString():"";c.detach();return d},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var b=a.getNodes([3]),c=0,d;d=b[c++];)if(!this.isIgnorableWhiteSpaceNode(d)&&h(a,d)&&this.isModifiable(d)&&!this.getSelfOrAncestorWithClass(d))return!1;
return!0},isAppliedToSelection:function(a){for(var a=m.getSelection(a||window).getAllRanges(),b=a.length;b--;)if(!this.isAppliedToRange(a[b]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};q.util={hasClass:a,addClass:c,removeClass:A,hasSameClasses:f,replaceWithOwnChildren:e,elementsHaveSameNonClassAttributes:b,
elementHasNonClassAttributes:k,splitNodeAt:r,isEditableElement:E,isEditingHost:l,isEditable:o};m.CssClassApplier=q;m.createCssClassApplier=function(a,b,c){return new q(a,b,c)}});
rangy.createModule("SaveRestore",function(m,w){function a(a,b){var c="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),d,f=e.getDocument(a.startContainer),n=a.cloneRange();n.collapse(b);d=f.createElement("span");d.id=c;d.style.lineHeight="0";d.style.display="none";d.className="rangySelectionBoundary";d.appendChild(f.createTextNode(h));n.insertNode(d);n.detach();return d}function c(a,b,c,d){(a=(a||document).getElementById(c))?(b[d?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
w.warn("Marker element has been removed. Cannot restore selection.")}function d(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function f(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}m.requireModules(["DomUtil","DomRange","WrappedRange"]);var e=m.dom,h="\ufeff";m.saveSelection=function(c){var c=c||window,b=c.document;if(m.isSelectionValid(c)){var e=m.getSelection(c),f=e.getAllRanges(),h=[],n,p;f.sort(d);for(var r=0,s=f.length;r<s;++r)n=f[r],n.collapsed?(p=a(n,
!1),h.push({markerId:p.id,collapsed:!0})):(p=a(n,!1),n=a(n,!0),h[r]={startMarkerId:n.id,endMarkerId:p.id,collapsed:!1,backwards:1==f.length&&e.isBackwards()});for(r=s-1;0<=r;--r)n=f[r],n.collapsed?n.collapseBefore((b||document).getElementById(h[r].markerId)):(n.setEndBefore((b||document).getElementById(h[r].endMarkerId)),n.setStartAfter((b||document).getElementById(h[r].startMarkerId)));e.setRanges(f);return{win:c,doc:b,rangeInfos:h,restored:!1}}w.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
m.restoreSelection=function(a,b){if(!a.restored){for(var d=a.rangeInfos,e=m.getSelection(a.win),f=[],h=d.length,p=h-1,r,s;0<=p;--p){r=d[p];s=m.createRange(a.doc);if(r.collapsed)if(r=(a.doc||document).getElementById(r.markerId)){r.style.display="inline";var x=r.previousSibling;x&&3==x.nodeType?(r.parentNode.removeChild(r),s.collapseToPoint(x,x.length)):(s.collapseBefore(r),r.parentNode.removeChild(r))}else w.warn("Marker element has been removed. Cannot restore selection.");else c(a.doc,s,r.startMarkerId,
!0),c(a.doc,s,r.endMarkerId,!1);1==h&&s.normalizeBoundaries();f[p]=s}1==h&&b&&m.features.selectionHasExtend&&d[0].backwards?(e.removeAllRanges(),e.addRange(f[0],!0)):e.setRanges(f);a.restored=!0}};m.removeMarkerElement=f;m.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?f(a.doc,e.markerId):(f(a.doc,e.startMarkerId),f(a.doc,e.endMarkerId))}});
rangy.createModule("Serializer",function(m,w){function a(b,c){var c=c||[],d=b.nodeType,e=b.childNodes,f=e.length,g=[d,b.nodeName,f].join(":"),h="",k="";switch(d){case 3:h=b.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:h="<\!--"+b.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:h="<"+g+">",k="</>"}h&&c.push(h);for(d=0;d<f;++d)a(e[d],c);k&&c.push(k);return c}function c(b){b=a(b).join("");return l(b).toString(16)}function d(a,b,c){for(var d=[],e=a,c=c||o.getDocument(a).documentElement;e&&
e!=c;)d.push(o.getNodeIndex(e,!0)),e=e.parentNode;return d.join("/")+":"+b}function f(a,b,c){b?c||o.getDocument(b):b=(c||document).documentElement;for(var a=a.split(":"),c=a[0]?a[0].split("/"):[],d=c.length,e;d--;)if(e=parseInt(c[d],10),e<b.childNodes.length)b=b.childNodes[parseInt(c[d],10)];else throw w.createError("deserializePosition failed: node "+o.inspectNode(b)+" has no child with index "+e+", "+d);return new o.DomPosition(b,parseInt(a[1],10))}function e(a,b,e){e=e||m.DomRange.getRangeDocument(a).documentElement;
if(!o.isAncestorOf(e,a.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");a=d(a.startContainer,a.startOffset,e)+","+d(a.endContainer,a.endOffset,e);b||(a+="{"+c(e)+"}");return a}function h(a,b,d){b?d=d||o.getDocument(b):(d=d||document,b=d.documentElement);var a=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(a),e=a[4],g=c(b);if(e&&e!==c(b))throw Error("deserializeRange: checksums of serialized range root node ("+e+") and target root node ("+
g+") do not match");e=f(a[1],b,d);b=f(a[2],b,d);d=m.createRange(d);d.setStart(e.node,e.offset);d.setEnd(b.node,b.offset);return d}function g(a,b,d){b?d||o.getDocument(b):b=(d||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===c(b)}function b(a,b,c){for(var a=a||m.getSelection(),a=a.getAllRanges(),d=[],f=0,g=a.length;f<g;++f)d[f]=e(a[f],b,c);return d.join("|")}function k(a,b,c){b?c=c||o.getWindow(b):(c=c||window,b=c.document.documentElement);for(var a=a.split("|"),
d=m.getSelection(c),e=[],f=0,g=a.length;f<g;++f)e[f]=h(a[f],b,c.document);d.setRanges(e);return d}m.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&w.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var l=function(){var a=null;return function(b){for(var c=[],d=0,e=b.length,f;d<e;++d)f=b.charCodeAt(d),128>f?c.push(f):2048>f?c.push(f>>6|192,f&63|128):c.push(f>>12|224,f>>6&63|128,
f&63|128);b=-1;if(!a){for(var d=[],e=0,g;256>e;++e){g=e;for(f=8;f--;)g=1==(g&1)?g>>>1^3988292384:g>>>1;d[e]=g>>>0}a=d}d=a;e=0;for(f=c.length;e<f;++e)g=(b^c[e])&255,b=b>>>8^d[g];return(b^-1)>>>0}}(),o=m.dom;m.serializePosition=d;m.deserializePosition=f;m.serializeRange=e;m.deserializeRange=h;m.canDeserializeRange=g;m.serializeSelection=b;m.deserializeSelection=k;m.canDeserializeSelection=function(a,b,c){var d;b?d=c?c.document:o.getDocument(b):b=(c||window).document.documentElement;for(var a=a.split("|"),
c=0,e=a.length;c<e;++c)if(!g(a[c],b,d))return!1;return!0};m.restoreSelectionFromCookie=function(a){var a=a||window,b;a:{b=a.document.cookie.split(/[;,]/);for(var c=0,d=b.length,e;c<d;++c)if(e=b[c].split("="),"rangySerializedSelection"==e[0].replace(/^\s+/,"")&&(e=e[1])){b=decodeURIComponent(e.replace(/\s+$/,""));break a}b=null}b&&k(b,a.doc)};m.saveSelectionCookie=function(a,c){var a=a||window,c="object"==typeof c?c:{},d=c.expires?";expires="+c.expires.toUTCString():"",e=c.path?";path="+c.path:"",
f=c.domain?";domain="+c.domain:"",g=c.secure?";secure":"",h=b(m.getSelection(a));a.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(h)+d+e+f+g};m.getElementChecksum=c});
(function(m){(function(a,c){function d(a){var b=T[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function f(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(R,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:i.isNumeric(d)?+d:t.test(d)?i.parseJSON(d):d}catch(e){}i.data(a,b,d)}else d=c;return d}function e(a){for(var b in a)if(!("data"===b&&i.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function h(a,
b,c){var d=b+"defer",e=b+"queue",j=b+"mark",f=i._data(a,d);f&&("queue"===c||!i._data(a,e))&&("mark"===c||!i._data(a,j))&&setTimeout(function(){!i._data(a,e)&&!i._data(a,j)&&(i.removeData(a,d,!0),f.fire())},0)}function g(){return!1}function b(){return!0}function k(a,b,c){b=b||0;if(i.isFunction(b))return i.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return i.grep(a,function(a){return a===b===c});if("string"===typeof b){var d=i.grep(a,function(a){return 1===a.nodeType});if(Za.test(b))return i.filter(b,
d,!c);b=i.filter(b,d)}return i.grep(a,function(a){return 0<=i.inArray(a,b)===c})}function l(a){var b=Ga.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function o(a,b){if(1===b.nodeType&&i.hasData(a)){var c,d,e;d=i._data(a);var j=i._data(b,d),f=d.events;if(f)for(c in delete j.handle,j.events={},f){d=0;for(e=f[c].length;d<e;d++)i.event.add(b,c,f[c][d])}j.data&&(j.data=i.extend({},j.data))}}function n(a,b){var c;if(1===b.nodeType){b.clearAttributes&&
b.clearAttributes();b.mergeAttributes&&b.mergeAttributes(a);c=b.nodeName.toLowerCase();if("object"===c)b.outerHTML=a.outerHTML;else if("input"===c&&("checkbox"===a.type||"radio"===a.type)){if(a.checked&&(b.defaultChecked=b.checked=a.checked),b.value!==a.value)b.value=a.value}else"option"===c?b.selected=a.defaultSelected:"input"===c||"textarea"===c?b.defaultValue=a.defaultValue:"script"===c&&b.text!==a.text&&(b.text=a.text);b.removeAttribute(i.expando);b.removeAttribute("_submit_attached");b.removeAttribute("_change_attached")}}
function p(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function r(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function s(a){var b=(a.nodeName||"").toLowerCase();"input"===b?r(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&i.grep(a.getElementsByTagName("input"),r)}function x(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>e;e+=2)c||(d-=parseFloat(i.css(a,"padding"+da[e]))||0),d="margin"===c?d+(parseFloat(i.css(a,c+da[e]))||0):d-(parseFloat(i.css(a,"border"+da[e]+"Width"))||0);return d+"px"}d=ga(a,b);if(0>d||null==d)d=a.style[b];if(xa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(i.css(a,"padding"+da[e]))||0,"padding"!==c&&(d+=parseFloat(i.css(a,"border"+da[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(i.css(a,c+da[e]))||0);return d+"px"}function q(a){return function(b,c){"string"!==
typeof b&&(c=b,b="*");if(i.isFunction(c))for(var d=b.toLowerCase().split(Ka),e=0,j=d.length,f,g;e<j;e++)f=d[e],(g=/^\+/.test(f))&&(f=f.substr(1)||"*"),f=a[f]=a[f]||[],f[g?"unshift":"push"](c)}}function m(a,b,d,e,j,f){j=j||b.dataTypes[0];f=f||{};f[j]=!0;for(var j=a[j],g=0,h=j?j.length:0,k=a===ya,i;g<h&&(k||!i);g++)i=j[g](b,d,e),"string"===typeof i&&(!k||f[i]?i=c:(b.dataTypes.unshift(i),i=m(a,b,d,e,i,f)));if((k||!i)&&!f["*"])i=m(a,b,d,e,"*",f);return i}function A(a,b){var d,e,j=i.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((j[d]?a:e||(e={}))[d]=b[d]);e&&i.extend(!0,a,e)}function C(a,b,c,d){if(i.isArray(b))i.each(b,function(b,e){c||gb.test(a)?d(a,e):C(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===i.type(b))for(var e in b)C(a+"["+e+"]",b[e],c,d);else d(a,b)}function E(){try{return new a.XMLHttpRequest}catch(b){}}function y(){setTimeout(w,0);return qa=i.now()}function w(){qa=c}function D(a,b){var c={};i.each(ra.concat.apply([],ra.slice(0,b)),function(){c[this]=a});return c}
function Q(a){if(!za[a]){var b=v.body,c=i("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){aa||(aa=v.createElement("iframe"),aa.frameBorder=aa.width=aa.height=0);b.appendChild(aa);if(!ha||!aa.createElement)ha=(aa.contentWindow||aa.contentDocument).document,ha.write((i.support.boxModel?"<!doctype html>":"")+"<html><body>"),ha.close();c=ha.createElement(a);ha.body.appendChild(c);d=i.css(c,"display");b.removeChild(aa)}za[a]=d}return za[a]}function J(a){return i.isWindow(a)?
a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var v=a.document,V=a.navigator,M=a.location,i=function(){function b(){if(!d.isReady){try{v.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,f)},e=a.jQuery,j=a.$,f,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,h=/\S/,k=/^\s+/,i=/\s+$/,u=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,n=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,z=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
p=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,L=/(msie) ([\w.]+)/,s=/(mozilla)(?:.*? rv:([\w.]+))?/,U=/-([a-z]|[0-9])/ig,x=/^-ms-/,q=function(a,b){return(b+"").toUpperCase()},m=V.userAgent,sa,ia,Y=Object.prototype.toString,Aa=Object.prototype.hasOwnProperty,Ba=Array.prototype.push,na=Array.prototype.slice,B=String.prototype.trim,t=Array.prototype.indexOf,A={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var j;if(!a)return this;if(a.nodeType)return this.context=
this[0]=a,this.length=1,this;if("body"===a&&!b&&v.body)return this.context=v,this[0]=v.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((j="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a))&&(j[1]||!b)){if(j[1])return e=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:v,(a=u.exec(a))?d.isPlainObject(b)?(a=[v.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([j[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=v.getElementById(j[2]))&&b.parentNode){if(b.id!==j[2])return e.find(a);this.length=1;this[0]=b}this.context=v;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return na.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?Ba.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();sa.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(na.apply(this,arguments),"slice",na.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Ba,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,j,K,f=arguments[0]||{},g=1,h=arguments.length,k=!1;"boolean"===typeof f&&(k=f,f=arguments[1]||{},g=2);"object"!==typeof f&&!d.isFunction(f)&&
(f={});h===g&&(f=this,--g);for(;g<h;g++)if(null!=(a=arguments[g]))for(b in a)e=f[b],j=a[b],f!==j&&(k&&j&&(d.isPlainObject(j)||(K=d.isArray(j)))?(K?(K=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},f[b]=d.extend(k,e,j)):j!==c&&(f[b]=j));return f};d.extend({noConflict:function(b){a.$===d&&(a.$=j);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!v.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(sa.fireWith(v,[d]),d.fn.trigger&&d(v).trigger("ready").off("ready"))}},bindReady:function(){if(!sa){sa=d.Callbacks("once memory");if("complete"===v.readyState)return setTimeout(d.ready,1);if(v.addEventListener)v.addEventListener("DOMContentLoaded",ia,!1),a.addEventListener("load",d.ready,!1);else if(v.attachEvent){v.attachEvent("onreadystatechange",ia);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}v.documentElement.doScroll&&
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:A[Y.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!Aa.call(a,"constructor")&&!Aa.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var e in a);
return e===c||Aa.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(n.test(b.replace(l,"@").replace(z,"]").replace(p,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,j;try{a.DOMParser?(j=new DOMParser,e=j.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(K){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&h.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(x,"ms-").replace(U,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var j,K=0,f=a.length,g=f===c||d.isFunction(a);
if(e)if(g)for(j in a){if(!1===b.apply(a[j],e))break}else for(;K<f&&!1!==b.apply(a[K++],e););else if(g)for(j in a){if(!1===b.call(a[j],j,a[j]))break}else for(;K<f&&!1!==b.call(a[K],K,a[K++]););return a},trim:B?function(a){return null==a?"":B.call(a)}:function(a){return null==a?"":a.toString().replace(k,"").replace(i,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?Ba.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(t)return t.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,e=0;if("number"===typeof b.length)for(var j=b.length;e<j;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];a.length=d;return a},grep:function(a,b,c){for(var d=[],e,c=!!c,j=0,K=a.length;j<K;j++)e=!!b(a[j],j),c!==e&&d.push(a[j]);return d},map:function(a,b,e){var j,K,f=[],g=0,h=a.length;if(a instanceof d||h!==c&&"number"===typeof h&&(0<
h&&a[0]&&a[h-1]||0===h||d.isArray(a)))for(;g<h;g++)j=b(a[g],g,e),null!=j&&(f[f.length]=j);else for(K in a)j=b(a[K],K,e),null!=j&&(f[f.length]=j);return f.concat.apply([],f)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var j=na.call(arguments,2),e=function(){return a.apply(b,j.concat(na.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,j,K,f,g){var h,k=null==e,i=0,u=a.length;if(e&&"object"===typeof e){for(i in e)d.access(a,
b,i,e[i],1,f,j);K=1}else if(j!==c){h=g===c&&d.isFunction(j);k&&(h?(h=b,b=function(a,b,c){return h.call(d(a),c)}):(b.call(a,j),b=null));if(b)for(;i<u;i++)b(a[i],e,h?j.call(a[i],i,b(a[i],e)):j,g);K=1}return K?a:k?b.call(a):u?b(a[0],e):f},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||r.exec(a)||L.exec(a)||0>a.indexOf("compatible")&&s.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&e instanceof d&&!(e instanceof a)&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(v);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){A["[object "+b+"]"]=b.toLowerCase()});m=d.uaMatch(m);m.browser&&(d.browser[m.browser]=!0,d.browser.version=m.version);d.browser.webkit&&(d.browser.safari=!0);h.test("\u00a0")&&
(k=/^[\s\xA0]+/,i=/[\s\xA0]+$/);f=d(v);v.addEventListener?ia=function(){v.removeEventListener("DOMContentLoaded",ia,false);d.ready()}:v.attachEvent&&(ia=function(){if(v.readyState==="complete"){v.detachEvent("onreadystatechange",ia);d.ready()}});return d}(),T={};i.Callbacks=function(a){var a=a?T[a]||d(a):{},b=[],e=[],j,f,g,h,k,u,n=function(c){var d,e,j,f;d=0;for(e=c.length;d<e;d++)j=c[d],f=i.type(j),"array"===f?n(j):"function"===f&&(!a.unique||!z.has(j))&&b.push(j)},l=function(c,d){d=d||[];j=!a.memory||
[c,d];g=f=!0;u=h||0;h=0;for(k=b.length;b&&u<k;u++)if(!1===b[u].apply(c,d)&&a.stopOnFalse){j=!0;break}g=!1;b&&(a.once?!0===j?z.disable():b=[]:e&&e.length&&(j=e.shift(),z.fireWith(j[0],j[1])))},z={add:function(){if(b){var a=b.length;n(arguments);g?k=b.length:j&&!0!==j&&(h=a,l(j[0],j[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,e=c.length;d<e;d++)for(var j=0;j<b.length&&!(c[d]===b[j]&&(g&&j<=k&&(k--,j<=u&&u--),b.splice(j--,1),a.unique));j++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=e=j=c;return this},disabled:function(){return!b},lock:function(){e=c;(!j||!0===j)&&z.disable();return this},locked:function(){return!e},fireWith:function(b,c){e&&(g?a.once||e.push([b,c]):(!a.once||!j)&&l(b,c));return this},fire:function(){z.fireWith(this,arguments);return this},fired:function(){return!!f}};return z};var H=[].slice;i.extend({Deferred:function(a){var b=i.Callbacks("once memory"),
c=i.Callbacks("once memory"),d=i.Callbacks("memory"),e="pending",j={resolve:b,reject:c,notify:d},f={done:b.add,fail:c.add,progress:d.add,state:function(){return e},isResolved:b.fired,isRejected:c.fired,then:function(a,b,c){g.done(a).fail(b).progress(c);return this},always:function(){g.done.apply(g,arguments).fail.apply(g,arguments);return this},pipe:function(a,b,c){return i.Deferred(function(d){i.each({done:[a,"resolve"],fail:[b,"reject"],progress:[c,"notify"]},function(a,b){var c=b[0],e=b[1],j;if(i.isFunction(c))g[a](function(){if((j=
c.apply(this,arguments))&&i.isFunction(j.promise))j.promise().then(d.resolve,d.reject,d.notify);else d[e+"With"](this===g?d:this,[j])});else g[a](d[e])})}).promise()},promise:function(a){if(null==a)a=f;else for(var b in f)a[b]=f[b];return a}},g=f.promise({}),h;for(h in j)g[h]=j[h].fire,g[h+"With"]=j[h].fireWith;g.done(function(){e="resolved"},c.disable,d.lock).fail(function(){e="rejected"},b.disable,d.lock);a&&a.call(g,g);return g},when:function(a){function b(a){return function(b){d[a]=1<arguments.length?
H.call(arguments,0):b;--g||h.resolveWith(h,d)}}function c(a){return function(b){f[a]=1<arguments.length?H.call(arguments,0):b;h.notifyWith(k,f)}}var d=H.call(arguments,0),e=0,j=d.length,f=Array(j),g=j,h=1>=j&&a&&i.isFunction(a.promise)?a:i.Deferred(),k=h.promise();if(1<j){for(;e<j;e++)d[e]&&d[e].promise&&i.isFunction(d[e].promise)?d[e].promise().then(b(e),h.reject,c(e)):--g;g||h.resolveWith(h,d)}else h!==a&&h.resolveWith(h,j?[a]:[]);return k}});i.support=function(){var b,c,d,e,j,f,g,h,k=v.createElement("div");
k.setAttribute("className","t");k.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=k.getElementsByTagName("*");d=k.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=v.createElement("select");j=e.appendChild(v.createElement("option"));c=k.getElementsByTagName("input")[0];b={leadingWhitespace:3===k.firstChild.nodeType,tbody:!k.getElementsByTagName("tbody").length,htmlSerialize:!!k.getElementsByTagName("link").length,
style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,checkOn:"on"===c.value,optSelected:j.selected,getSetAttribute:"t"!==k.className,enctype:!!v.createElement("form").enctype,html5Clone:"<:nav></:nav>"!==v.createElement("nav").cloneNode(!0).outerHTML,submitBubbles:!0,changeBubbles:!0,focusinBubbles:!1,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0,
pixelMargin:!0};i.boxModel=b.boxModel="CSS1Compat"===v.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!j.disabled;try{delete k.test}catch(u){b.deleteExpando=!1}!k.addEventListener&&k.attachEvent&&k.fireEvent&&(k.attachEvent("onclick",function(){b.noCloneEvent=!1}),k.cloneNode(!0).fireEvent("onclick"));c=v.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
"t");k.appendChild(c);d=v.createDocumentFragment();d.appendChild(k.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(k);if(k.attachEvent)for(g in{submit:1,change:1,focusin:1})c="on"+g,h=c in k,h||(k.setAttribute(c,"return;"),h="function"===typeof k[c]),b[g+"Bubbles"]=h;d.removeChild(k);d=e=j=k=c=null;i(function(){var c,d,e,j,g=v.getElementsByTagName("body")[0];if(g){c=v.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
g.insertBefore(c,g.firstChild);k=v.createElement("div");c.appendChild(k);k.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";f=k.getElementsByTagName("td");h=f[0].offsetHeight===0;f[0].style.display="";f[1].style.display="none";b.reliableHiddenOffsets=h&&f[0].offsetHeight===0;if(a.getComputedStyle){k.innerHTML="";d=v.createElement("div");d.style.width="0";d.style.marginRight="0";k.style.width="2px";k.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
...
k.innerHTML="<div style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;display:block;'><div style='padding:0;margin:0;border:0;display:block;overflow:hidden;'></div></div><table style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";d=k.firstChild;e=d.firstChild;j={doesNotAddBorder:e.offsetTop!==5,doesAddBorderForTableAndCells:d.nextSibling.firstChild.firstChild.offsetTop===
5};e.style.position="fixed";e.style.top="20px";j.fixedPosition=e.offsetTop===20||e.offsetTop===15;e.style.position=e.style.top="";d.style.overflow="hidden";d.style.position="relative";j.subtractsBorderForOverflowNotVisible=e.offsetTop===-5;j.doesNotIncludeMarginInBodyOffset=g.offsetTop!==1;if(a.getComputedStyle){k.style.marginTop="1%";b.pixelMargin=(a.getComputedStyle(k,null)||{marginTop:0}).marginTop!=="1%"}if(typeof c.style.zoom!=="undefined")c.style.zoom=1;g.removeChild(c);k=null;i.extend(b,j)}});
return b}();var t=/^(?:\{.*\}|\[.*\])$/,R=/([A-Z])/g;i.extend({cache:{},uuid:0,expando:"jQuery"+(i.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?i.cache[a[i.expando]]:a[i.expando];return!!a&&!e(a)},data:function(a,b,d,e){if(i.acceptData(a)){var j;j=i.expando;var f="string"===typeof b,g=a.nodeType,h=g?i.cache:a,k=g?a[j]:a[j]&&j,u="events"===b;if(k&&h[k]&&(u||e||h[k].data)||!(f&&d===c)){k||
(g?a[j]=k=++i.uuid:k=j);h[k]||(h[k]={},g||(h[k].toJSON=i.noop));if("object"===typeof b||"function"===typeof b)e?h[k]=i.extend(h[k],b):h[k].data=i.extend(h[k].data,b);j=a=h[k];e||(a.data||(a.data={}),a=a.data);d!==c&&(a[i.camelCase(b)]=d);if(u&&!a[b])return j.events;f?(d=a[b],null==d&&(d=a[i.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(i.acceptData(a)){var d,j,f,g=i.expando,h=a.nodeType,k=h?i.cache:a,u=h?a[g]:g;if(k[u]){if(b&&(d=c?k[u]:k[u].data)){i.isArray(b)||(b in d?b=[b]:(b=i.camelCase(b),
b=b in d?[b]:b.split(" ")));j=0;for(f=b.length;j<f;j++)delete d[b[j]];if(!(c?e:i.isEmptyObject)(d))return}if(!c&&(delete k[u].data,!e(k[u])))return;i.support.deleteExpando||!k.setInterval?delete k[u]:k[u]=null;h&&(i.support.deleteExpando?delete a[g]:a.removeAttribute?a.removeAttribute(g):a[g]=null)}}},_data:function(a,b,c){return i.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=i.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});i.fn.extend({data:function(a,
b){var d,e,j,g,h,k=this[0],u=0,n=null;if(a===c){if(this.length&&(n=i.data(k),1===k.nodeType&&!i._data(k,"parsedAttrs"))){j=k.attributes;for(h=j.length;u<h;u++)g=j[u].name,0===g.indexOf("data-")&&(g=i.camelCase(g.substring(5)),f(k,g,n[g]));i._data(k,"parsedAttrs",!0)}return n}if("object"===typeof a)return this.each(function(){i.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";e=d[1]+"!";return i.access(this,function(b){if(b===c)return n=this.triggerHandler("getData"+e,[d[0]]),n===c&&k&&(n=i.data(k,
a),n=f(k,a,n)),n===c&&d[1]?this.data(d[0]):n;d[1]=b;this.each(function(){var c=i(this);c.triggerHandler("setData"+e,d);i.data(this,a,b);c.triggerHandler("changeData"+e,d)})},null,b,1<arguments.length,null,!1)},removeData:function(a){return this.each(function(){i.removeData(this,a)})}});i.extend({_mark:function(a,b){a&&(b=(b||"fx")+"mark",i._data(a,b,(i._data(a,b)||0)+1))},_unmark:function(a,b,c){!0!==a&&(c=b,b=a,a=!1);if(b){var c=c||"fx",d=c+"mark";(a=a?0:(i._data(b,d)||1)-1)?i._data(b,d,a):(i.removeData(b,
d,!0),h(b,c,"mark"))}},queue:function(a,b,c){var d;if(a)return b=(b||"fx")+"queue",d=i._data(a,b),c&&(!d||i.isArray(c)?d=i._data(a,b,i.makeArray(c)):d.push(c)),d||[]},dequeue:function(a,b){var b=b||"fx",c=i.queue(a,b),d=c.shift(),e={};"inprogress"===d&&(d=c.shift());d&&("fx"===b&&c.unshift("inprogress"),i._data(a,b+".run",e),d.call(a,function(){i.dequeue(a,b)},e));c.length||(i.removeData(a,b+"queue "+b+".run",!0),h(a,b,"queue"))}});i.fn.extend({queue:function(a,b){var d=2;"string"!==typeof a&&(b=
a,a="fx",d--);return arguments.length<d?i.queue(this[0],a):b===c?this:this.each(function(){var c=i.queue(this,a,b);a==="fx"&&c[0]!=="inprogress"&&i.dequeue(this,a)})},dequeue:function(a){return this.each(function(){i.dequeue(this,a)})},delay:function(a,b){a=i.fx?i.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){function d(){--g||e.resolveWith(j,[j])}"string"!==
typeof a&&(b=a,a=c);for(var a=a||"fx",e=i.Deferred(),j=this,f=j.length,g=1,h=a+"defer",k=a+"queue",u=a+"mark",n;f--;)if(n=i.data(j[f],h,c,!0)||(i.data(j[f],k,c,!0)||i.data(j[f],u,c,!0))&&i.data(j[f],h,i.Callbacks("once memory"),!0))g++,n.add(d);d();return e.promise(b)}});var P=/[\n\t\r]/g,I=/\s+/,G=/\r/g,O=/^(?:button|input)$/i,N=/^(?:button|input|object|select|textarea)$/i,W=/^a(?:rea)?$/i,X=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
S=i.support.getSetAttribute,j,u,z;i.fn.extend({attr:function(a,b){return i.access(this,i.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){i.removeAttr(this,a)})},prop:function(a,b){return i.access(this,i.prop,a,b,1<arguments.length)},removeProp:function(a){a=i.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,e,j,f,g;if(i.isFunction(a))return this.each(function(b){i(this).addClass(a.call(this,b,this.className))});
if(a&&"string"===typeof a){b=a.split(I);c=0;for(d=this.length;c<d;c++)if(e=this[c],1===e.nodeType)if(!e.className&&1===b.length)e.className=a;else{j=" "+e.className+" ";f=0;for(g=b.length;f<g;f++)~j.indexOf(" "+b[f]+" ")||(j+=b[f]+" ");e.className=i.trim(j)}}return this},removeClass:function(a){var b,d,e,j,f,g,h;if(i.isFunction(a))return this.each(function(b){i(this).removeClass(a.call(this,b,this.className))});if(a&&"string"===typeof a||a===c){b=(a||"").split(I);d=0;for(e=this.length;d<e;d++)if(j=
this[d],1===j.nodeType&&j.className)if(a){f=(" "+j.className+" ").replace(P," ");g=0;for(h=b.length;g<h;g++)f=f.replace(" "+b[g]+" "," ");j.className=i.trim(f)}else j.className=""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return i.isFunction(a)?this.each(function(c){i(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,j=0,f=i(this),g=b,h=a.split(I);e=h[j++];)g=d?g:!f.hasClass(e),f[g?"addClass":"removeClass"](e);
else if("undefined"===c||"boolean"===c)this.className&&i._data(this,"__className__",this.className),this.className=this.className||!1===a?"":i._data(this,"__className__")||""})},hasClass:function(a){for(var a=" "+a+" ",b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&-1<(" "+this[b].className+" ").replace(P," ").indexOf(a))return!0;return!1},val:function(a){var b,d,e,j=this[0];if(arguments.length)return e=i.isFunction(a),this.each(function(d){var j=i(this);if(1===this.nodeType&&(d=e?a.call(this,
d,j.val()):a,null==d?d="":"number"===typeof d?d+="":i.isArray(d)&&(d=i.map(d,function(a){return a==null?"":a+""})),b=i.valHooks[this.type]||i.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(j){if((b=i.valHooks[j.type]||i.valHooks[j.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(j,"value"))!==c)return d;d=j.value;return"string"===typeof d?d.replace(G,""):null==d?"":d}}});i.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
b.specified?a.value:a.text}},select:{get:function(a){var b,c,d=a.selectedIndex,e=[],j=a.options,f="select-one"===a.type;if(0>d)return null;a=f?d:0;for(c=f?d+1:j.length;a<c;a++)if(b=j[a],b.selected&&(i.support.optDisabled?!b.disabled:null===b.getAttribute("disabled"))&&(!b.parentNode.disabled||!i.nodeName(b.parentNode,"optgroup"))){b=i(b).val();if(f)return b;e.push(b)}return f&&!e.length&&j.length?i(j[d]).val():e},set:function(a,b){var c=i.makeArray(b);i(a).find("option").each(function(){this.selected=
0<=i.inArray(i(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,e){var f,g,h=a.nodeType;if(a&&!(3===h||8===h||2===h)){if(e&&b in i.attrFn)return i(a)[b](d);if("undefined"===typeof a.getAttribute)return i.prop(a,b,d);if(e=1!==h||!i.isXMLDoc(a))b=b.toLowerCase(),g=i.attrHooks[b]||(X.test(b)?u:j);if(d!==c)if(null===d)i.removeAttr(a,b);else{if(g&&"set"in g&&e&&(f=g.set(a,d,b))!==c)return f;a.setAttribute(b,
""+d);return d}else{if(g&&"get"in g&&e&&null!==(f=g.get(a,b)))return f;f=a.getAttribute(b);return null===f?c:f}}},removeAttr:function(a,b){var c,d,e,j,f,g=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(I);for(j=d.length;g<j;g++)if(e=d[g])c=i.propFix[e]||e,(f=X.test(e))||i.attr(a,e,""),a.removeAttribute(S?e:c),f&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(O.test(a.nodeName)&&a.parentNode)i.error("type property can't be changed");else if(!i.support.radioValue&&"radio"===b&&i.nodeName(a,
"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}},value:{get:function(a,b){return j&&i.nodeName(a,"button")?j.get(a,b):b in a?a.value:null},set:function(a,b,c){if(j&&i.nodeName(a,"button"))return j.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},
prop:function(a,b,d){var e,j,f=a.nodeType;if(a&&!(3===f||8===f||2===f)){if(1!==f||!i.isXMLDoc(a))b=i.propFix[b]||b,j=i.propHooks[b];return d!==c?j&&"set"in j&&(e=j.set(a,d,b))!==c?e:a[b]=d:j&&"get"in j&&null!==(e=j.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):N.test(a.nodeName)||W.test(a.nodeName)&&a.href?0:c}}}});i.attrHooks.tabindex=i.propHooks.tabIndex;u={get:function(a,b){var d,e=i.prop(a,b);return!0===
e||"boolean"!==typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?i.removeAttr(a,c):(b=i.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};S||(z={name:!0,id:!0,coords:!0},j=i.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(z[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=v.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
i.attrHooks.tabindex.set=j.set,i.each(["width","height"],function(a,b){i.attrHooks[b]=i.extend(i.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),i.attrHooks.contenteditable={get:j.get,set:function(a,b,c){""===b&&(b="false");j.set(a,b,c)}});i.support.hrefNormalized||i.each(["href","src","width","height"],function(a,b){i.attrHooks[b]=i.extend(i.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return a===null?c:a}})});i.support.style||(i.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
c},set:function(a,b){return a.style.cssText=""+b}});i.support.optSelected||(i.propHooks.selected=i.extend(i.propHooks.selected,{get:function(a){if(a=a.parentNode){a.selectedIndex;a.parentNode&&a.parentNode.selectedIndex}return null}}));i.support.enctype||(i.propFix.enctype="encoding");i.support.checkOn||i.each(["radio","checkbox"],function(){i.valHooks[this]={get:function(a){return a.getAttribute("value")===null?"on":a.value}}});i.each(["radio","checkbox"],function(){i.valHooks[this]=i.extend(i.valHooks[this],
{set:function(a,b){if(i.isArray(b))return a.checked=i.inArray(i(a).val(),b)>=0}})});var L=/^(?:textarea|input|select)$/i,U=/^([^\.]*)?(?:\.(.+))?$/,Y=/(?:^|\s)hover(\.\S+)?\b/,ca=/^key/,$=/^(?:mouse|contextmenu)|click/,ka=/^(?:focusinfocus|focusoutblur)$/,oa=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,pa=function(a){if(a=oa.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},la=function(a){return i.event.special.hover?a:a.replace(Y,"mouseenter$1 mouseleave$1")};
i.event={add:function(a,b,d,e,j){var f,g,h,k,u,n,l,z,p;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(f=i._data(a)))){if(d.handler){l=d;d=l.handler;j=l.selector}if(!d.guid)d.guid=i.guid++;h=f.events;if(!h)f.events=h={};g=f.handle;if(!g){f.handle=g=function(a){return typeof i!=="undefined"&&(!a||i.event.triggered!==a.type)?i.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=i.trim(la(b)).split(" ");for(f=0;f<b.length;f++){k=U.exec(b[f])||[];u=k[1];n=(k[2]||"").split(".").sort();p=i.event.special[u]||
{};u=(j?p.delegateType:p.bindType)||u;p=i.event.special[u]||{};k=i.extend({type:u,origType:k[1],data:e,handler:d,guid:d.guid,selector:j,quick:j&&pa(j),namespace:n.join(".")},l);z=h[u];if(!z){z=h[u]=[];z.delegateCount=0;if(!p.setup||p.setup.call(a,e,n,g)===false)a.addEventListener?a.addEventListener(u,g,false):a.attachEvent&&a.attachEvent("on"+u,g)}if(p.add){p.add.call(a,k);if(!k.handler.guid)k.handler.guid=d.guid}j?z.splice(z.delegateCount++,0,k):z.push(k);i.event.global[u]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var j=i.hasData(a)&&i._data(a),f,g,h,k,u,n,l,z,p,o;if(j&&(l=j.events)){b=i.trim(la(b||"")).split(" ");for(f=0;f<b.length;f++){g=U.exec(b[f])||[];h=k=g[1];g=g[2];if(h){z=i.event.special[h]||{};h=(d?z.delegateType:z.bindType)||h;p=l[h]||[];u=p.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(n=0;n<p.length;n++){o=p[n];if((e||k===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){p.splice(n--,
1);o.selector&&p.delegateCount--;z.remove&&z.remove.call(a,o)}}if(p.length===0&&u!==p.length){(!z.teardown||z.teardown.call(a,g)===false)&&i.removeEvent(a,h,j.handle);delete l[h]}}else for(h in l)i.event.remove(a,h+b[f],c,d,true)}if(i.isEmptyObject(l)){if(b=j.handle)b.elem=null;i.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,j){if(!e||!(e.nodeType===3||e.nodeType===8)){var f=b.type||b,g=[],h,k,u,n,l;if(!ka.test(f+i.event.triggered)){if(f.indexOf("!")>=
0){f=f.slice(0,-1);h=true}if(f.indexOf(".")>=0){g=f.split(".");f=g.shift();g.sort()}if(e&&!i.event.customEvent[f]||i.event.global[f]){b=typeof b==="object"?b[i.expando]?b:new i.Event(f,b):new i.Event(f);b.type=f;b.isTrigger=true;b.exclusive=h;b.namespace=g.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;h=f.indexOf(":")<0?"on"+f:"";if(e){b.result=c;if(!b.target)b.target=e;d=d!=null?i.makeArray(d):[];d.unshift(b);u=i.event.special[f]||{};if(!(u.trigger&&
u.trigger.apply(e,d)===false)){l=[[e,u.bindType||f]];if(!j&&!u.noBubble&&!i.isWindow(e)){n=u.delegateType||f;g=ka.test(n+f)?e:e.parentNode;for(k=null;g;g=g.parentNode){l.push([g,n]);k=g}k&&k===e.ownerDocument&&l.push([k.defaultView||k.parentWindow||a,n])}for(k=0;k<l.length&&!b.isPropagationStopped();k++){g=l[k][0];b.type=l[k][1];(n=(i._data(g,"events")||{})[b.type]&&i._data(g,"handle"))&&n.apply(g,d);(n=h&&g[h])&&i.acceptData(g)&&n.apply(g,d)===false&&b.preventDefault()}b.type=f;if(!j&&!b.isDefaultPrevented()&&
(!u._default||u._default.apply(e.ownerDocument,d)===false)&&!(f==="click"&&i.nodeName(e,"a"))&&i.acceptData(e))if(h&&e[f]&&(f!=="focus"&&f!=="blur"||b.target.offsetWidth!==0)&&!i.isWindow(e)){(k=e[h])&&(e[h]=null);i.event.triggered=f;e[f]();i.event.triggered=c;k&&(e[h]=k)}return b.result}}else{e=i.cache;for(k in e)e[k].events&&e[k].events[f]&&i.event.trigger(b,d,e[k].handle.elem,true)}}}}},dispatch:function(b){var b=i.event.fix(b||a.event),d=(i._data(this,"events")||{})[b.type]||[],e=d.delegateCount,
j=[].slice.call(arguments,0),f=!b.exclusive&&!b.namespace,g=i.event.special[b.type]||{},h=[],k,u,n,l,z,p,o;j[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){n=i(this);n.context=this.ownerDocument||this;for(u=b.target;u!=this;u=u.parentNode||this)if(u.disabled!==true){z={};p=[];n[0]=u;for(k=0;k<e;k++){l=d[k];o=l.selector;if(z[o]===c){var r=z,L=o,s;if(l.quick){s=l.quick;var U=u.attributes||{};s=(!s[1]||u.nodeName.toLowerCase()===
s[1])&&(!s[2]||(U.id||{}).value===s[2])&&(!s[3]||s[3].test((U["class"]||{}).value))}else s=n.is(o);r[L]=s}z[o]&&p.push(l)}p.length&&h.push({elem:u,matches:p})}}d.length>e&&h.push({elem:this,matches:d.slice(e)});for(k=0;k<h.length&&!b.isPropagationStopped();k++){e=h[k];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){l=e.matches[d];if(f||!b.namespace&&!l.namespace||b.namespace_re&&b.namespace_re.test(l.namespace)){b.data=l.data;b.handleObj=l;l=((i.event.special[l.origType]||
{}).handle||l.handler).apply(e.elem,j);if(l!==c){b.result=l;if(l===false){b.preventDefault();b.stopPropagation()}}}}}g.postDispatch&&g.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
return a}},mouseHooks:{props:"button,buttons,clientX,clientY,fromElement,offsetX,offsetY,pageX,pageY,screenX,screenY,toElement".split(","),filter:function(a,b){var d,e,j=b.button,f=b.fromElement;if(a.pageX==null&&b.clientX!=null){d=a.target.ownerDocument||v;e=d.documentElement;d=d.body;a.pageX=b.clientX+(e&&e.scrollLeft||d&&d.scrollLeft||0)-(e&&e.clientLeft||d&&d.clientLeft||0);a.pageY=b.clientY+(e&&e.scrollTop||d&&d.scrollTop||0)-(e&&e.clientTop||d&&d.clientTop||0)}if(!a.relatedTarget&&f)a.relatedTarget=
f===a.target?b.toElement:f;if(!a.which&&j!==c)a.which=j&1?1:j&2?3:j&4?2:0;return a}},fix:function(a){if(a[i.expando])return a;var b,d,e=a,j=i.event.fixHooks[a.type]||{},f=j.props?this.props.concat(j.props):this.props,a=i.Event(e);for(b=f.length;b;){d=f[--b];a[d]=e[d]}if(!a.target)a.target=e.srcElement||v;if(a.target.nodeType===3)a.target=a.target.parentNode;if(a.metaKey===c)a.metaKey=a.ctrlKey;return j.filter?j.filter(a,e):a},special:{ready:{setup:i.bindReady},load:{noBubble:!0},focus:{delegateType:"focusin"},
blur:{delegateType:"focusout"},beforeunload:{setup:function(a,b,c){if(i.isWindow(this))this.onbeforeunload=c},teardown:function(a,b){if(this.onbeforeunload===b)this.onbeforeunload=null}}},simulate:function(a,b,c,d){a=i.extend(new i.Event,c,{type:a,isSimulated:true,originalEvent:{}});d?i.event.trigger(a,null,b):i.event.dispatch.call(b,a);a.isDefaultPrevented()&&c.preventDefault()}};i.event.handle=i.event.dispatch;i.removeEvent=v.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,
c,false)}:function(a,b,c){a.detachEvent&&a.detachEvent("on"+b,c)};i.Event=function(a,c){if(!(this instanceof i.Event))return new i.Event(a,c);if(a&&a.type){this.originalEvent=a;this.type=a.type;this.isDefaultPrevented=a.defaultPrevented||a.returnValue===false||a.getPreventDefault&&a.getPreventDefault()?b:g}else this.type=a;c&&i.extend(this,c);this.timeStamp=a&&a.timeStamp||i.now();this[i.expando]=true};i.Event.prototype={preventDefault:function(){this.isDefaultPrevented=b;var a=this.originalEvent;
if(a)a.preventDefault?a.preventDefault():a.returnValue=false},stopPropagation:function(){this.isPropagationStopped=b;var a=this.originalEvent;if(a){a.stopPropagation&&a.stopPropagation();a.cancelBubble=true}},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=b;this.stopPropagation()},isDefaultPrevented:g,isPropagationStopped:g,isImmediatePropagationStopped:g};i.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){i.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c=
a.relatedTarget,d=a.handleObj,e;if(!c||c!==this&&!i.contains(this,c)){a.type=d.origType;e=d.handler.apply(this,arguments);a.type=b}return e}}});i.support.submitBubbles||(i.event.special.submit={setup:function(){if(i.nodeName(this,"form"))return false;i.event.add(this,"click._submit keypress._submit",function(a){a=a.target;if((a=i.nodeName(a,"input")||i.nodeName(a,"button")?a.form:c)&&!a._submit_attached){i.event.add(a,"submit._submit",function(a){a._submit_bubble=true});a._submit_attached=true}})},
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&i.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(i.nodeName(this,"form"))return false;i.event.remove(this,"._submit")}});i.support.changeBubbles||(i.event.special.change={setup:function(){if(L.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){i.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});i.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;i.event.simulate("change",this,a,true)}})}return false}i.event.add(this,"beforeactivate._change",function(a){a=a.target;if(L.test(a.nodeName)&&!a._change_attached){i.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&i.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){i.event.remove(this,"._change");return L.test(this.nodeName)}});i.support.focusinBubbles||i.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){i.event.simulate(b,a.target,i.event.fix(a),true)};i.event.special[b]={setup:function(){c++===0&&v.addEventListener(a,d,true)},teardown:function(){--c===0&&v.removeEventListener(a,d,true)}}});i.fn.extend({on:function(a,
b,d,e,j){var f,h;if(typeof a==="object"){if(typeof b!=="string"){d=d||b;b=c}for(h in a)this.on(h,b,d,a[h],j);return this}if(d==null&&e==null){e=b;d=b=c}else if(e==null)if(typeof b==="string"){e=d;d=c}else{e=d;d=b;b=c}if(e===false)e=g;else if(!e)return this;if(j===1){f=e;e=function(a){i().off(a);return f.apply(this,arguments)};e.guid=f.guid||(f.guid=i.guid++)}return this.each(function(){i.event.add(this,a,e,d,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,d){if(a&&a.preventDefault&&
a.handleObj){var e=a.handleObj;i(a.delegateTarget).off(e.namespace?e.origType+"."+e.namespace:e.origType,e.selector,e.handler);return this}if(typeof a==="object"){for(e in a)this.off(e,b,a[e]);return this}if(b===false||typeof b==="function"){d=b;b=c}d===false&&(d=g);return this.each(function(){i.event.remove(this,a,d,b)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},live:function(a,b,c){i(this.context).on(a,this.selector,b,c);return this},die:function(a,
b){i(this.context).off(a,this.selector||"**",b);return this},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return arguments.length==1?this.off(a,"**"):this.off(b,a,c)},trigger:function(a,b){return this.each(function(){i.event.trigger(a,b,this)})},triggerHandler:function(a,b){if(this[0])return i.event.trigger(a,b,this[0],true)},toggle:function(a){var b=arguments,c=a.guid||i.guid++,d=0,e=function(c){var e=(i._data(this,"lastToggle"+a.guid)||0)%d;i._data(this,"lastToggle"+
a.guid,e+1);c.preventDefault();return b[e].apply(this,arguments)||false};for(e.guid=c;d<b.length;)b[d++].guid=c;return this.click(e)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});i.each("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error,contextmenu".split(","),function(a,b){i.fn[b]=function(a,c){if(c==null){c=a;a=null}return arguments.length>
0?this.on(b,null,a,c):this.trigger(b)};i.attrFn&&(i.attrFn[b]=true);if(ca.test(b))i.event.fixHooks[b]=i.event.keyHooks;if($.test(b))i.event.fixHooks[b]=i.event.mouseHooks});(function(){function a(b,c,d,j,f,g){for(var f=0,h=j.length;f<h;f++){var k=j[f];if(k){for(var i=false,k=k[b];k;){if(k[e]===d){i=j[k.sizset];break}if(k.nodeType===1&&!g){k[e]=d;k.sizset=f}if(k.nodeName.toLowerCase()===c){i=k;break}k=k[b]}j[f]=i}}}function b(a,c,d,j,f,g){for(var f=0,h=j.length;f<h;f++){var k=j[f];if(k){for(var i=
false,k=k[a];k;){if(k[e]===d){i=j[k.sizset];break}if(k.nodeType===1){if(!g){k[e]=d;k.sizset=f}if(typeof c!=="string"){if(k===c){i=true;break}}else if(l.filter(c,[k]).length>0){i=k;break}}k=k[a]}j[f]=i}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e="sizcache"+(Math.random()+"").replace(".",""),j=0,f=Object.prototype.toString,g=false,h=true,k=/\\/g,u=/\r\n/g,n=/\W/;[0,0].sort(function(){h=false;return 0});
var l=function(a,b,c,e){var c=c||[],j=b=b||v;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,h,k,i,u,n=true,K=l.isXML(b),z=[],r=a;do{d.exec("");if(g=d.exec(r)){r=g[3];z.push(g[1]);if(g[2]){i=g[3];break}}}while(g);if(z.length>1&&o.exec(a))if(z.length===2&&p.relative[z[0]])h=m(z[0]+z[1],b,e);else for(h=p.relative[z[0]]?[b]:l(z.shift(),b);z.length;){a=z.shift();p.relative[a]&&(a=a+z.shift());h=m(a,h,e)}else{if(!e&&z.length>1&&b.nodeType===9&&!K&&p.match.ID.test(z[0])&&
!p.match.ID.test(z[z.length-1])){g=l.find(z.shift(),b,K);b=g.expr?l.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:z.pop(),set:L(e)}:l.find(z.pop(),z.length===1&&(z[0]==="~"||z[0]==="+")&&b.parentNode?b.parentNode:b,K);h=g.expr?l.filter(g.expr,g.set):g.set;for(z.length>0?k=L(h):n=false;z.length;){g=u=z.pop();p.relative[u]?g=z.pop():u="";g==null&&(g=b);p.relative[u](k,g,K)}}else k=[]}k||(k=h);k||l.error(u||a);if(f.call(k)==="[object Array]")if(n)if(b&&b.nodeType===1)for(a=0;k[a]!=null;a++)k[a]&&
(k[a]===true||k[a].nodeType===1&&l.contains(b,k[a]))&&c.push(h[a]);else for(a=0;k[a]!=null;a++)k[a]&&k[a].nodeType===1&&c.push(h[a]);else c.push.apply(c,k);else L(k,c);if(i){l(i,j,c,e);l.uniqueSort(c)}return c};l.uniqueSort=function(a){if(x){g=h;a.sort(x);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};l.matches=function(a,b){return l(a,null,null,b)};l.matchesSelector=function(a,b){return l(b,null,null,[a]).length>0};l.find=function(a,b,c){var d,e,j,f,g,h;if(!a)return[];e=
0;for(j=p.order.length;e<j;e++){g=p.order[e];if(f=p.leftMatch[g].exec(a)){h=f[1];f.splice(1,1);if(h.substr(h.length-1)!=="\\"){f[1]=(f[1]||"").replace(k,"");d=p.find[g](f,b,c);if(d!=null){a=a.replace(p.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};l.filter=function(a,b,d,e){for(var j,f,g,h,k,i,u,n,z=a,K=[],o=b,r=b&&b[0]&&l.isXML(b[0]);a&&b.length;){for(g in p.filter)if((j=p.leftMatch[g].exec(a))!=null&&j[2]){i=p.filter[g];
k=j[1];f=false;j.splice(1,1);if(k.substr(k.length-1)!=="\\"){o===K&&(K=[]);if(p.preFilter[g])if(j=p.preFilter[g](j,o,d,K,e,r)){if(j===true)continue}else f=h=true;if(j)for(u=0;(k=o[u])!=null;u++)if(k){h=i(k,j,u,o);n=e^h;if(d&&h!=null)n?f=true:o[u]=false;else if(n){K.push(k);f=true}}if(h!==c){d||(o=K);a=a.replace(p.match[g],"");if(!f)return[];break}}}if(a===z)if(f==null)l.error(a);else break;z=a}return o};l.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var z=l.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(u,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+z(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+z(c));return d},p=l.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!n.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,j;d<e;d++)if(j=a[d]){for(;(j=j.previousSibling)&&j.nodeType!==1;);a[d]=c||j&&j.nodeName.toLowerCase()===b?j||false:j===b}c&&l.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",e=0,j=a.length;if(d&&!n.test(b))for(b=b.toLowerCase();e<j;e++){if(c=a[e]){c=c.parentNode;a[e]=c.nodeName.toLowerCase()===b?c:false}}else{for(;e<
j;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&l.filter(b,a,true)}},"":function(c,d,e){var f,g=j++,h=b;if(typeof d==="string"&&!n.test(d)){f=d=d.toLowerCase();h=a}h("parentNode",d,g,c,f,e)},"~":function(c,d,e){var f,g=j++,h=b;if(typeof d==="string"&&!n.test(d)){f=d=d.toLowerCase();h=a}h("previousSibling",d,g,c,f,e)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
"undefined"){for(var c=[],d=b.getElementsByName(a[1]),e=0,j=d.length;e<j;e++)d[e].getAttribute("name")===a[1]&&c.push(d[e]);return c.length===0?null:c}},TAG:function(a,b){if(typeof b.getElementsByTagName!=="undefined")return b.getElementsByTagName(a[1])}},preFilter:{CLASS:function(a,b,c,d,e,j){a=" "+a[1].replace(k,"")+" ";if(j)return a;for(var j=0,f;(f=b[j])!=null;j++)f&&(e^(f.className&&(" "+f.className+" ").replace(/[\t\n\r]/g," ").indexOf(a)>=0)?c||d.push(f):c&&(b[j]=false));return false},ID:function(a){return a[1].replace(k,
"")},TAG:function(a){return a[1].replace(k,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||l.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&l.error(a[0]);a[0]=j++;return a},ATTR:function(a,b,c,d,e,j){b=a[1]=a[1].replace(k,"");!j&&p.attrMap[b]&&(a[1]=p.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(k,"");a[2]==="~="&&(a[4]=" "+a[4]+
" ");return a},PSEUDO:function(a,b,c,e,j){if(a[1]==="not")if((d.exec(a[3])||"").length>1||/^\w/.test(a[3]))a[3]=l(a[3],null,null,b);else{a=l.filter(a[3],b,c,1^j);c||e.push.apply(e,a);return false}else if(p.match.POS.test(a[0])||p.match.CHILD.test(a[0]))return true;return a},POS:function(a){a.unshift(true);return a}},filters:{enabled:function(a){return a.disabled===false&&a.type!=="hidden"},disabled:function(a){return a.disabled===true},checked:function(a){return a.checked===true},selected:function(a){a.parentNode&&
...
b,c,d){var e=b[1],j=p.filters[e];if(j)return j(a,c,b,d);if(e==="contains")return(a.textContent||a.innerText||z([a])||"").indexOf(b[3])>=0;if(e==="not"){b=b[3];c=0;for(d=b.length;c<d;c++)if(b[c]===a)return false;return true}l.error(e)},CHILD:function(a,b){var c,d,j,f,g,h;c=b[1];h=a;switch(c){case "only":case "first":for(;h=h.previousSibling;)if(h.nodeType===1)return false;if(c==="first")return true;h=a;case "last":for(;h=h.nextSibling;)if(h.nodeType===1)return false;return true;case "nth":c=b[2];d=
b[3];if(c===1&&d===0)return true;j=b[0];if((f=a.parentNode)&&(f[e]!==j||!a.nodeIndex)){g=0;for(h=f.firstChild;h;h=h.nextSibling)if(h.nodeType===1)h.nodeIndex=++g;f[e]=j}h=a.nodeIndex-d;return c===0?h===0:h%c===0&&h/c>=0}},ID:function(a,b){return a.nodeType===1&&a.getAttribute("id")===b},TAG:function(a,b){return b==="*"&&a.nodeType===1||!!a.nodeName&&a.nodeName.toLowerCase()===b},CLASS:function(a,b){return(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)>-1},ATTR:function(a,b){var c=b[1],
c=l.attr?l.attr(a,c):p.attrHandle[c]?p.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],j=b[4];return c==null?e==="!=":!e&&l.attr?c!=null:e==="="?d===j:e==="*="?d.indexOf(j)>=0:e==="~="?(" "+d+" ").indexOf(j)>=0:!j?d&&c!==false:e==="!="?d!==j:e==="^="?d.indexOf(j)===0:e==="$="?d.substr(d.length-j.length)===j:e==="|="?d===j||d.substr(0,j.length+1)===j+"-":false},POS:function(a,b,c,d){var e=p.setFilters[b[2]];if(e)return e(a,c,b,d)}}},o=p.match.POS,r=function(a,b){return"\\"+(b-0+1)},
s;for(s in p.match){p.match[s]=RegExp(p.match[s].source+/(?![^\[]*\])(?![^\(]*\))/.source);p.leftMatch[s]=RegExp(/(^(?:.|\r|\n)*?)/.source+p.match[s].source.replace(/\\(\d+)/g,r))}p.match.globalPOS=o;var L=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(v.documentElement.childNodes,0)[0].nodeType}catch(U){L=function(a,b){var c=0,d=b||[];if(f.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var x,q;if(v.documentElement.compareDocumentPosition)x=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{x=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],j=[];c=a.parentNode;d=b.parentNode;var f=c;if(c===d)return q(a,
b);if(c){if(!d)return 1}else return-1;for(;f;){e.unshift(f);f=f.parentNode}for(f=d;f;){j.unshift(f);f=f.parentNode}c=e.length;d=j.length;for(f=0;f<c&&f<d;f++)if(e[f]!==j[f])return q(e[f],j[f]);return f===c?q(a,j[f],-1):q(e[f],b,1)};q=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=v.createElement("div"),b="script"+(new Date).getTime(),d=v.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(v.getElementById(b)){p.find.ID=
function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};p.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=v.createElement("div");a.appendChild(v.createComment(""));if(a.getElementsByTagName("*").length>0)p.find.TAG=function(a,
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],e=0;c[e];e++)c[e].nodeType===1&&d.push(c[e]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")p.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();v.querySelectorAll&&function(){var a=l,b=v.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){l=
function(b,c,d,e){c=c||v;if(!e&&!l.isXML(c)){var j=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(j&&(c.nodeType===1||c.nodeType===9)){if(j[1])return L(c.getElementsByTagName(b),d);if(j[2]&&p.find.CLASS&&c.getElementsByClassName)return L(c.getElementsByClassName(j[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return L([c.body],d);if(j&&j[3]){var f=c.getElementById(j[3]);if(f&&f.parentNode){if(f.id===j[3])return L([f],d)}else return L([],d)}try{return L(c.querySelectorAll(b),d)}catch(g){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var j=c,h=(f=c.getAttribute("id"))||"__sizzle__",k=c.parentNode,i=/^\s*[+~]/.test(b);f?h=h.replace(/'/g,"\\$&"):c.setAttribute("id",h);if(i&&k)c=c.parentNode;try{if(!i||k)return L(c.querySelectorAll("[id='"+h+"'] "+b),d)}catch(u){}finally{f||j.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)l[c]=a[c];b=null}}();(function(){var a=v.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(v.createElement("div"),
"div"),d=false;try{b.call(v.documentElement,"[test!='']:sizzle")}catch(e){d=true}l.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!l.isXML(a))try{if(d||!p.match.PSEUDO.test(e)&&!/!=/.test(e)){var j=b.call(a,e);if(j||!c||a.document&&a.document.nodeType!==11)return j}}catch(f){}return l(e,null,null,[a]).length>0}}})();(function(){var a=v.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){p.order.splice(1,0,"CLASS");p.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();l.contains=v.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:v.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};l.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var m=function(a,b,c){for(var d,e=[],j="",b=b.nodeType?[b]:b;d=p.match.PSEUDO.exec(a);){j=j+d[0];a=a.replace(p.match.PSEUDO,"")}a=p.relative[a]?a+"*":a;d=0;for(var f=b.length;d<f;d++)l(a,b[d],e,c);return l.filter(j,e)};l.attr=i.attr;l.selectors.attrMap={};i.find=l;i.expr=l.selectors;i.expr[":"]=i.expr.filters;i.unique=l.uniqueSort;i.text=l.getText;i.isXMLDoc=l.isXML;i.contains=l.contains})();var ma=/Until$/,Xa=/^(?:parents|prevUntil|prevAll)/,Ya=/,/,
Za=/^.[^:#\[\.,]*$/,$a=Array.prototype.slice,Fa=i.expr.match.globalPOS,ab={children:!0,contents:!0,next:!0,prev:!0};i.fn.extend({find:function(a){var b=this,c,d;if(typeof a!=="string")return i(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(i.contains(b[c],this))return true});var e=this.pushStack("","find",a),j,f,g;c=0;for(d=this.length;c<d;c++){j=e.length;i.find(a,this[c],e);if(c>0)for(f=j;f<e.length;f++)for(g=0;g<j;g++)if(e[g]===e[f]){e.splice(f--,1);break}}return e},has:function(a){var b=i(a);
return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(i.contains(this,b[a]))return true})},not:function(a){return this.pushStack(k(this,a,false),"not",a)},filter:function(a){return this.pushStack(k(this,a,true),"filter",a)},is:function(a){return!!a&&(typeof a==="string"?Fa.test(a)?i(a,this.context).index(this[0])>=0:i.filter(a,this).length>0:this.filter(a).length>0)},closest:function(a,b){var c=[],d,e,j=this[0];if(i.isArray(a)){for(e=1;j&&j.ownerDocument&&j!==b;){for(d=0;d<a.length;d++)i(j).is(a[d])&&
c.push({selector:a[d],elem:j,level:e});j=j.parentNode;e++}return c}var f=Fa.test(a)||typeof a!=="string"?i(a,b||this.context):0;d=0;for(e=this.length;d<e;d++)for(j=this[d];j;)if(f?f.index(j)>-1:i.find.matchesSelector(j,a)){c.push(j);break}else{j=j.parentNode;if(!j||!j.ownerDocument||j===b||j.nodeType===11)break}c=c.length>1?i.unique(c):c;return this.pushStack(c,"closest",a)},index:function(a){return!a?this[0]&&this[0].parentNode?this.prevAll().length:-1:typeof a==="string"?i.inArray(this[0],i(a)):
i.inArray(a.jquery?a[0]:a,this)},add:function(a,b){var c=typeof a==="string"?i(a,b):i.makeArray(a&&a.nodeType?[a]:a),d=i.merge(this.get(),c);return this.pushStack(!c[0]||!c[0].parentNode||c[0].parentNode.nodeType===11||!d[0]||!d[0].parentNode||d[0].parentNode.nodeType===11?d:i.unique(d))},andSelf:function(){return this.add(this.prevObject)}});i.each({parent:function(a){return(a=a.parentNode)&&a.nodeType!==11?a:null},parents:function(a){return i.dir(a,"parentNode")},parentsUntil:function(a,b,c){return i.dir(a,
"parentNode",c)},next:function(a){return i.nth(a,2,"nextSibling")},prev:function(a){return i.nth(a,2,"previousSibling")},nextAll:function(a){return i.dir(a,"nextSibling")},prevAll:function(a){return i.dir(a,"previousSibling")},nextUntil:function(a,b,c){return i.dir(a,"nextSibling",c)},prevUntil:function(a,b,c){return i.dir(a,"previousSibling",c)},siblings:function(a){return i.sibling((a.parentNode||{}).firstChild,a)},children:function(a){return i.sibling(a.firstChild)},contents:function(a){return i.nodeName(a,
"iframe")?a.contentDocument||a.contentWindow.document:i.makeArray(a.childNodes)}},function(a,b){i.fn[a]=function(c,d){var e=i.map(this,b,c);ma.test(a)||(d=c);d&&typeof d==="string"&&(e=i.filter(d,e));e=this.length>1&&!ab[a]?i.unique(e):e;if((this.length>1||Ya.test(d))&&Xa.test(a))e=e.reverse();return this.pushStack(e,a,$a.call(arguments).join(","))}});i.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?i.find.matchesSelector(b[0],a)?[b[0]]:[]:i.find.matches(a,b)},dir:function(a,
b,d){for(var e=[],a=a[b];a&&a.nodeType!==9&&(d===c||a.nodeType!==1||!i(a).is(d));){a.nodeType===1&&e.push(a);a=a[b]}return e},nth:function(a,b,c){for(var b=b||1,d=0;a;a=a[c])if(a.nodeType===1&&++d===b)break;return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)a.nodeType===1&&a!==b&&c.push(a);return c}});var Ga="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",bb=/ jQuery\d+="(?:\d+|null)"/g,
va=/^\s+/,Ha=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ia=/<([\w:]+)/,eb=/<tbody/i,fb=/<|&#?\w+;/,cb=/<(?:script|style)/i,db=/<(?:script|object|embed|option|style)/i,Ja=RegExp("<(?:"+Ga+")[\\s/>]","i"),La=/checked\s*(?:[^=]|=\s*.checked.)/i,Ma=/\/(java|ecma)script/i,hb=/^\s*<!(?:\[CDATA\[|\-\-)/,Z={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ca=l(v);Z.optgroup=Z.option;Z.tbody=Z.tfoot=Z.colgroup=Z.caption=Z.thead;Z.th=Z.td;i.support.htmlSerialize||(Z._default=[1,"div<div>","</div>"]);i.fn.extend({text:function(a){return i.access(this,function(a){return a===c?i.text(this):this.empty().append((this[0]&&this[0].ownerDocument||v).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(i.isFunction(a))return this.each(function(b){i(this).wrapAll(a.call(this,
b))});if(this[0]){var b=i(a,this[0].ownerDocument).eq(0).clone(true);this[0].parentNode&&b.insertBefore(this[0]);b.map(function(){for(var a=this;a.firstChild&&a.firstChild.nodeType===1;)a=a.firstChild;return a}).append(this)}return this},wrapInner:function(a){return i.isFunction(a)?this.each(function(b){i(this).wrapInner(a.call(this,b))}):this.each(function(){var b=i(this),c=b.contents();c.length?c.wrapAll(a):b.append(a)})},wrap:function(a){var b=i.isFunction(a);return this.each(function(c){i(this).wrapAll(b?
a.call(this,c):a)})},unwrap:function(){return this.parent().each(function(){i.nodeName(this,"body")||i(this).replaceWith(this.childNodes)}).end()},append:function(){return this.domManip(arguments,true,function(a){this.nodeType===1&&this.appendChild(a)})},prepend:function(){return this.domManip(arguments,true,function(a){this.nodeType===1&&this.insertBefore(a,this.firstChild)})},before:function(){if(this[0]&&this[0].parentNode)return this.domManip(arguments,false,function(a){this.parentNode.insertBefore(a,
this)});if(arguments.length){var a=i.clean(arguments);a.push.apply(a,this.toArray());return this.pushStack(a,"before",arguments)}},after:function(){if(this[0]&&this[0].parentNode)return this.domManip(arguments,false,function(a){this.parentNode.insertBefore(a,this.nextSibling)});if(arguments.length){var a=this.pushStack(this,"after",arguments);a.push.apply(a,i.clean(arguments));return a}},remove:function(a,b){for(var c=0,d;(d=this[c])!=null;c++)if(!a||i.filter(a,[d]).length){if(!b&&d.nodeType===1){i.cleanData(d.getElementsByTagName("*"));
i.cleanData([d])}d.parentNode&&d.parentNode.removeChild(d)}return this},empty:function(){for(var a=0,b;(b=this[a])!=null;a++)for(b.nodeType===1&&i.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=a==null?false:a;b=b==null?a:b;return this.map(function(){return i.clone(this,a,b)})},html:function(a){return i.access(this,function(a){var b=this[0]||{},d=0,e=this.length;if(a===c)return b.nodeType===1?b.innerHTML.replace(bb,""):null;if(typeof a===
"string"&&!cb.test(a)&&(i.support.leadingWhitespace||!va.test(a))&&!Z[(Ia.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ha,"<$1></$2>");try{for(;d<e;d++){b=this[d]||{};if(b.nodeType===1){i.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(j){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(i.isFunction(a))return this.each(function(b){var c=i(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=
i(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;i(this).remove();b?i(b).before(a):i(c).append(a)})}return this.length?this.pushStack(i(i.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,j,f,g=a[0],h=[];if(!i.support.checkClone&&arguments.length===3&&typeof g==="string"&&La.test(g))return this.each(function(){i(this).domManip(a,b,d,true)});if(i.isFunction(g))return this.each(function(e){var j=
i(this);a[0]=g.call(this,e,b?j.html():c);j.domManip(a,b,d)});if(this[0]){e=g&&g.parentNode;e=i.support.parentNode&&e&&e.nodeType===11&&e.childNodes.length===this.length?{fragment:e}:i.buildFragment(a,this,h);f=e.fragment;if(j=f.childNodes.length===1?f=f.firstChild:f.firstChild){b=b&&i.nodeName(j,"tr");j=0;for(var k=this.length,u=k-1;j<k;j++)d.call(b?i.nodeName(this[j],"table")?this[j].getElementsByTagName("tbody")[0]||this[j].appendChild(this[j].ownerDocument.createElement("tbody")):this[j]:this[j],
e.cacheable||k>1&&j<u?i.clone(f,true,true):f)}h.length&&i.each(h,function(a,b){b.src?i.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):i.globalEval((b.text||b.textContent||b.innerHTML||"").replace(hb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});i.buildFragment=function(a,b,c){var d,e,j,f,g=a[0];b&&b[0]&&(f=b[0].ownerDocument||b[0]);f.createDocumentFragment||(f=v);if(a.length===1&&typeof g==="string"&&g.length<512&&f===v&&g.charAt(0)==="<"&&!db.test(g)&&
(i.support.checkClone||!La.test(g))&&(i.support.html5Clone||!Ja.test(g))){e=true;(j=i.fragments[g])&&j!==1&&(d=j)}if(!d){d=f.createDocumentFragment();i.clean(a,f,d,c)}e&&(i.fragments[g]=j?d:1);return{fragment:d,cacheable:e}};i.fragments={};i.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){i.fn[a]=function(c){var d=[],c=i(c),e=this.length===1&&this[0].parentNode;if(e&&e.nodeType===11&&e.childNodes.length===1&&c.length===
1){c[b](this[0]);return this}for(var e=0,j=c.length;e<j;e++){var f=(e>0?this.clone(true):this).get();i(c[e])[b](f);d=d.concat(f)}return this.pushStack(d,a,c.selector)}});i.extend({clone:function(a,b,c){var d,e,j;if(i.support.html5Clone||i.isXMLDoc(a)||!Ja.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=v.createElement("div");Ca.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var f=d;if((!i.support.noCloneEvent||!i.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!i.isXMLDoc(a)){n(a,
f);d=p(a);e=p(f);for(j=0;d[j];++j)e[j]&&n(d[j],e[j])}if(b){o(a,f);if(c){d=p(a);e=p(f);for(j=0;d[j];++j)o(d[j],e[j])}}return f},clean:function(a,b,c,d){var e,j=[],b=b||v;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||v);for(var f=0,g;(g=a[f])!=null;f++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(fb.test(g)){g=g.replace(Ha,"<$1></$2>");e=(Ia.exec(g)||["",""])[1].toLowerCase();var h=Z[e]||Z._default,k=h[0],u=b.createElement("div"),n=Ca.childNodes;
b===v?Ca.appendChild(u):l(b).appendChild(u);for(u.innerHTML=h[1]+g+h[2];k--;)u=u.lastChild;if(!i.support.tbody){k=eb.test(g);h=e==="table"&&!k?u.firstChild&&u.firstChild.childNodes:h[1]==="<table>"&&!k?u.childNodes:[];for(e=h.length-1;e>=0;--e)i.nodeName(h[e],"tbody")&&!h[e].childNodes.length&&h[e].parentNode.removeChild(h[e])}!i.support.leadingWhitespace&&va.test(g)&&u.insertBefore(b.createTextNode(va.exec(g)[0]),u.firstChild);g=u.childNodes;if(u){u.parentNode.removeChild(u);if(n.length>0)(u=n[n.length-
1])&&u.parentNode&&u.parentNode.removeChild(u)}}else g=b.createTextNode(g);var z;if(!i.support.appendChecked)if(g[0]&&typeof(z=g.length)==="number")for(e=0;e<z;e++)s(g[e]);else s(g);g.nodeType?j.push(g):j=i.merge(j,g)}}if(c){a=function(a){return!a.type||Ma.test(a.type)};for(f=0;j[f];f++){b=j[f];if(d&&i.nodeName(b,"script")&&(!b.type||Ma.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=i.grep(b.getElementsByTagName("script"),a);j.splice.apply(j,[f+1,0].concat(g))}c.appendChild(b)}}}return j},
cleanData:function(a){for(var b,c,d=i.cache,e=i.event.special,j=i.support.deleteExpando,f=0,g;(g=a[f])!=null;f++)if(!g.nodeName||!i.noData[g.nodeName.toLowerCase()])if(c=g[i.expando]){if((b=d[c])&&b.events){for(var h in b.events)e[h]?i.event.remove(g,h):i.removeEvent(g,h,b.handle);if(b.handle)b.handle.elem=null}j?delete g[i.expando]:g.removeAttribute&&g.removeAttribute(i.expando);delete d[c]}}});var Da=/alpha\([^)]*\)/i,ib=/opacity=([^)]*)/,jb=/([A-Z]|^ms)/g,kb=/^[\-+]?(?:\d*\.)?\d+$/i,xa=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
lb=/^([\-+])=([\-+.\de]+)/,mb=/^margin/,nb={position:"absolute",visibility:"hidden",display:"block"},da=["Top","Right","Bottom","Left"],ga,Na,Oa;i.fn.css=function(a,b){return i.access(this,function(a,b,d){return d!==c?i.style(a,b,d):i.css(a,b)},a,b,arguments.length>1)};i.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ga(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":i.support.cssFloat?
"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var j,f=i.camelCase(b),g=a.style,h=i.cssHooks[f],b=i.cssProps[f]||f;if(d!==c){e=typeof d;if(e==="string"&&(j=lb.exec(d))){d=+(j[1]+1)*+j[2]+parseFloat(i.css(a,b));e="number"}if(!(d==null||e==="number"&&isNaN(d))){e==="number"&&!i.cssNumber[f]&&(d=d+"px");if(!h||!("set"in h)||(d=h.set(a,d))!==c)try{g[b]=d}catch(k){}}}else return h&&"get"in h&&(j=h.get(a,false,e))!==c?j:g[b]}},css:function(a,b,d){var e,
j,b=i.camelCase(b);j=i.cssHooks[b];b=i.cssProps[b]||b;b==="cssFloat"&&(b="float");if(j&&"get"in j&&(e=j.get(a,true,d))!==c)return e;if(ga)return ga(a,b)},swap:function(a,b,c){var d={},e;for(e in b){d[e]=a.style[e];a.style[e]=b[e]}c=c.call(a);for(e in b)a.style[e]=d[e];return c}});i.curCSS=i.css;v.defaultView&&v.defaultView.getComputedStyle&&(Na=function(a,b){var c,d,e,j=a.style,b=b.replace(jb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(e=d.getComputedStyle(a,null))){c=e.getPropertyValue(b);
c===""&&!i.contains(a.ownerDocument.documentElement,a)&&(c=i.style(a,b))}if(!i.support.pixelMargin&&e&&mb.test(b)&&xa.test(c)){d=j.width;j.width=c;c=e.width;j.width=d}return c});v.documentElement.currentStyle&&(Oa=function(a,b){var c,d,e=a.currentStyle&&a.currentStyle[b],j=a.style;if(e==null&&j&&(c=j[b]))e=c;if(xa.test(e)){c=j.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;j.left=b==="fontSize"?"1em":e;e=j.pixelLeft+"px";j.left=c;if(d)a.runtimeStyle.left=d}return e===
""?"auto":e});ga=Na||Oa;i.each(["height","width"],function(a,b){i.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?x(a,b,d):i.swap(a,nb,function(){return x(a,b,d)})},set:function(a,b){return kb.test(b)?b+"px":b}}});i.support.opacity||(i.cssHooks.opacity={get:function(a,b){return ib.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=i.isNumeric(b)?"alpha(opacity="+b*100+")":"",j=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&i.trim(j.replace(Da,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Da.test(j)?j.replace(Da,e):j+" "+e}});i(function(){if(!i.support.reliableMarginRight)i.cssHooks.marginRight={get:function(a,b){return i.swap(a,{display:"inline-block"},function(){return b?ga(a,"margin-right"):a.style.marginRight})}}});i.expr&&i.expr.filters&&(i.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!i.support.reliableHiddenOffsets&&
(a.style&&a.style.display||i.css(a,"display"))==="none"},i.expr.filters.visible=function(a){return!i.expr.filters.hidden(a)});i.each({margin:"",padding:"",border:"Width"},function(a,b){i.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+da[c]+b]=d[c]||d[c-2]||d[0];return e}}});var ob=/%20/g,gb=/\[\]$/,Pa=/\r?\n/g,pb=/#.*$/,qb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,rb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
sb=/^(?:GET|HEAD)$/,tb=/^\/\//,Qa=/\?/,ub=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,vb=/^(?:select|textarea)/i,Ka=/\s+/,wb=/([?&])_=[^&]*/,Ra=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Sa=i.fn.load,ya={},Ta={},ea,fa,Ua=["*/"]+["*"];try{ea=M.href}catch(Cb){ea=v.createElement("a"),ea.href="",ea=ea.href}fa=Ra.exec(ea.toLowerCase())||[];i.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Sa)return Sa.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
0)var j=a.slice(e,a.length),a=a.slice(0,e);e="GET";if(b)if(i.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=i.param(b,i.ajaxSettings.traditional);e="POST"}var f=this;i.ajax({url:a,type:e,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});f.html(j?i("<div>").append(c.replace(ub,"")).find(j):c)}d&&f.each(d,[c,b,a])}});return this},serialize:function(){return i.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
i.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||vb.test(this.nodeName)||rb.test(this.type))}).map(function(a,b){var c=i(this).val();return c==null?null:i.isArray(c)?i.map(c,function(a){return{name:b.name,value:a.replace(Pa,"\r\n")}}):{name:b.name,value:c.replace(Pa,"\r\n")}}).get()}});i.each("ajaxStart,ajaxStop,ajaxComplete,ajaxError,ajaxSuccess,ajaxSend".split(","),function(a,b){i.fn[b]=function(a){return this.on(b,a)}});i.each(["get","post"],
function(a,b){i[b]=function(a,d,e,j){if(i.isFunction(d)){j=j||e;e=d;d=c}return i.ajax({type:b,url:a,data:d,success:e,dataType:j})}});i.extend({getScript:function(a,b){return i.get(a,c,b,"script")},getJSON:function(a,b,c){return i.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)A(a,i.ajaxSettings);else{b=a;a=i.ajaxSettings}A(a,b);return a},ajaxSettings:{url:ea,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(fa[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ua},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":i.parseJSON,"text xml":i.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:q(ya),ajaxTransport:q(Ta),ajax:function(a,b){function d(a,b,l,n){if(L!==2){L=2;r&&clearTimeout(r);o=c;z=n||"";q.readyState=
a>0?4:0;var p,s,K,n=b;if(l){var x=e,m=q,Y=x.contents,ba=x.dataTypes,B=x.responseFields,v,t,A,wa;for(t in B)t in l&&(m[B[t]]=l[t]);for(;ba[0]==="*";){ba.shift();v===c&&(v=x.mimeType||m.getResponseHeader("content-type"))}if(v)for(t in Y)if(Y[t]&&Y[t].test(v)){ba.unshift(t);break}if(ba[0]in l)A=ba[0];else{for(t in l){if(!ba[0]||x.converters[t+" "+ba[0]]){A=t;break}wa||(wa=t)}A=A||wa}if(A){A!==ba[0]&&ba.unshift(A);l=l[A]}else l=void 0}else l=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(v=q.getResponseHeader("Last-Modified"))i.lastModified[u]=
v;if(v=q.getResponseHeader("Etag"))i.etag[u]=v}if(a===304){n="notmodified";p=true}else try{v=e;v.dataFilter&&(l=v.dataFilter(l,v.dataType));var ca=v.dataTypes;t={};var C,y,E=ca.length,w,D=ca[0],$,H,F,G,I;for(C=1;C<E;C++){if(C===1)for(y in v.converters)typeof y==="string"&&(t[y.toLowerCase()]=v.converters[y]);$=D;D=ca[C];if(D==="*")D=$;else if($!=="*"&&$!==D){H=$+" "+D;F=t[H]||t["* "+D];if(!F){I=c;for(G in t){w=G.split(" ");if(w[0]===$||w[0]==="*")if(I=t[w[1]+" "+D]){G=t[G];G===true?F=I:I===true&&
(F=G);break}}}!F&&!I&&i.error("No conversion from "+H.replace(" "," to "));F!==true&&(l=F?F(l):I(G(l)))}}s=l;n="success";p=true}catch(J){n="parsererror";K=J}}else{K=n;if(!n||a){n="error";a<0&&(a=0)}}q.status=a;q.statusText=""+(b||n);p?g.resolveWith(j,[s,n,q]):g.rejectWith(j,[q,n,K]);q.statusCode(k);k=c;U&&f.trigger("ajax"+(p?"Success":"Error"),[q,e,p?s:K]);h.fireWith(j,[q,n]);if(U){f.trigger("ajaxComplete",[q,e]);--i.active||i.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},
e=i.ajaxSetup({},b),j=e.context||e,f=j!==e&&(j.nodeType||j instanceof i)?i(j):i.event,g=i.Deferred(),h=i.Callbacks("once memory"),k=e.statusCode||{},u,l={},n={},z,p,o,r,s,L=0,U,x,q={readyState:0,setRequestHeader:function(a,b){if(!L){var c=a.toLowerCase(),a=n[c]=n[c]||a;l[a]=b}return this},getAllResponseHeaders:function(){return L===2?z:null},getResponseHeader:function(a){var b;if(L===2){if(!p)for(p={};b=qb.exec(z);)p[b[1].toLowerCase()]=b[2];b=p[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!L)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(q);q.success=q.done;q.error=q.fail;q.complete=h.add;q.statusCode=function(a){if(a){var b;if(L<2)for(b in a)k[b]=[k[b],a[b]];else{b=a[q.status];q.then(b,b)}}return this};e.url=((a||e.url)+"").replace(pb,"").replace(tb,fa[1]+"//");e.dataTypes=i.trim(e.dataType||"*").toLowerCase().split(Ka);if(e.crossDomain==null){s=Ra.exec(e.url.toLowerCase());e.crossDomain=!(!s||!(s[1]!=fa[1]||s[2]!=fa[2]||(s[3]||(s[1]==="http:"?
80:443))!=(fa[3]||(fa[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=i.param(e.data,e.traditional);m(ya,e,b,q);if(L===2)return false;U=e.global;e.type=e.type.toUpperCase();e.hasContent=!sb.test(e.type);U&&i.active++===0&&i.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Qa.test(e.url)?"&":"?")+e.data);delete e.data}u=e.url;if(e.cache===false){s=i.now();var Y=e.url.replace(wb,"$1_="+s);e.url=Y+(Y===e.url?(Qa.test(e.url)?"&":"?")+"_="+s:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&q.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){u=u||e.url;i.lastModified[u]&&q.setRequestHeader("If-Modified-Since",i.lastModified[u]);i.etag[u]&&q.setRequestHeader("If-None-Match",i.etag[u])}q.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ua+"; q=0.01":""):e.accepts["*"]);for(x in e.headers)q.setRequestHeader(x,e.headers[x]);if(e.beforeSend&&(e.beforeSend.call(j,
q,e)===false||L===2)){q.abort();return false}for(x in{success:1,error:1,complete:1})q[x](e[x]);if(o=m(Ta,e,b,q)){q.readyState=1;U&&f.trigger("ajaxSend",[q,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){q.abort("timeout")},e.timeout));try{L=1;o.send(l,d)}catch(v){if(L<2)d(-1,v);else throw v;}}else d(-1,"No Transport");return q},param:function(a,b){var d=[],e=function(a,b){b=i.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=i.ajaxSettings.traditional;
if(i.isArray(a)||a.jquery&&!i.isPlainObject(a))i.each(a,function(){e(this.name,this.value)});else for(var j in a)C(j,a[j],b,e);return d.join("&").replace(ob,"+")}});i.extend({active:0,lastModified:{},etag:{}});var xb=i.now(),ta=/(\=)\?(&|$)|\?\?/i;i.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return i.expando+"_"+xb++}});i.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
false&&(ta.test(b.url)||c&&ta.test(b.data))){var e,j=b.jsonpCallback=i.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,f=a[j],g=b.url,h=b.data,k="$1"+j+"$2";if(b.jsonp!==false){g=g.replace(ta,k);if(b.url===g){c&&(h=h.replace(ta,k));b.data===h&&(g=g+((/\?/.test(g)?"&":"?")+b.jsonp+"="+j))}}b.url=g;b.data=h;a[j]=function(a){e=[a]};d.always(function(){a[j]=f;if(e&&i.isFunction(f))a[j](e[0])});b.converters["script json"]=function(){e||i.error(j+" was not called");return e[0]};b.dataTypes[0]=
"json";return"script"}});i.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){i.globalEval(a);return a}}});i.ajaxPrefilter("script",function(a){if(a.cache===c)a.cache=false;if(a.crossDomain){a.type="GET";a.global=false}});i.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=v.head||v.getElementsByTagName("head")[0]||v.documentElement;return{send:function(e,
j){b=v.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||j(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Ea=a.ActiveXObject?function(){for(var a in ja)ja[a](0,1)}:!1,yb=0,ja;i.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&E()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:E;(function(a){i.extend(i.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(i.ajaxSettings.xhr());i.support.ajax&&i.ajaxTransport(function(b){if(!b.crossDomain||i.support.cors){var d;return{send:function(e,j){var f=b.xhr(),g,h;b.username?f.open(b.type,b.url,b.async,b.username,b.password):f.open(b.type,b.url,b.async);if(b.xhrFields)for(h in b.xhrFields)f[h]=b.xhrFields[h];b.mimeType&&f.overrideMimeType&&
f.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(h in e)f.setRequestHeader(h,e[h])}catch(k){}f.send(b.hasContent&&b.data||null);d=function(a,e){var h,k,u,l,n;try{if(d&&(e||f.readyState===4)){d=c;if(g){f.onreadystatechange=i.noop;Ea&&delete ja[g]}if(e)f.readyState!==4&&f.abort();else{h=f.status;u=f.getAllResponseHeaders();l={};if((n=f.responseXML)&&n.documentElement)l.xml=n;try{l.text=f.responseText}catch(z){}try{k=f.statusText}catch(p){k=
""}!h&&b.isLocal&&!b.crossDomain?h=l.text?200:404:h===1223&&(h=204)}}}catch(o){e||j(-1,o)}l&&j(h,k,l,u)};if(!b.async||f.readyState===4)d();else{g=++yb;if(Ea){if(!ja){ja={};i(a).unload(Ea)}ja[g]=d}f.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var za={},aa,ha,zb=/^(?:toggle|show|hide)$/,Ab=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ua,ra=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],qa;i.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(D("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!i._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&i.css(a,"display")==="none"||!i.contains(a.ownerDocument.documentElement,a))&&i._data(a,"olddisplay",Q(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=i._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(D("hide",
3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=i.css(a,"display");b!=="none"&&!i._data(a,"olddisplay")&&i._data(a,"olddisplay",b)}}for(c=0;c<d;c++)if(this[c].style)this[c].style.display="none";return this},_toggle:i.fn.toggle,toggle:function(a,b,c){var d=typeof a==="boolean";i.isFunction(a)&&i.isFunction(b)?this._toggle.apply(this,arguments):a==null||d?this.each(function(){var b=d?a:i(this).is(":hidden");i(this)[b?"show":"hide"]()}):this.animate(D("toggle",3),a,b,c);return this},
fadeTo:function(a,b,c,d){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){function e(){j.queue===false&&i._mark(this);var b=i.extend({},j),c=this.nodeType===1,d=c&&i(this).is(":hidden"),f,g,h,k,u;b.animatedProperties={};for(h in a){f=i.camelCase(h);if(h!==f){a[f]=a[h];delete a[h]}if((g=i.cssHooks[f])&&"expand"in g){k=g.expand(a[f]);delete a[f];for(h in k)h in a||(a[h]=k[h])}}for(f in a){g=a[f];if(i.isArray(g)){b.animatedProperties[f]=
g[1];g=a[f]=g[0]}else b.animatedProperties[f]=b.specialEasing&&b.specialEasing[f]||b.easing||"swing";if(g==="hide"&&d||g==="show"&&!d)return b.complete.call(this);if(c&&(f==="height"||f==="width")){b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(i.css(this,"display")==="inline"&&i.css(this,"float")==="none")!i.support.inlineBlockNeedsLayout||Q(this.nodeName)==="inline"?this.style.display="inline-block":this.style.zoom=1}}if(b.overflow!=null)this.style.overflow="hidden";
for(h in a){c=new i.fx(this,b,h);g=a[h];if(zb.test(g))if(f=i._data(this,"toggle"+h)||(g==="toggle"?d?"show":"hide":0)){i._data(this,"toggle"+h,f==="show"?"hide":"show");c[f]()}else c[g]();else{f=Ab.exec(g);k=c.cur();if(f){g=parseFloat(f[2]);u=f[3]||(i.cssNumber[h]?"":"px");if(u!=="px"){i.style(this,h,(g||1)+u);k=(g||1)/c.cur()*k;i.style(this,h,k+u)}f[1]&&(g=(f[1]==="-="?-1:1)*g+k);c.custom(k,g,u)}else c.custom(k,g,"")}}return true}var j=i.speed(b,c,d);if(i.isEmptyObject(a))return this.each(j.complete,
[false]);a=i.extend({},a);return j.queue===false?this.each(e):this.queue(j.queue,e)},stop:function(a,b,d){if(typeof a!=="string"){d=b;b=a;a=c}b&&a!==false&&this.queue(a||"fx",[]);return this.each(function(){var b,c=false,e=i.timers,j=i._data(this);d||i._unmark(true,this);if(a==null)for(b in j){if(j[b]&&j[b].stop&&b.indexOf(".run")===b.length-4){var f=j[b];i.removeData(this,b,true);f.stop(d)}}else if(j[b=a+".run"]&&j[b].stop){j=j[b];i.removeData(this,b,true);j.stop(d)}for(b=e.length;b--;)if(e[b].elem===
this&&(a==null||e[b].queue===a)){if(d)e[b](true);else e[b].saveState();c=true;e.splice(b,1)}(!d||!c)&&i.dequeue(this,a)})}});i.each({slideDown:D("show",1),slideUp:D("hide",1),slideToggle:D("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){i.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});i.extend({speed:function(a,b,c){var d=a&&typeof a==="object"?i.extend({},a):{complete:c||!c&&b||i.isFunction(a)&&a,duration:a,easing:c&&b||b&&!i.isFunction(b)&&
b};d.duration=i.fx.off?0:typeof d.duration==="number"?d.duration:d.duration in i.fx.speeds?i.fx.speeds[d.duration]:i.fx.speeds._default;if(d.queue==null||d.queue===true)d.queue="fx";d.old=d.complete;d.complete=function(a){i.isFunction(d.old)&&d.old.call(this);d.queue?i.dequeue(this,d.queue):a!==false&&i._unmark(this)};return d},easing:{linear:function(a){return a},swing:function(a){return-Math.cos(a*Math.PI)/2+0.5}},timers:[],fx:function(a,b,c){this.options=b;this.elem=a;this.prop=c;b.orig=b.orig||
{}}});i.fx.prototype={update:function(){this.options.step&&this.options.step.call(this.elem,this.now,this);(i.fx.step[this.prop]||i.fx.step._default)(this)},cur:function(){if(this.elem[this.prop]!=null&&(!this.elem.style||this.elem.style[this.prop]==null))return this.elem[this.prop];var a,b=i.css(this.elem,this.prop);return isNaN(a=parseFloat(b))?!b||b==="auto"?0:b:a},custom:function(a,b,d){function e(a){return j.step(a)}var j=this,f=i.fx;this.startTime=qa||y();this.end=b;this.now=this.start=a;this.pos=
this.state=0;this.unit=d||this.unit||(i.cssNumber[this.prop]?"":"px");e.queue=this.options.queue;e.elem=this.elem;e.saveState=function(){i._data(j.elem,"fxshow"+j.prop)===c&&(j.options.hide?i._data(j.elem,"fxshow"+j.prop,j.start):j.options.show&&i._data(j.elem,"fxshow"+j.prop,j.end))};e()&&i.timers.push(e)&&!ua&&(ua=setInterval(f.tick,f.interval))},show:function(){var a=i._data(this.elem,"fxshow"+this.prop);this.options.orig[this.prop]=a||i.style(this.elem,this.prop);this.options.show=true;a!==c?
this.custom(this.cur(),a):this.custom(this.prop==="width"||this.prop==="height"?1:0,this.cur());i(this.elem).show()},hide:function(){this.options.orig[this.prop]=i._data(this.elem,"fxshow"+this.prop)||i.style(this.elem,this.prop);this.options.hide=true;this.custom(this.cur(),0)},step:function(a){var b,c=qa||y(),d=true,e=this.elem,j=this.options;if(a||c>=j.duration+this.startTime){this.now=this.end;this.pos=this.state=1;this.update();j.animatedProperties[this.prop]=true;for(b in j.animatedProperties)j.animatedProperties[b]!==
true&&(d=false);if(d){j.overflow!=null&&!i.support.shrinkWrapBlocks&&i.each(["","X","Y"],function(a,b){e.style["overflow"+b]=j.overflow[a]});j.hide&&i(e).hide();if(j.hide||j.show)for(b in j.animatedProperties){i.style(e,b,j.orig[b]);i.removeData(e,"fxshow"+b,true);i.removeData(e,"toggle"+b,true)}if(a=j.complete){j.complete=false;a.call(e)}}return false}if(j.duration==Infinity)this.now=c;else{a=c-this.startTime;this.state=a/j.duration;this.pos=i.easing[j.animatedProperties[this.prop]](this.state,a,
0,1,j.duration);this.now=this.start+(this.end-this.start)*this.pos}this.update();return true}};i.extend(i.fx,{tick:function(){for(var a,b=i.timers,c=0;c<b.length;c++){a=b[c];!a()&&b[c]===a&&b.splice(c--,1)}b.length||i.fx.stop()},interval:13,stop:function(){clearInterval(ua);ua=null},speeds:{slow:600,fast:200,_default:400},step:{opacity:function(a){i.style(a.elem,"opacity",a.now)},_default:function(a){a.elem.style&&a.elem.style[a.prop]!=null?a.elem.style[a.prop]=a.now+a.unit:a.elem[a.prop]=a.now}}});
i.each(ra.concat.apply([],ra),function(a,b){b.indexOf("margin")&&(i.fx.step[b]=function(a){i.style(a.elem,b,Math.max(0,a.now)+a.unit)})});i.expr&&i.expr.filters&&(i.expr.filters.animated=function(a){return i.grep(i.timers,function(b){return a===b.elem}).length});var Va,Bb=/^t(?:able|d|h)$/i,Wa=/^(?:body|html)$/i;Va="getBoundingClientRect"in v.documentElement?function(a,b,c,d){try{d=a.getBoundingClientRect()}catch(e){}if(!d||!i.contains(c,a))return d?{top:d.top,left:d.left}:{top:0,left:0};a=b.body;
b=J(b);return{top:d.top+(b.pageYOffset||i.support.boxModel&&c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0),left:d.left+(b.pageXOffset||i.support.boxModel&&c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||0)}}:function(a,b,c){var d,e=a.offsetParent,j=b.body;d=(b=b.defaultView)?b.getComputedStyle(a,null):a.currentStyle;for(var f=a.offsetTop,g=a.offsetLeft;(a=a.parentNode)&&a!==j&&a!==c;){if(i.support.fixedPosition&&d.position==="fixed")break;d=b?b.getComputedStyle(a,null):a.currentStyle;
f=f-a.scrollTop;g=g-a.scrollLeft;if(a===e){f=f+a.offsetTop;g=g+a.offsetLeft;if(i.support.doesNotAddBorder&&(!i.support.doesAddBorderForTableAndCells||!Bb.test(a.nodeName))){f=f+(parseFloat(d.borderTopWidth)||0);g=g+(parseFloat(d.borderLeftWidth)||0)}e=a.offsetParent}if(i.support.subtractsBorderForOverflowNotVisible&&d.overflow!=="visible"){f=f+(parseFloat(d.borderTopWidth)||0);g=g+(parseFloat(d.borderLeftWidth)||0)}}if(d.position==="relative"||d.position==="static"){f=f+j.offsetTop;g=g+j.offsetLeft}if(i.support.fixedPosition&&
d.position==="fixed"){f=f+Math.max(c.scrollTop,j.scrollTop);g=g+Math.max(c.scrollLeft,j.scrollLeft)}return{top:f,left:g}};i.fn.offset=function(a){if(arguments.length)return a===c?this:this.each(function(b){i.offset.setOffset(this,a,b)});var b=this[0],d=b&&b.ownerDocument;return!d?null:b===d.body?i.offset.bodyOffset(b):Va(b,d,d.documentElement)};i.offset={bodyOffset:function(a){var b=a.offsetTop,c=a.offsetLeft;if(i.support.doesNotIncludeMarginInBodyOffset){b=b+(parseFloat(i.css(a,"marginTop"))||0);
c=c+(parseFloat(i.css(a,"marginLeft"))||0)}return{top:b,left:c}},setOffset:function(a,b,c){var d=i.css(a,"position");if(d==="static")a.style.position="relative";var e=i(a),j=e.offset(),f=i.css(a,"top"),g=i.css(a,"left"),h={},k={};if((d==="absolute"||d==="fixed")&&i.inArray("auto",[f,g])>-1){k=e.position();d=k.top;g=k.left}else{d=parseFloat(f)||0;g=parseFloat(g)||0}i.isFunction(b)&&(b=b.call(a,c,j));if(b.top!=null)h.top=b.top-j.top+d;if(b.left!=null)h.left=b.left-j.left+g;"using"in b?b.using.call(a,
h):e.css(h)}};i.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Wa.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top=c.top-(parseFloat(i.css(a,"marginTop"))||0);c.left=c.left-(parseFloat(i.css(a,"marginLeft"))||0);d.top=d.top+(parseFloat(i.css(b[0],"borderTopWidth"))||0);d.left=d.left+(parseFloat(i.css(b[0],"borderLeftWidth"))||0);return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent||v.body;a&&!Wa.test(a.nodeName)&&i.css(a,"position")==="static";)a=a.offsetParent;return a})}});i.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var d=/Y/.test(b);i.fn[a]=function(e){return i.access(this,function(a,e,j){var f=J(a);if(j===c)return f?b in f?f[b]:i.support.boxModel&&f.document.documentElement[e]||f.document.body[e]:a[e];f?f.scrollTo(!d?j:i(f).scrollLeft(),d?j:i(f).scrollTop()):a[e]=j},a,e,arguments.length,null)}});i.each({Height:"height",Width:"width"},
function(a,b){var d="client"+a,e="scroll"+a,j="offset"+a;i.fn["inner"+a]=function(){var a=this[0];return a?a.style?parseFloat(i.css(a,b,"padding")):this[b]():null};i.fn["outer"+a]=function(a){var c=this[0];return c?c.style?parseFloat(i.css(c,b,a?"margin":"border")):this[b]():null};i.fn[b]=function(a){return i.access(this,function(a,b,f){if(i.isWindow(a)){b=a.document;a=b.documentElement[d];return i.support.boxModel&&a||b.body&&b.body[d]||a}if(a.nodeType===9){b=a.documentElement;return b[d]>=b[e]?
b[d]:Math.max(a.body[e],b[e],a.body[j],b[j])}if(f===c){a=i.css(a,b);b=parseFloat(a);return i.isNumeric(b)?b:a}i(a).css(b,f)},b,a,arguments.length,null)}});a.jQuery=a.$=i;"function"===typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return i})})(m);var w=m.jQuery.noConflict(!0);m.raptor=w;(function(a,c){function d(c,d){var g=c.nodeName.toLowerCase();if("area"===g){var g=c.parentNode,b=g.name;if(!c.href||!b||"map"!==g.nodeName.toLowerCase())return!1;g=a("img[usemap=#"+b+"]")[0];
return!!g&&f(g)}return(/input|select|textarea|button|object/.test(g)?!c.disabled:"a"==g?c.href||d:d)&&f(c)}function f(c){return!a(c).parents().andSelf().filter(function(){return"hidden"===a.curCSS(this,"visibility")||a.expr.filters.hidden(this)}).length}a.ui=a.ui||{};a.ui.version||(a.extend(a.ui,{version:"1.8.20",keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,COMMAND:91,COMMAND_LEFT:91,COMMAND_RIGHT:93,CONTROL:17,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,INSERT:45,LEFT:37,MENU:93,NUMPAD_ADD:107,
NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SHIFT:16,SPACE:32,TAB:9,UP:38,WINDOWS:91}}),a.fn.extend({propAttr:a.fn.prop||a.fn.attr,_focus:a.fn.focus,focus:function(c,d){return"number"===typeof c?this.each(function(){var f=this;setTimeout(function(){a(f).focus();d&&d.call(f)},c)}):this._focus.apply(this,arguments)},scrollParent:function(){var c;c=a.browser.msie&&/(static|relative)/.test(this.css("position"))||
...
c)return this.css("zIndex",d);if(this.length)for(var d=a(this[0]),f;d.length&&d[0]!==document;){f=d.css("position");if("absolute"===f||"relative"===f||"fixed"===f)if(f=parseInt(d.css("zIndex"),10),!isNaN(f)&&0!==f)return f;d=d.parent()}return 0},disableSelection:function(){return this.bind((a.support.selectstart?"selectstart":"mousedown")+".ui-disableSelection",function(a){a.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}}),a.each(["Width","Height"],function(d,
f){function g(c,d,e,f){a.each(b,function(){d-=parseFloat(a.curCSS(c,"padding"+this,!0))||0;e&&(d-=parseFloat(a.curCSS(c,"border"+this+"Width",!0))||0);f&&(d-=parseFloat(a.curCSS(c,"margin"+this,!0))||0)});return d}var b="Width"===f?["Left","Right"]:["Top","Bottom"],k=f.toLowerCase(),l={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+f]=function(b){return b===c?l["inner"+f].call(this):this.each(function(){a(this).css(k,g(this,
b)+"px")})};a.fn["outer"+f]=function(b,c){return"number"!==typeof b?l["outer"+f].call(this,b):this.each(function(){a(this).css(k,g(this,b,!0,c)+"px")})}}),a.extend(a.expr[":"],{data:function(c,d,f){return!!a.data(c,f[3])},focusable:function(c){return d(c,!isNaN(a.attr(c,"tabindex")))},tabbable:function(c){var f=a.attr(c,"tabindex"),g=isNaN(f);return(g||0<=f)&&d(c,!g)}}),a(function(){var c=document.body,d=c.appendChild(d=document.createElement("div"));d.offsetHeight;a.extend(d.style,{minHeight:"100px",
height:"auto",padding:0,borderWidth:0});a.support.minHeight=100===d.offsetHeight;a.support.selectstart="onselectstart"in d;c.removeChild(d).style.display="none"}),a.extend(a.ui,{plugin:{add:function(c,d,f){var c=a.ui[c].prototype,b;for(b in f)c.plugins[b]=c.plugins[b]||[],c.plugins[b].push([d,f[b]])},call:function(a,c,d){if((c=a.plugins[c])&&a.element[0].parentNode)for(var b=0;b<c.length;b++)a.options[c[b][0]]&&c[b][1].apply(a.element,d)}},contains:function(a,c){return document.compareDocumentPosition?
a.compareDocumentPosition(c)&16:a!==c&&a.contains(c)},hasScroll:function(c,d){if("hidden"===a(c).css("overflow"))return!1;var f=d&&"left"===d?"scrollLeft":"scrollTop",b=!1;if(0<c[f])return!0;c[f]=1;b=0<c[f];c[f]=0;return b},isOverAxis:function(a,c,d){return a>c&&a<c+d},isOver:function(c,d,f,b,k,l){return a.ui.isOverAxis(c,f,k)&&a.ui.isOverAxis(d,b,l)}}))})(w);(function(a,c){if(a.cleanData){var d=a.cleanData;a.cleanData=function(c){for(var f=0,g;null!=(g=c[f]);f++)try{a(g).triggerHandler("remove")}catch(b){}d(c)}}else{var f=
a.fn.remove;a.fn.remove=function(c,d){return this.each(function(){d||(!c||a.filter(c,[this]).length)&&a("*",this).add([this]).each(function(){try{a(this).triggerHandler("remove")}catch(c){}});return f.call(a(this),c,d)})}}a.widget=function(c,d,f){var b=c.split(".")[0],k,c=c.split(".")[1];k=b+"-"+c;f||(f=d,d=a.Widget);a.expr[":"][k]=function(b){return!!a.data(b,c)};a[b]=a[b]||{};a[b][c]=function(a,b){arguments.length&&this._createWidget(a,b)};d=new d;d.options=a.extend(!0,{},d.options);a[b][c].prototype=
a.extend(!0,d,{namespace:b,widgetName:c,widgetEventPrefix:a[b][c].prototype.widgetEventPrefix||c,widgetBaseClass:k},f);a.widget.bridge(c,a[b][c])};a.widget.bridge=function(d,f){a.fn[d]=function(g){var b="string"===typeof g,k=Array.prototype.slice.call(arguments,1),l=this,g=!b&&k.length?a.extend.apply(null,[!0,g].concat(k)):g;if(b&&"_"===g.charAt(0))return l;b?this.each(function(){var b=a.data(this,d),f=b&&a.isFunction(b[g])?b[g].apply(b,k):b;if(f!==b&&f!==c)return l=f,!1}):this.each(function(){var b=
a.data(this,d);b?b.option(g||{})._init():a.data(this,d,new f(g,this))});return l}};a.Widget=function(a,c){arguments.length&&this._createWidget(a,c)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:!1},_createWidget:function(c,d){a.data(d,this.widgetName,this);this.element=a(d);this.options=a.extend(!0,{},this.options,this._getCreateOptions(),c);var f=this;this.element.bind("remove."+this.widgetName,function(){f.destroy()});this._create();this._trigger("create");this._init()},
_getCreateOptions:function(){return a.metadata&&a.metadata.get(this.element[0])[this.widgetName]},_create:function(){},_init:function(){},destroy:function(){this.element.unbind("."+this.widgetName).removeData(this.widgetName);this.widget().unbind("."+this.widgetName).removeAttr("aria-disabled").removeClass(this.widgetBaseClass+"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(d,f){var g=d;if(0===arguments.length)return a.extend({},this.options);if("string"===typeof d){if(f===
c)return this.options[d];g={};g[d]=f}this._setOptions(g);return this},_setOptions:function(c){var d=this;a.each(c,function(a,b){d._setOption(a,b)});return this},_setOption:function(a,c){this.options[a]=c;"disabled"===a&&this.widget()[c?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",c);return this},enable:function(){return this._setOption("disabled",!1)},disable:function(){return this._setOption("disabled",!0)},_trigger:function(c,d,f){var b,k=this.options[c],
f=f||{},d=a.Event(d);d.type=(c===this.widgetEventPrefix?c:this.widgetEventPrefix+c).toLowerCase();d.target=this.element[0];if(c=d.originalEvent)for(b in c)b in d||(d[b]=c[b]);this.element.trigger(d,f);return!(a.isFunction(k)&&!1===k.call(this.element[0],d,f)||d.isDefaultPrevented())}}})(w);(function(a){var c=!1;a(document).mouseup(function(){c=!1});a.widget("ui.mouse",{options:{cancel:":input,option",distance:1,delay:0},_mouseInit:function(){var c=this;this.element.bind("mousedown."+this.widgetName,
function(a){return c._mouseDown(a)}).bind("click."+this.widgetName,function(f){if(!0===a.data(f.target,c.widgetName+".preventClickEvent"))return a.removeData(f.target,c.widgetName+".preventClickEvent"),f.stopImmediatePropagation(),!1});this.started=!1},_mouseDestroy:function(){this.element.unbind("."+this.widgetName);a(document).unbind("mousemove."+this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate)},_mouseDown:function(d){if(!c){this._mouseStarted&&this._mouseUp(d);
this._mouseDownEvent=d;var f=this,e=1==d.which,h="string"==typeof this.options.cancel&&d.target.nodeName?a(d.target).closest(this.options.cancel).length:!1;if(!e||h||!this._mouseCapture(d))return!0;this.mouseDelayMet=!this.options.delay;this.mouseDelayMet||(this._mouseDelayTimer=setTimeout(function(){f.mouseDelayMet=!0},this.options.delay));if(this._mouseDistanceMet(d)&&this._mouseDelayMet(d)&&(this._mouseStarted=!1!==this._mouseStart(d),!this._mouseStarted))return d.preventDefault(),!0;!0===a.data(d.target,
this.widgetName+".preventClickEvent")&&a.removeData(d.target,this.widgetName+".preventClickEvent");this._mouseMoveDelegate=function(a){return f._mouseMove(a)};this._mouseUpDelegate=function(a){return f._mouseUp(a)};a(document).bind("mousemove."+this.widgetName,this._mouseMoveDelegate).bind("mouseup."+this.widgetName,this._mouseUpDelegate);d.preventDefault();return c=!0}},_mouseMove:function(c){if(a.browser.msie&&!(9<=document.documentMode)&&!c.button)return this._mouseUp(c);if(this._mouseStarted)return this._mouseDrag(c),
...
this._mouseInit()},destroy:function(){if(this.element.data("draggable"))return this.element.removeData("draggable").unbind(".draggable").removeClass("ui-draggable ui-draggable-dragging ui-draggable-disabled"),this._mouseDestroy(),this},_mouseCapture:function(c){var d=this.options;if(this.helper||d.disabled||a(c.target).is(".ui-resizable-handle"))return!1;this.handle=this._getHandle(c);if(!this.handle)return!1;d.iframeFix&&a(!0===d.iframeFix?"iframe":d.iframeFix).each(function(){a('<div class="ui-draggable-iframeFix" style="background: #fff;"></div>').css({width:this.offsetWidth+
"px",height:this.offsetHeight+"px",position:"absolute",opacity:"0.001",zIndex:1E3}).css(a(this).offset()).appendTo("body")});return!0},_mouseStart:function(c){var d=this.options;this.helper=this._createHelper(c);this._cacheHelperProportions();a.ui.ddmanager&&(a.ui.ddmanager.current=this);this._cacheMargins();this.cssPosition=this.helper.css("position");this.scrollParent=this.helper.scrollParent();this.offset=this.positionAbs=this.element.offset();this.offset={top:this.offset.top-this.margins.top,
left:this.offset.left-this.margins.left};a.extend(this.offset,{click:{left:c.pageX-this.offset.left,top:c.pageY-this.offset.top},parent:this._getParentOffset(),relative:this._getRelativeOffset()});this.originalPosition=this.position=this._generatePosition(c);this.originalPageX=c.pageX;this.originalPageY=c.pageY;d.cursorAt&&this._adjustOffsetFromHelper(d.cursorAt);d.containment&&this._setContainment();if(!1===this._trigger("start",c))return this._clear(),!1;this._cacheHelperProportions();a.ui.ddmanager&&
!d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c);this.helper.addClass("ui-draggable-dragging");this._mouseDrag(c,!0);a.ui.ddmanager&&a.ui.ddmanager.dragStart(this,c);return!0},_mouseDrag:function(c,d){this.position=this._generatePosition(c);this.positionAbs=this._convertPositionTo("absolute");if(!d){var f=this._uiHash();if(!1===this._trigger("drag",c,f))return this._mouseUp({}),!1;this.position=f.position}if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+
"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);return!1},_mouseStop:function(c){var d=!1;a.ui.ddmanager&&!this.options.dropBehaviour&&(d=a.ui.ddmanager.drop(this,c));this.dropped&&(d=this.dropped,this.dropped=!1);for(var f=this.element[0],e=!1;f&&(f=f.parentNode);)f==document&&(e=!0);if(!e&&"original"===this.options.helper)return!1;if("invalid"==this.options.revert&&!d||"valid"==this.options.revert&&d||
!0===this.options.revert||a.isFunction(this.options.revert)&&this.options.revert.call(this.element,d)){var h=this;a(this.helper).animate(this.originalPosition,parseInt(this.options.revertDuration,10),function(){h._trigger("stop",c)!==false&&h._clear()})}else!1!==this._trigger("stop",c)&&this._clear();return!1},_mouseUp:function(c){!0===this.options.iframeFix&&a("div.ui-draggable-iframeFix").each(function(){this.parentNode.removeChild(this)});a.ui.ddmanager&&a.ui.ddmanager.dragStop(this,c);return a.ui.mouse.prototype._mouseUp.call(this,
c)},cancel:function(){this.helper.is(".ui-draggable-dragging")?this._mouseUp({}):this._clear();return this},_getHandle:function(c){var d=!this.options.handle||!a(this.options.handle,this.element).length?!0:!1;a(this.options.handle,this.element).find("*").andSelf().each(function(){this==c.target&&(d=!0)});return d},_createHelper:function(c){var d=this.options,c=a.isFunction(d.helper)?a(d.helper.apply(this.element[0],[c])):"clone"==d.helper?this.element.clone().removeAttr("id"):this.element;c.parents("body").length||
c.appendTo("parent"==d.appendTo?this.element[0].parentNode:d.appendTo);c[0]!=this.element[0]&&!/(fixed|absolute)/.test(c.css("position"))&&c.css("position","absolute");return c},_adjustOffsetFromHelper:function(c){"string"==typeof c&&(c=c.split(" "));a.isArray(c)&&(c={left:+c[0],top:+c[1]||0});"left"in c&&(this.offset.click.left=c.left+this.margins.left);"right"in c&&(this.offset.click.left=this.helperProportions.width-c.right+this.margins.left);"top"in c&&(this.offset.click.top=c.top+this.margins.top);
...
a.browser.msie)c={top:0,left:0};return{top:c.top+(parseInt(this.offsetParent.css("borderTopWidth"),10)||0),left:c.left+(parseInt(this.offsetParent.css("borderLeftWidth"),10)||0)}},_getRelativeOffset:function(){if("relative"==this.cssPosition){var a=this.element.position();return{top:a.top-(parseInt(this.helper.css("top"),10)||0)+this.scrollParent.scrollTop(),left:a.left-(parseInt(this.helper.css("left"),10)||0)+this.scrollParent.scrollLeft()}}return{top:0,left:0}},_cacheMargins:function(){this.margins=
...
["document"==c.containment?0:a(m).scrollLeft()-this.offset.relative.left-this.offset.parent.left,"document"==c.containment?0:a(m).scrollTop()-this.offset.relative.top-this.offset.parent.top,("document"==c.containment?0:a(m).scrollLeft())+a("document"==c.containment?document:m).width()-this.helperProportions.width-this.margins.left,("document"==c.containment?0:a(m).scrollTop())+(a("document"==c.containment?document:m).height()||document.body.parentNode.scrollHeight)-this.helperProportions.height-this.margins.top];
if(!/^(document|window|parent)$/.test(c.containment)&&c.containment.constructor!=Array){var c=a(c.containment),d=c[0];if(d){c.offset();var f="hidden"!=a(d).css("overflow");this.containment=[(parseInt(a(d).css("borderLeftWidth"),10)||0)+(parseInt(a(d).css("paddingLeft"),10)||0),(parseInt(a(d).css("borderTopWidth"),10)||0)+(parseInt(a(d).css("paddingTop"),10)||0),(f?Math.max(d.scrollWidth,d.offsetWidth):d.offsetWidth)-(parseInt(a(d).css("borderLeftWidth"),10)||0)-(parseInt(a(d).css("paddingRight"),
10)||0)-this.helperProportions.width-this.margins.left-this.margins.right,(f?Math.max(d.scrollHeight,d.offsetHeight):d.offsetHeight)-(parseInt(a(d).css("borderTopWidth"),10)||0)-(parseInt(a(d).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top-this.margins.bottom];this.relative_container=c}}else c.containment.constructor==Array&&(this.containment=c.containment)},_convertPositionTo:function(c,d){d||(d=this.position);var f="absolute"==c?1:-1,e="absolute"==this.cssPosition&&
!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,h=/(html|body)/i.test(e[0].tagName);return{top:d.top+this.offset.relative.top*f+this.offset.parent.top*f-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():h?0:e.scrollTop())*f),left:d.left+this.offset.relative.left*f+this.offset.parent.left*f-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?
0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():h?0:e.scrollLeft())*f)}},_generatePosition:function(c){var d=this.options,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,e=/(html|body)/i.test(f[0].tagName),h=c.pageX,g=c.pageY;if(this.originalPosition){var b;this.containment&&(this.relative_container?(b=this.relative_container.offset(),b=[this.containment[0]+b.left,this.containment[1]+
b.top,this.containment[2]+b.left,this.containment[3]+b.top]):b=this.containment,c.pageX-this.offset.click.left<b[0]&&(h=b[0]+this.offset.click.left),c.pageY-this.offset.click.top<b[1]&&(g=b[1]+this.offset.click.top),c.pageX-this.offset.click.left>b[2]&&(h=b[2]+this.offset.click.left),c.pageY-this.offset.click.top>b[3]&&(g=b[3]+this.offset.click.top));d.grid&&(g=d.grid[1]?this.originalPageY+Math.round((g-this.originalPageY)/d.grid[1])*d.grid[1]:this.originalPageY,g=b?!(g-this.offset.click.top<b[1]||
g-this.offset.click.top>b[3])?g:!(g-this.offset.click.top<b[1])?g-d.grid[1]:g+d.grid[1]:g,h=d.grid[0]?this.originalPageX+Math.round((h-this.originalPageX)/d.grid[0])*d.grid[0]:this.originalPageX,h=b?!(h-this.offset.click.left<b[0]||h-this.offset.click.left>b[2])?h:!(h-this.offset.click.left<b[0])?h-d.grid[0]:h+d.grid[0]:h)}return{top:g-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?
-this.scrollParent.scrollTop():e?0:f.scrollTop()),left:h-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():e?0:f.scrollLeft())}},_clear:function(){this.helper.removeClass("ui-draggable-dragging");this.helper[0]!=this.element[0]&&!this.cancelHelperRemoval&&this.helper.remove();this.helper=null;this.cancelHelperRemoval=!1},_trigger:function(c,d,f){f=
f||this._uiHash();a.ui.plugin.call(this,c,[d,f]);"drag"==c&&(this.positionAbs=this._convertPositionTo("absolute"));return a.Widget.prototype._trigger.call(this,c,d,f)},plugins:{},_uiHash:function(){return{helper:this.helper,position:this.position,originalPosition:this.originalPosition,offset:this.positionAbs}}});a.extend(a.ui.draggable,{version:"1.8.20"});a.ui.plugin.add("draggable","connectToSortable",{start:function(c,d){var f=a(this).data("draggable"),e=f.options,h=a.extend({},d,{item:f.element});
f.sortables=[];a(e.connectToSortable).each(function(){var d=a.data(this,"sortable");d&&!d.options.disabled&&(f.sortables.push({instance:d,shouldRevert:d.options.revert}),d.refreshPositions(),d._trigger("activate",c,h))})},stop:function(c,d){var f=a(this).data("draggable"),e=a.extend({},d,{item:f.element});a.each(f.sortables,function(){this.instance.isOver?(this.instance.isOver=0,f.cancelHelperRemoval=!0,this.instance.cancelHelperRemoval=!1,this.shouldRevert&&(this.instance.options.revert=!0),this.instance._mouseStop(c),
this.instance.options.helper=this.instance.options._helper,"original"==f.options.helper&&this.instance.currentItem.css({top:"auto",left:"auto"})):(this.instance.cancelHelperRemoval=!1,this.instance._trigger("deactivate",c,e))})},drag:function(c,d){var f=a(this).data("draggable"),e=this;a.each(f.sortables,function(){this.instance.positionAbs=f.positionAbs;this.instance.helperProportions=f.helperProportions;this.instance.offset.click=f.offset.click;this.instance._intersectsWith(this.instance.containerCache)?
...
"opacity",{start:function(c,d){var f=a(d.helper),e=a(this).data("draggable").options;f.css("opacity")&&(e._opacity=f.css("opacity"));f.css("opacity",e.opacity)},stop:function(c,d){var f=a(this).data("draggable").options;f._opacity&&a(d.helper).css("opacity",f._opacity)}});a.ui.plugin.add("draggable","scroll",{start:function(){var c=a(this).data("draggable");c.scrollParent[0]!=document&&"HTML"!=c.scrollParent[0].tagName&&(c.overflowOffset=c.scrollParent.offset())},drag:function(c){var d=a(this).data("draggable"),
f=d.options,e=!1;if(d.scrollParent[0]!=document&&"HTML"!=d.scrollParent[0].tagName){if(!f.axis||"x"!=f.axis)d.overflowOffset.top+d.scrollParent[0].offsetHeight-c.pageY<f.scrollSensitivity?d.scrollParent[0].scrollTop=e=d.scrollParent[0].scrollTop+f.scrollSpeed:c.pageY-d.overflowOffset.top<f.scrollSensitivity&&(d.scrollParent[0].scrollTop=e=d.scrollParent[0].scrollTop-f.scrollSpeed);if(!f.axis||"y"!=f.axis)d.overflowOffset.left+d.scrollParent[0].offsetWidth-c.pageX<f.scrollSensitivity?d.scrollParent[0].scrollLeft=
e=d.scrollParent[0].scrollLeft+f.scrollSpeed:c.pageX-d.overflowOffset.left<f.scrollSensitivity&&(d.scrollParent[0].scrollLeft=e=d.scrollParent[0].scrollLeft-f.scrollSpeed)}else{if(!f.axis||"x"!=f.axis)c.pageY-a(document).scrollTop()<f.scrollSensitivity?e=a(document).scrollTop(a(document).scrollTop()-f.scrollSpeed):a(m).height()-(c.pageY-a(document).scrollTop())<f.scrollSensitivity&&(e=a(document).scrollTop(a(document).scrollTop()+f.scrollSpeed));if(!f.axis||"y"!=f.axis)c.pageX-a(document).scrollLeft()<
f.scrollSensitivity?e=a(document).scrollLeft(a(document).scrollLeft()-f.scrollSpeed):a(m).width()-(c.pageX-a(document).scrollLeft())<f.scrollSensitivity&&(e=a(document).scrollLeft(a(document).scrollLeft()+f.scrollSpeed))}!1!==e&&a.ui.ddmanager&&!f.dropBehaviour&&a.ui.ddmanager.prepareOffsets(d,c)}});a.ui.plugin.add("draggable","snap",{start:function(){var c=a(this).data("draggable"),d=c.options;c.snapElements=[];a(d.snap.constructor!=String?d.snap.items||":data(draggable)":d.snap).each(function(){var d=
a(this),e=d.offset();this!=c.element[0]&&c.snapElements.push({item:this,width:d.outerWidth(),height:d.outerHeight(),top:e.top,left:e.left})})},drag:function(c,d){for(var f=a(this).data("draggable"),e=f.options,h=e.snapTolerance,g=d.offset.left,b=g+f.helperProportions.width,k=d.offset.top,l=k+f.helperProportions.height,o=f.snapElements.length-1;0<=o;o--){var n=f.snapElements[o].left,p=n+f.snapElements[o].width,r=f.snapElements[o].top,s=r+f.snapElements[o].height;if(n-h<g&&g<p+h&&r-h<k&&k<s+h||n-h<
g&&g<p+h&&r-h<l&&l<s+h||n-h<b&&b<p+h&&r-h<k&&k<s+h||n-h<b&&b<p+h&&r-h<l&&l<s+h){if("inner"!=e.snapMode){var x=Math.abs(r-l)<=h,q=Math.abs(s-k)<=h,m=Math.abs(n-b)<=h,A=Math.abs(p-g)<=h;x&&(d.position.top=f._convertPositionTo("relative",{top:r-f.helperProportions.height,left:0}).top-f.margins.top);q&&(d.position.top=f._convertPositionTo("relative",{top:s,left:0}).top-f.margins.top);m&&(d.position.left=f._convertPositionTo("relative",{top:0,left:n-f.helperProportions.width}).left-f.margins.left);A&&
(d.position.left=f._convertPositionTo("relative",{top:0,left:p}).left-f.margins.left)}var C=x||q||m||A;if("outer"!=e.snapMode&&(x=Math.abs(r-k)<=h,q=Math.abs(s-l)<=h,m=Math.abs(n-g)<=h,A=Math.abs(p-b)<=h,x&&(d.position.top=f._convertPositionTo("relative",{top:r,left:0}).top-f.margins.top),q&&(d.position.top=f._convertPositionTo("relative",{top:s-f.helperProportions.height,left:0}).top-f.margins.top),m&&(d.position.left=f._convertPositionTo("relative",{top:0,left:n}).left-f.margins.left),A))d.position.left=
f._convertPositionTo("relative",{top:0,left:p-f.helperProportions.width}).left-f.margins.left;!f.snapElements[o].snapping&&(x||q||m||A||C)&&f.options.snap.snap&&f.options.snap.snap.call(f.element,c,a.extend(f._uiHash(),{snapItem:f.snapElements[o].item}));f.snapElements[o].snapping=x||q||m||A||C}else f.snapElements[o].snapping&&f.options.snap.release&&f.options.snap.release.call(f.element,c,a.extend(f._uiHash(),{snapItem:f.snapElements[o].item})),f.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable",
...
a.ui.ddmanager.droppables[c.scope]=a.ui.ddmanager.droppables[c.scope]||[];a.ui.ddmanager.droppables[c.scope].push(this);c.addClasses&&this.element.addClass("ui-droppable")},destroy:function(){for(var c=a.ui.ddmanager.droppables[this.options.scope],d=0;d<c.length;d++)c[d]==this&&c.splice(d,1);this.element.removeClass("ui-droppable ui-droppable-disabled").removeData("droppable").unbind(".droppable");return this},_setOption:function(c,d){"accept"==c&&(this.accept=a.isFunction(d)?d:function(a){return a.is(d)});
a.Widget.prototype._setOption.apply(this,arguments)},_activate:function(c){var d=a.ui.ddmanager.current;this.options.activeClass&&this.element.addClass(this.options.activeClass);d&&this._trigger("activate",c,this.ui(d))},_deactivate:function(c){var d=a.ui.ddmanager.current;this.options.activeClass&&this.element.removeClass(this.options.activeClass);d&&this._trigger("deactivate",c,this.ui(d))},_over:function(c){var d=a.ui.ddmanager.current;if(d&&(d.currentItem||d.element)[0]!=this.element[0])if(this.accept.call(this.element[0],
d.currentItem||d.element))this.options.hoverClass&&this.element.addClass(this.options.hoverClass),this._trigger("over",c,this.ui(d))},_out:function(c){var d=a.ui.ddmanager.current;if(d&&(d.currentItem||d.element)[0]!=this.element[0])if(this.accept.call(this.element[0],d.currentItem||d.element))this.options.hoverClass&&this.element.removeClass(this.options.hoverClass),this._trigger("out",c,this.ui(d))},_drop:function(c,d){var f=d||a.ui.ddmanager.current;if(!f||(f.currentItem||f.element)[0]==this.element[0])return!1;
var e=!1;this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function(){var c=a.data(this,"droppable");if(c.options.greedy&&!c.options.disabled&&c.options.scope==f.options.scope&&c.accept.call(c.element[0],f.currentItem||f.element)&&a.ui.intersect(f,a.extend(c,{offset:c.element.offset()}),c.options.tolerance))return e=!0,!1});return e?!1:this.accept.call(this.element[0],f.currentItem||f.element)?(this.options.activeClass&&this.element.removeClass(this.options.activeClass),this.options.hoverClass&&
this.element.removeClass(this.options.hoverClass),this._trigger("drop",c,this.ui(f)),this.element):!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,f){if(!d.offset)return!1;var e=(c.positionAbs||c.position.absolute).left,h=e+c.helperProportions.width,g=(c.positionAbs||c.position.absolute).top,b=g+c.helperProportions.height,k=d.offset.left,l=k+d.proportions.width,
o=d.offset.top,n=o+d.proportions.height;switch(f){case "fit":return k<=e&&h<=l&&o<=g&&b<=n;case "intersect":return k<e+c.helperProportions.width/2&&h-c.helperProportions.width/2<l&&o<g+c.helperProportions.height/2&&b-c.helperProportions.height/2<n;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,o,k,d.proportions.height,d.proportions.width);case "touch":return(g>=
o&&g<=n||b>=o&&b<=n||g<o&&b>n)&&(e>=k&&e<=l||h>=k&&h<=l||e<k&&h>l);default:return!1}};a.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(c,d){var f=a.ui.ddmanager.droppables[c.options.scope]||[],e=d?d.type:null,h=(c.currentItem||c.element).find(":data(droppable)").andSelf(),g=0;a:for(;g<f.length;g++)if(!(f[g].options.disabled||c&&!f[g].accept.call(f[g].element[0],c.currentItem||c.element))){for(var b=0;b<h.length;b++)if(h[b]==f[g].element[0]){f[g].proportions.height=0;
continue a}f[g].visible="none"!=f[g].element.css("display");f[g].visible&&("mousedown"==e&&f[g]._activate.call(f[g],d),f[g].offset=f[g].element.offset(),f[g].proportions={width:f[g].element[0].offsetWidth,height:f[g].element[0].offsetHeight})}},drop:function(c,d){var f=!1;a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(this.options&&(!this.options.disabled&&this.visible&&a.ui.intersect(c,this,this.options.tolerance)&&(f=this._drop.call(this,d)||f),!this.options.disabled&&this.visible&&
this.accept.call(this.element[0],c.currentItem||c.element)))this.isout=1,this.isover=0,this._deactivate.call(this,d)});return f},dragStart:function(c,d){c.element.parents(":not(body,html)").bind("scroll.droppable",function(){c.options.refreshPositions||a.ui.ddmanager.prepareOffsets(c,d)})},drag:function(c,d){c.options.refreshPositions&&a.ui.ddmanager.prepareOffsets(c,d);a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var f=
a.ui.intersect(c,this,this.options.tolerance);if(f=!f&&1==this.isover?"isout":f&&0==this.isover?"isover":null){var e;if(this.options.greedy){var h=this.element.parents(":data(droppable):eq(0)");h.length&&(e=a.data(h[0],"droppable"),e.greedyChild="isover"==f?1:0)}e&&"isover"==f&&(e.isover=0,e.isout=1,e._out.call(e,d));this[f]=1;this["isout"==f?"isover":"isout"]=0;this["isover"==f?"_over":"_out"].call(this,d);e&&"isout"==f&&(e.isout=0,e.isover=1,e._over.call(e,d))}}})},dragStop:function(c,d){c.element.parents(":not(body,html)").unbind("scroll.droppable");
c.options.refreshPositions||a.ui.ddmanager.prepareOffsets(c,d)}}})(w);(function(a){a.widget("ui.resizable",a.ui.mouse,{widgetEventPrefix:"resize",options:{alsoResize:!1,animate:!1,animateDuration:"slow",animateEasing:"swing",aspectRatio:!1,autoHide:!1,containment:!1,ghost:!1,grid:!1,handles:"e,s,se",helper:!1,maxHeight:null,maxWidth:null,minHeight:10,minWidth:10,zIndex:1E3},_create:function(){var c=this,d=this.options;this.element.addClass("ui-resizable");a.extend(this,{_aspectRatio:!!d.aspectRatio,
...
this.element.parent().data("resizable",this.element.data("resizable")),this.elementIsWrapper=!0,this.element.css({marginLeft:this.originalElement.css("marginLeft"),marginTop:this.originalElement.css("marginTop"),marginRight:this.originalElement.css("marginRight"),marginBottom:this.originalElement.css("marginBottom")}),this.originalElement.css({marginLeft:0,marginTop:0,marginRight:0,marginBottom:0}),this.originalResizeStyle=this.originalElement.css("resize"),this.originalElement.css("resize","none"),
this._proportionallyResizeElements.push(this.originalElement.css({position:"static",zoom:1,display:"block"})),this.originalElement.css({margin:this.originalElement.css("margin")}),this._proportionallyResize());this.handles=d.handles||(!a(".ui-resizable-handle",this.element).length?"e,s,se":{n:".ui-resizable-n",e:".ui-resizable-e",s:".ui-resizable-s",w:".ui-resizable-w",se:".ui-resizable-se",sw:".ui-resizable-sw",ne:".ui-resizable-ne",nw:".ui-resizable-nw"});if(this.handles.constructor==String){"all"==
this.handles&&(this.handles="n,e,s,w,se,sw,ne,nw");var h=this.handles.split(",");this.handles={};for(var g=0;g<h.length;g++){var b=a.trim(h[g]),k=a('<div class="ui-resizable-handle ui-resizable-'+b+'"></div>');k.css({zIndex:d.zIndex});"se"==b&&k.addClass("ui-icon ui-icon-gripsmall-diagonal-se");this.handles[b]=".ui-resizable-"+b;this.element.append(k)}}this._renderAxis=function(b){var b=b||this.element,c;for(c in this.handles){this.handles[c].constructor==String&&(this.handles[c]=a(this.handles[c],
this.element).show());if(this.elementIsWrapper&&this.originalElement[0].nodeName.match(/textarea|input|select|button/i)){var d=a(this.handles[c],this.element),e=0,e=/sw|ne|nw|se|n|s/.test(c)?d.outerHeight():d.outerWidth(),d=["padding",/ne|nw|n/.test(c)?"Top":/se|sw|s/.test(c)?"Bottom":/^e$/.test(c)?"Right":"Left"].join("");b.css(d,e);this._proportionallyResize()}a(this.handles[c])}};this._renderAxis(this.element);this._handles=a(".ui-resizable-handle",this.element).disableSelection();this._handles.mouseover(function(){if(!c.resizing){if(this.className)var a=
this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i);c.axis=a&&a[1]?a[1]:"se"}});d.autoHide&&(this._handles.hide(),a(this.element).addClass("ui-resizable-autohide").hover(function(){if(!d.disabled){a(this).removeClass("ui-resizable-autohide");c._handles.show()}},function(){if(!d.disabled&&!c.resizing){a(this).addClass("ui-resizable-autohide");c._handles.hide()}}));this._mouseInit()},destroy:function(){this._mouseDestroy();var c=function(c){a(c).removeClass("ui-resizable ui-resizable-disabled ui-resizable-resizing").removeData("resizable").unbind(".resizable").find(".ui-resizable-handle").remove()};
if(this.elementIsWrapper){c(this.element);var d=this.element;d.after(this.originalElement.css({position:d.css("position"),width:d.outerWidth(),height:d.outerHeight(),top:d.css("top"),left:d.css("left")})).remove()}this.originalElement.css("resize",this.originalResizeStyle);c(this.originalElement);return this},_mouseCapture:function(c){var d=!1,h;for(h in this.handles)a(this.handles[h])[0]==c.target&&(d=!0);return!this.options.disabled&&d},_mouseStart:function(d){var e=this.options,h=this.element.position(),
g=this.element;this.resizing=!0;this.documentScroll={top:a(document).scrollTop(),left:a(document).scrollLeft()};(g.is(".ui-draggable")||/absolute/.test(g.css("position")))&&g.css({position:"absolute",top:h.top,left:h.left});this._renderProxy();var h=c(this.helper.css("left")),b=c(this.helper.css("top"));e.containment&&(h+=a(e.containment).scrollLeft()||0,b+=a(e.containment).scrollTop()||0);this.offset=this.helper.offset();this.position={left:h,top:b};this.size=this._helper?{width:g.outerWidth(),height:g.outerHeight()}:
{width:g.width(),height:g.height()};this.originalSize=this._helper?{width:g.outerWidth(),height:g.outerHeight()}:{width:g.width(),height:g.height()};this.originalPosition={left:h,top:b};this.sizeDiff={width:g.outerWidth()-g.width(),height:g.outerHeight()-g.height()};this.originalMousePosition={left:d.pageX,top:d.pageY};this.aspectRatio="number"==typeof e.aspectRatio?e.aspectRatio:this.originalSize.width/this.originalSize.height||1;e=a(".ui-resizable-"+this.axis).css("cursor");a("body").css("cursor",
"auto"==e?this.axis+"-resize":e);g.addClass("ui-resizable-resizing");this._propagate("start",d);return!0},_mouseDrag:function(a){var c=this.helper,d=this.originalMousePosition,g=this._change[this.axis];if(!g)return!1;d=g.apply(this,[a,a.pageX-d.left||0,a.pageY-d.top||0]);this._updateVirtualBoundaries(a.shiftKey);if(this._aspectRatio||a.shiftKey)d=this._updateRatio(d,a);d=this._respectSize(d,a);this._propagate("resize",a);c.css({top:this.position.top+"px",left:this.position.left+"px",width:this.size.width+
"px",height:this.size.height+"px"});!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize();this._updateCache(d);this._trigger("resize",a,this.ui());return!1},_mouseStop:function(c){this.resizing=!1;var d=this.options;if(this._helper){var h=this._proportionallyResizeElements,g=h.length&&/textarea/i.test(h[0].nodeName),h=g&&a.ui.hasScroll(h[0],"left")?0:this.sizeDiff.height,g=g?0:this.sizeDiff.width,g={width:this.helper.width()-g,height:this.helper.height()-h},h=parseInt(this.element.css("left"),
10)+(this.position.left-this.originalPosition.left)||null,b=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null;d.animate||this.element.css(a.extend(g,{top:b,left:h}));this.helper.height(this.size.height);this.helper.width(this.size.width);this._helper&&!d.animate&&this._proportionallyResize()}a("body").css("cursor","auto");this.element.removeClass("ui-resizable-resizing");this._propagate("stop",c);this._helper&&this.helper.remove();return!1},_updateVirtualBoundaries:function(a){var c=
this.options,h,g,b,c={minWidth:d(c.minWidth)?c.minWidth:0,maxWidth:d(c.maxWidth)?c.maxWidth:Infinity,minHeight:d(c.minHeight)?c.minHeight:0,maxHeight:d(c.maxHeight)?c.maxHeight:Infinity};if(this._aspectRatio||a)if(a=c.minHeight*this.aspectRatio,g=c.minWidth/this.aspectRatio,h=c.maxHeight*this.aspectRatio,b=c.maxWidth/this.aspectRatio,a>c.minWidth&&(c.minWidth=a),g>c.minHeight&&(c.minHeight=g),h<c.maxWidth&&(c.maxWidth=h),b<c.maxHeight)c.maxHeight=b;this._vBoundaries=c},_updateCache:function(a){this.offset=
this.helper.offset();d(a.left)&&(this.position.left=a.left);d(a.top)&&(this.position.top=a.top);d(a.height)&&(this.size.height=a.height);d(a.width)&&(this.size.width=a.width)},_updateRatio:function(a){var c=this.position,h=this.size,g=this.axis;d(a.height)?a.width=a.height*this.aspectRatio:d(a.width)&&(a.height=a.width/this.aspectRatio);"sw"==g&&(a.left=c.left+(h.width-a.width),a.top=null);"nw"==g&&(a.top=c.top+(h.height-a.height),a.left=c.left+(h.width-a.width));return a},_respectSize:function(a){var c=
this._vBoundaries,h=this.axis,g=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,k=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;k&&(a.width=c.minWidth);l&&(a.height=c.minHeight);g&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var o=this.originalPosition.left+this.originalSize.width,n=this.position.top+this.size.height,p=/sw|nw|w/.test(h),h=/nw|ne|n/.test(h);k&&p&&(a.left=o-c.minWidth);g&&p&&(a.left=o-c.maxWidth);
l&&h&&(a.top=n-c.minHeight);b&&h&&(a.top=n-c.maxHeight);(c=!a.width&&!a.height)&&!a.left&&a.top?a.top=null:c&&!a.top&&a.left&&(a.left=null);return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var c=this.helper||this.element,d=0;d<this._proportionallyResizeElements.length;d++){var h=this._proportionallyResizeElements[d];if(!this.borderDif){var g=[h.css("borderTopWidth"),h.css("borderRightWidth"),h.css("borderBottomWidth"),h.css("borderLeftWidth")],b=[h.css("paddingTop"),
h.css("paddingRight"),h.css("paddingBottom"),h.css("paddingLeft")];this.borderDif=a.map(g,function(a,c){var d=parseInt(a,10)||0,e=parseInt(b[c],10)||0;return d+e})}if(!a.browser.msie||!a(c).is(":hidden")&&!a(c).parents(":hidden").length)h.css({height:c.height()-this.borderDif[0]-this.borderDif[2]||0,width:c.width()-this.borderDif[1]-this.borderDif[3]||0})}},_renderProxy:function(){var c=this.options;this.elementOffset=this.element.offset();if(this._helper){this.helper=this.helper||a('<div style="overflow:hidden;"></div>');
var d=a.browser.msie&&7>a.browser.version,h=d?1:0,d=d?2:-1;this.helper.addClass(this._helper).css({width:this.element.outerWidth()+d,height:this.element.outerHeight()+d,position:"absolute",left:this.elementOffset.left-h+"px",top:this.elementOffset.top-h+"px",zIndex:++c.zIndex});this.helper.appendTo("body").disableSelection()}else this.helper=this.element},_change:{e:function(a,c){return{width:this.originalSize.width+c}},w:function(a,c){return{left:this.originalPosition.left+c,width:this.originalSize.width-
c}},n:function(a,c,d){return{top:this.originalPosition.top+d,height:this.originalSize.height-d}},s:function(a,c,d){return{height:this.originalSize.height+d}},se:function(c,d,h){return a.extend(this._change.s.apply(this,arguments),this._change.e.apply(this,[c,d,h]))},sw:function(c,d,h){return a.extend(this._change.s.apply(this,arguments),this._change.w.apply(this,[c,d,h]))},ne:function(c,d,h){return a.extend(this._change.n.apply(this,arguments),this._change.e.apply(this,[c,d,h]))},nw:function(c,d,
h){return a.extend(this._change.n.apply(this,arguments),this._change.w.apply(this,[c,d,h]))}},_propagate:function(c,d){a.ui.plugin.call(this,c,[d,this.ui()]);"resize"!=c&&this._trigger(c,d,this.ui())},plugins:{},ui:function(){return{originalElement:this.originalElement,element:this.element,helper:this.helper,position:this.position,size:this.size,originalSize:this.originalSize,originalPosition:this.originalPosition}}});a.extend(a.ui.resizable,{version:"1.8.20"});a.ui.plugin.add("resizable","alsoResize",
{start:function(){var c=a(this).data("resizable").options,d=function(c){a(c).each(function(){var c=a(this);c.data("resizable-alsoresize",{width:parseInt(c.width(),10),height:parseInt(c.height(),10),left:parseInt(c.css("left"),10),top:parseInt(c.css("top"),10)})})};"object"==typeof c.alsoResize&&!c.alsoResize.parentNode?c.alsoResize.length?(c.alsoResize=c.alsoResize[0],d(c.alsoResize)):a.each(c.alsoResize,function(a){d(a)}):d(c.alsoResize)},resize:function(c,d){var h=a(this).data("resizable"),g=h.options,
b=h.originalSize,k=h.originalPosition,l={height:h.size.height-b.height||0,width:h.size.width-b.width||0,top:h.position.top-k.top||0,left:h.position.left-k.left||0},o=function(b,c){a(b).each(function(){var b=a(this),f=a(this).data("resizable-alsoresize"),g={},k=c&&c.length?c:b.parents(d.originalElement[0]).length?["width","height"]:["width","height","top","left"];a.each(k,function(a,b){var c=(f[b]||0)+(l[b]||0);c&&0<=c&&(g[b]=c||null)});b.css(g)})};"object"==typeof g.alsoResize&&!g.alsoResize.nodeType?
a.each(g.alsoResize,function(a,b){o(a,b)}):o(g.alsoResize)},stop:function(){a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","animate",{stop:function(c){var d=a(this).data("resizable"),h=d.options,g=d._proportionallyResizeElements,b=g.length&&/textarea/i.test(g[0].nodeName),k=b&&a.ui.hasScroll(g[0],"left")?0:d.sizeDiff.height,b={width:d.size.width-(b?0:d.sizeDiff.width),height:d.size.height-k},k=parseInt(d.element.css("left"),10)+(d.position.left-d.originalPosition.left)||
null,l=parseInt(d.element.css("top"),10)+(d.position.top-d.originalPosition.top)||null;d.element.animate(a.extend(b,l&&k?{top:l,left:k}:{}),{duration:h.animateDuration,easing:h.animateEasing,step:function(){var b={width:parseInt(d.element.css("width"),10),height:parseInt(d.element.css("height"),10),top:parseInt(d.element.css("top"),10),left:parseInt(d.element.css("left"),10)};g&&g.length&&a(g[0]).css({width:b.width,height:b.height});d._updateCache(b);d._propagate("resize",c)}})}});a.ui.plugin.add("resizable",
"containment",{start:function(){var d=a(this).data("resizable"),e=d.element,h=d.options.containment;if(e=h instanceof a?h.get(0):/parent/.test(h)?e.parent().get(0):h)if(d.containerElement=a(e),/document/.test(h)||h==document)d.containerOffset={left:0,top:0},d.containerPosition={left:0,top:0},d.parentData={element:a(document),left:0,top:0,width:a(document).width(),height:a(document).height()||document.body.parentNode.scrollHeight};else{var g=a(e),b=[];a(["Top","Right","Left","Bottom"]).each(function(a,
d){b[a]=c(g.css("padding"+d))});d.containerOffset=g.offset();d.containerPosition=g.position();d.containerSize={height:g.innerHeight()-b[3],width:g.innerWidth()-b[1]};var h=d.containerOffset,k=d.containerSize.height,l=d.containerSize.width,l=a.ui.hasScroll(e,"left")?e.scrollWidth:l,k=a.ui.hasScroll(e)?e.scrollHeight:k;d.parentData={element:e,left:h.left,top:h.top,width:l,height:k}}},resize:function(c){var d=a(this).data("resizable"),h=d.options,g=d.containerOffset,b=d.position,c=d._aspectRatio||c.shiftKey,
k={top:0,left:0},l=d.containerElement;l[0]!=document&&/static/.test(l.css("position"))&&(k=g);if(b.left<(d._helper?g.left:0))d.size.width+=d._helper?d.position.left-g.left:d.position.left-k.left,c&&(d.size.height=d.size.width/d.aspectRatio),d.position.left=h.helper?g.left:0;if(b.top<(d._helper?g.top:0))d.size.height+=d._helper?d.position.top-g.top:d.position.top,c&&(d.size.width=d.size.height*d.aspectRatio),d.position.top=d._helper?g.top:0;d.offset.left=d.parentData.left+d.position.left;d.offset.top=
d.parentData.top+d.position.top;h=Math.abs(d.offset.left-k.left+d.sizeDiff.width);g=Math.abs((d._helper?d.offset.top-k.top:d.offset.top-g.top)+d.sizeDiff.height);b=d.containerElement.get(0)==d.element.parent().get(0);k=/relative|absolute/.test(d.containerElement.css("position"));b&&k&&(h-=d.parentData.left);h+d.size.width>=d.parentData.width&&(d.size.width=d.parentData.width-h,c&&(d.size.height=d.size.width/d.aspectRatio));g+d.size.height>=d.parentData.height&&(d.size.height=d.parentData.height-g,
c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,h=c.containerOffset,g=c.containerPosition,b=c.containerElement,k=a(c.helper),l=k.offset(),o=k.outerWidth()-c.sizeDiff.width,k=k.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-g.left-h.left,width:o,height:k});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-g.left-h.left,width:o,height:k})}});
a.ui.plugin.add("resizable","ghost",{start:function(){var c=a(this).data("resizable"),d=c.options,h=c.size;c.ghost=c.originalElement.clone();c.ghost.css({opacity:0.25,display:"block",position:"relative",height:h.height,width:h.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof d.ghost?d.ghost:"");c.ghost.appendTo(c.helper)},resize:function(){var c=a(this).data("resizable");c.ghost&&c.ghost.css({position:"relative",height:c.size.height,width:c.size.width})},stop:function(){var c=
a(this).data("resizable");c.ghost&&c.helper&&c.helper.get(0).removeChild(c.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var c=a(this).data("resizable"),d=c.options,h=c.size,g=c.originalSize,b=c.originalPosition,k=c.axis;d.grid="number"==typeof d.grid?[d.grid,d.grid]:d.grid;var l=Math.round((h.width-g.width)/(d.grid[0]||1))*(d.grid[0]||1),d=Math.round((h.height-g.height)/(d.grid[1]||1))*(d.grid[1]||1);/^(se|s|e)$/.test(k)?(c.size.width=g.width+l,c.size.height=g.height+d):
/^(ne)$/.test(k)?(c.size.width=g.width+l,c.size.height=g.height+d,c.position.top=b.top-d):(/^(sw)$/.test(k)?(c.size.width=g.width+l,c.size.height=g.height+d):(c.size.width=g.width+l,c.size.height=g.height+d,c.position.top=b.top-d),c.position.left=b.left-l)}});var c=function(a){return parseInt(a,10)||0},d=function(a){return!isNaN(parseInt(a,10))}})(w);(function(a){a.widget("ui.selectable",a.ui.mouse,{options:{appendTo:"body",autoRefresh:!0,distance:0,filter:"*",tolerance:"touch"},_create:function(){var c=
this;this.element.addClass("ui-selectable");this.dragged=!1;var d;this.refresh=function(){d=a(c.options.filter,c.element[0]);d.addClass("ui-selectee");d.each(function(){var c=a(this),d=c.offset();a.data(this,"selectable-item",{element:this,$element:c,left:d.left,top:d.top,right:d.left+c.outerWidth(),bottom:d.top+c.outerHeight(),startselected:!1,selected:c.hasClass("ui-selected"),selecting:c.hasClass("ui-selecting"),unselecting:c.hasClass("ui-unselecting")})})};this.refresh();this.selectees=d.addClass("ui-selectee");
this._mouseInit();this.helper=a("<div class='ui-selectable-helper'></div>")},destroy:function(){this.selectees.removeClass("ui-selectee").removeData("selectable-item");this.element.removeClass("ui-selectable ui-selectable-disabled").removeData("selectable").unbind(".selectable");this._mouseDestroy();return this},_mouseStart:function(c){var d=this;this.opos=[c.pageX,c.pageY];if(!this.options.disabled){var f=this.options;this.selectees=a(f.filter,this.element[0]);this._trigger("start",c);a(f.appendTo).append(this.helper);
this.helper.css({left:c.clientX,top:c.clientY,width:0,height:0});f.autoRefresh&&this.refresh();this.selectees.filter(".ui-selected").each(function(){var e=a.data(this,"selectable-item");e.startselected=!0;!c.metaKey&&!c.ctrlKey&&(e.$element.removeClass("ui-selected"),e.selected=!1,e.$element.addClass("ui-unselecting"),e.unselecting=!0,d._trigger("unselecting",c,{unselecting:e.element}))});a(c.target).parents().andSelf().each(function(){var e=a.data(this,"selectable-item");if(e){var f=!c.metaKey&&
!c.ctrlKey||!e.$element.hasClass("ui-selected");e.$element.removeClass(f?"ui-unselecting":"ui-selected").addClass(f?"ui-selecting":"ui-unselecting");e.unselecting=!f;e.selecting=f;(e.selected=f)?d._trigger("selecting",c,{selecting:e.element}):d._trigger("unselecting",c,{unselecting:e.element});return!1}})}},_mouseDrag:function(c){var d=this;this.dragged=!0;if(!this.options.disabled){var f=this.options,e=this.opos[0],h=this.opos[1],g=c.pageX,b=c.pageY;if(e>g)var k=g,g=e,e=k;h>b&&(k=b,b=h,h=k);this.helper.css({left:e,
top:h,width:g-e,height:b-h});this.selectees.each(function(){var k=a.data(this,"selectable-item");if(k&&k.element!=d.element[0]){var o=false;f.tolerance=="touch"?o=!(k.left>g||k.right<e||k.top>b||k.bottom<h):f.tolerance=="fit"&&(o=k.left>e&&k.right<g&&k.top>h&&k.bottom<b);if(o){if(k.selected){k.$element.removeClass("ui-selected");k.selected=false}if(k.unselecting){k.$element.removeClass("ui-unselecting");k.unselecting=false}if(!k.selecting){k.$element.addClass("ui-selecting");k.selecting=true;d._trigger("selecting",
c,{selecting:k.element})}}else{if(k.selecting)if((c.metaKey||c.ctrlKey)&&k.startselected){k.$element.removeClass("ui-selecting");k.selecting=false;k.$element.addClass("ui-selected");k.selected=true}else{k.$element.removeClass("ui-selecting");k.selecting=false;if(k.startselected){k.$element.addClass("ui-unselecting");k.unselecting=true}d._trigger("unselecting",c,{unselecting:k.element})}if(k.selected&&!c.metaKey&&!c.ctrlKey&&!k.startselected){k.$element.removeClass("ui-selected");k.selected=false;
k.$element.addClass("ui-unselecting");k.unselecting=true;d._trigger("unselecting",c,{unselecting:k.element})}}}});return!1}},_mouseStop:function(c){var d=this;this.dragged=!1;a(".ui-unselecting",this.element[0]).each(function(){var f=a.data(this,"selectable-item");f.$element.removeClass("ui-unselecting");f.unselecting=!1;f.startselected=!1;d._trigger("unselected",c,{unselected:f.element})});a(".ui-selecting",this.element[0]).each(function(){var f=a.data(this,"selectable-item");f.$element.removeClass("ui-selecting").addClass("ui-selected");
f.selecting=!1;f.selected=!0;f.startselected=!0;d._trigger("selected",c,{selected:f.element})});this._trigger("stop",c);this.helper.remove();return!1}});a.extend(a.ui.selectable,{version:"1.8.20"})})(w);(function(a){a.widget("ui.sortable",a.ui.mouse,{widgetEventPrefix:"sort",ready:!1,options:{appendTo:"parent",axis:!1,connectWith:!1,containment:!1,cursor:"auto",cursorAt:!1,dropOnEmpty:!0,forcePlaceholderSize:!1,forceHelperSize:!1,grid:!1,handle:!1,helper:"original",items:"> *",opacity:!1,placeholder:!1,
...
this.element.removeClass("ui-sortable ui-sortable-disabled");this._mouseDestroy();for(var c=this.items.length-1;0<=c;c--)this.items[c].item.removeData(this.widgetName+"-item");return this},_setOption:function(c,d){"disabled"===c?(this.options[c]=d,this.widget()[d?"addClass":"removeClass"]("ui-sortable-disabled")):a.Widget.prototype._setOption.apply(this,arguments)},_mouseCapture:function(c,d){var f=this;if(this.reverting||this.options.disabled||"static"==this.options.type)return!1;this._refreshItems(c);
var e=null,h=this;a(c.target).parents().each(function(){if(a.data(this,f.widgetName+"-item")==h)return e=a(this),!1});a.data(c.target,f.widgetName+"-item")==h&&(e=a(c.target));if(!e)return!1;if(this.options.handle&&!d){var g=!1;a(this.options.handle,e).find("*").andSelf().each(function(){this==c.target&&(g=!0)});if(!g)return!1}this.currentItem=e;this._removeCurrentsFromItems();return!0},_mouseStart:function(c,d,f){d=this.options;this.currentContainer=this;this.refreshPositions();this.helper=this._createHelper(c);
this._cacheHelperProportions();this._cacheMargins();this.scrollParent=this.helper.scrollParent();this.offset=this.currentItem.offset();this.offset={top:this.offset.top-this.margins.top,left:this.offset.left-this.margins.left};this.helper.css("position","absolute");this.cssPosition=this.helper.css("position");a.extend(this.offset,{click:{left:c.pageX-this.offset.left,top:c.pageY-this.offset.top},parent:this._getParentOffset(),relative:this._getRelativeOffset()});this.originalPosition=this._generatePosition(c);
this.originalPageX=c.pageX;this.originalPageY=c.pageY;d.cursorAt&&this._adjustOffsetFromHelper(d.cursorAt);this.domPosition={prev:this.currentItem.prev()[0],parent:this.currentItem.parent()[0]};this.helper[0]!=this.currentItem[0]&&this.currentItem.hide();this._createPlaceholder();d.containment&&this._setContainment();d.cursor&&(a("body").css("cursor")&&(this._storedCursor=a("body").css("cursor")),a("body").css("cursor",d.cursor));d.opacity&&(this.helper.css("opacity")&&(this._storedOpacity=this.helper.css("opacity")),
...
(a.ui.ddmanager.current=this);a.ui.ddmanager&&!d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c);this.dragging=!0;this.helper.addClass("ui-sortable-helper");this._mouseDrag(c);return!0},_mouseDrag:function(c){this.position=this._generatePosition(c);this.positionAbs=this._convertPositionTo("absolute");this.lastPositionAbs||(this.lastPositionAbs=this.positionAbs);if(this.options.scroll){var d=this.options,f=!1;this.scrollParent[0]!=document&&"HTML"!=this.scrollParent[0].tagName?(this.overflowOffset.top+
this.scrollParent[0].offsetHeight-c.pageY<d.scrollSensitivity?this.scrollParent[0].scrollTop=f=this.scrollParent[0].scrollTop+d.scrollSpeed:c.pageY-this.overflowOffset.top<d.scrollSensitivity&&(this.scrollParent[0].scrollTop=f=this.scrollParent[0].scrollTop-d.scrollSpeed),this.overflowOffset.left+this.scrollParent[0].offsetWidth-c.pageX<d.scrollSensitivity)?this.scrollParent[0].scrollLeft=f=this.scrollParent[0].scrollLeft+d.scrollSpeed:c.pageX-this.overflowOffset.left<d.scrollSensitivity&&(this.scrollParent[0].scrollLeft=
f=this.scrollParent[0].scrollLeft-d.scrollSpeed):(c.pageY-a(document).scrollTop()<d.scrollSensitivity?f=a(document).scrollTop(a(document).scrollTop()-d.scrollSpeed):a(m).height()-(c.pageY-a(document).scrollTop())<d.scrollSensitivity&&(f=a(document).scrollTop(a(document).scrollTop()+d.scrollSpeed)),c.pageX-a(document).scrollLeft()<d.scrollSensitivity?f=a(document).scrollLeft(a(document).scrollLeft()-d.scrollSpeed):a(m).width()-(c.pageX-a(document).scrollLeft())<d.scrollSensitivity&&(f=a(document).scrollLeft(a(document).scrollLeft()+
d.scrollSpeed)));!1!==f&&a.ui.ddmanager&&!d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c)}this.positionAbs=this._convertPositionTo("absolute");if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";for(d=this.items.length-1;0<=d;d--){var f=this.items[d],e=f.item[0],h=this._intersectsWithPointer(f);if(h&&e!=this.currentItem[0]&&this.placeholder[1==h?"next":"prev"]()[0]!=
e&&!a.ui.contains(this.placeholder[0],e)&&("semi-dynamic"==this.options.type?!a.ui.contains(this.element[0],e):1)){this.direction=1==h?"down":"up";if("pointer"==this.options.tolerance||this._intersectsWithSides(f))this._rearrange(c,f);else break;this._trigger("change",c,this._uiHash());break}}this._contactContainers(c);a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);this._trigger("sort",c,this._uiHash());this.lastPositionAbs=this.positionAbs;return!1},_mouseStop:function(c,d){if(c){a.ui.ddmanager&&!this.options.dropBehaviour&&
a.ui.ddmanager.drop(this,c);if(this.options.revert){var f=this,e=f.placeholder.offset();f.reverting=!0;a(this.helper).animate({left:e.left-this.offset.parent.left-f.margins.left+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollLeft),top:e.top-this.offset.parent.top-f.margins.top+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollTop)},parseInt(this.options.revert,10)||500,function(){f._clear(c)})}else this._clear(c,d);return!1}},cancel:function(){if(this.dragging){this._mouseUp({target:null});
...
this.options.helper&&this.helper&&this.helper[0].parentNode&&this.helper.remove(),a.extend(this,{helper:null,dragging:!1,reverting:!1,_noFinalSort:null}),this.domPosition.prev?a(this.domPosition.prev).after(this.currentItem):a(this.domPosition.parent).prepend(this.currentItem));return this},serialize:function(c){var d=this._getItemsAsjQuery(c&&c.connected),f=[],c=c||{};a(d).each(function(){var d=(a(c.item||this).attr(c.attribute||"id")||"").match(c.expression||/(.+)[-=_](.+)/);d&&f.push((c.key||d[1]+
"[]")+"="+(c.key&&c.expression?d[1]:d[2]))});!f.length&&c.key&&f.push(c.key+"=");return f.join("&")},toArray:function(c){var d=this._getItemsAsjQuery(c&&c.connected),f=[],c=c||{};d.each(function(){f.push(a(c.item||this).attr(c.attribute||"id")||"")});return f},_intersectsWith:function(a){var d=this.positionAbs.left,f=d+this.helperProportions.width,e=this.positionAbs.top,h=e+this.helperProportions.height,g=a.left,b=g+a.width,k=a.top,l=k+a.height,o=this.offset.click.top,n=this.offset.click.left;return"pointer"==
this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?e+o>k&&e+o<l&&d+n>g&&d+n<b:g<d+this.helperProportions.width/2&&f-this.helperProportions.width/2<b&&k<e+this.helperProportions.height/2&&h-this.helperProportions.height/2<l},_intersectsWithPointer:function(c){var d="x"===this.options.axis||a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top,c.height),
c="y"===this.options.axis||a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left,c.width),d=d&&c,c=this._getDragVerticalDirection(),f=this._getDragHorizontalDirection();return!d?!1:this.floating?f&&"right"==f||"down"==c?2:1:c&&("down"==c?2:1)},_intersectsWithSides:function(c){var d=a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top+c.height/2,c.height),c=a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left+c.width/2,c.width),f=this._getDragVerticalDirection(),
e=this._getDragHorizontalDirection();return this.floating&&e?"right"==e&&c||"left"==e&&!c:f&&("down"==f&&d||"up"==f&&!d)},_getDragVerticalDirection:function(){var a=this.positionAbs.top-this.lastPositionAbs.top;return 0!=a&&(0<a?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-this.lastPositionAbs.left;return 0!=a&&(0<a?"right":"left")},refresh:function(a){this._refreshItems(a);this.refreshPositions();return this},_connectWith:function(){var a=this.options;return a.connectWith.constructor==
String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(c){var d=[],f=[],e=this._connectWith();if(e&&c)for(c=e.length-1;0<=c;c--)for(var h=a(e[c]),g=h.length-1;0<=g;g--){var b=a.data(h[g],this.widgetName);b&&b!=this&&!b.options.disabled&&f.push([a.isFunction(b.options.items)?b.options.items.call(b.element):a(b.options.items,b.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),b])}f.push([a.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,
item:this.currentItem}):a(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]);for(c=f.length-1;0<=c;c--)f[c][0].each(function(){d.push(this)});return a(d)},_removeCurrentsFromItems:function(){for(var a=this.currentItem.find(":data("+this.widgetName+"-item)"),d=0;d<this.items.length;d++)for(var f=0;f<a.length;f++)a[f]==this.items[d].item[0]&&this.items.splice(d,1)},_refreshItems:function(c){this.items=[];this.containers=[this];var d=this.items,f=[[a.isFunction(this.options.items)?
this.options.items.call(this.element[0],c,{item:this.currentItem}):a(this.options.items,this.element),this]],e=this._connectWith();if(e&&this.ready)for(var h=e.length-1;0<=h;h--)for(var g=a(e[h]),b=g.length-1;0<=b;b--){var k=a.data(g[b],this.widgetName);k&&k!=this&&!k.options.disabled&&(f.push([a.isFunction(k.options.items)?k.options.items.call(k.element[0],c,{item:this.currentItem}):a(k.options.items,k.element),k]),this.containers.push(k))}for(h=f.length-1;0<=h;h--){c=f[h][1];e=f[h][0];b=0;for(g=
e.length;b<g;b++)k=a(e[b]),k.data(this.widgetName+"-item",c),d.push({item:k,instance:c,width:0,height:0,left:0,top:0})}},refreshPositions:function(c){this.offsetParent&&this.helper&&(this.offset.parent=this._getParentOffset());for(var d=this.items.length-1;0<=d;d--){var f=this.items[d];if(!(f.instance!=this.currentContainer&&this.currentContainer&&f.item[0]!=this.currentItem[0])){var e=this.options.toleranceElement?a(this.options.toleranceElement,f.item):f.item;c||(f.width=e.outerWidth(),f.height=
...
return this},_createPlaceholder:function(c){var d=c||this,f=d.options;if(!f.placeholder||f.placeholder.constructor==String){var e=f.placeholder;f.placeholder={element:function(){var c=a(document.createElement(d.currentItem[0].nodeName)).addClass(e||d.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];e||(c.style.visibility="hidden");return c},update:function(a,c){if(!e||f.forcePlaceholderSize)c.height()||c.height(d.currentItem.innerHeight()-parseInt(d.currentItem.css("paddingTop")||
0,10)-parseInt(d.currentItem.css("paddingBottom")||0,10)),c.width()||c.width(d.currentItem.innerWidth()-parseInt(d.currentItem.css("paddingLeft")||0,10)-parseInt(d.currentItem.css("paddingRight")||0,10))}}}d.placeholder=a(f.placeholder.element.call(d.element,d.currentItem));d.currentItem.after(d.placeholder);f.placeholder.update(d,d.placeholder)},_contactContainers:function(c){for(var d=null,f=null,e=this.containers.length-1;0<=e;e--)if(!a.ui.contains(this.currentItem[0],this.containers[e].element[0]))if(this._intersectsWith(this.containers[e].containerCache)){if(!d||
!a.ui.contains(this.containers[e].element[0],d.element[0]))d=this.containers[e],f=e}else this.containers[e].containerCache.over&&(this.containers[e]._trigger("out",c,this._uiHash(this)),this.containers[e].containerCache.over=0);if(d)if(1===this.containers.length)this.containers[f]._trigger("over",c,this._uiHash(this)),this.containers[f].containerCache.over=1;else if(this.currentContainer!=this.containers[f]){for(var d=1E4,e=null,h=this.positionAbs[this.containers[f].floating?"left":"top"],g=this.items.length-
1;0<=g;g--)if(a.ui.contains(this.containers[f].element[0],this.items[g].item[0])){var b=this.items[g][this.containers[f].floating?"left":"top"];Math.abs(b-h)<d&&(d=Math.abs(b-h),e=this.items[g])}if(e||this.options.dropOnEmpty)this.currentContainer=this.containers[f],e?this._rearrange(c,e,null,!0):this._rearrange(c,null,this.containers[f].element,!0),this._trigger("change",c,this._uiHash()),this.containers[f]._trigger("change",c,this._uiHash(this)),this.options.placeholder.update(this.currentContainer,
this.placeholder),this.containers[f]._trigger("over",c,this._uiHash(this)),this.containers[f].containerCache.over=1}},_createHelper:function(c){var d=this.options,c=a.isFunction(d.helper)?a(d.helper.apply(this.element[0],[c,this.currentItem])):"clone"==d.helper?this.currentItem.clone():this.currentItem;c.parents("body").length||a("parent"!=d.appendTo?d.appendTo:this.currentItem[0].parentNode)[0].appendChild(c[0]);c[0]==this.currentItem[0]&&(this._storedCSS={width:this.currentItem[0].style.width,height:this.currentItem[0].style.height,
...
[0-this.offset.relative.left-this.offset.parent.left,0-this.offset.relative.top-this.offset.parent.top,a("document"==c.containment?document:m).width()-this.helperProportions.width-this.margins.left,(a("document"==c.containment?document:m).height()||document.body.parentNode.scrollHeight)-this.helperProportions.height-this.margins.top];if(!/^(document|window|parent)$/.test(c.containment)){var d=a(c.containment)[0],c=a(c.containment).offset(),f="hidden"!=a(d).css("overflow");this.containment=[c.left+
(parseInt(a(d).css("borderLeftWidth"),10)||0)+(parseInt(a(d).css("paddingLeft"),10)||0)-this.margins.left,c.top+(parseInt(a(d).css("borderTopWidth"),10)||0)+(parseInt(a(d).css("paddingTop"),10)||0)-this.margins.top,c.left+(f?Math.max(d.scrollWidth,d.offsetWidth):d.offsetWidth)-(parseInt(a(d).css("borderLeftWidth"),10)||0)-(parseInt(a(d).css("paddingRight"),10)||0)-this.helperProportions.width-this.margins.left,c.top+(f?Math.max(d.scrollHeight,d.offsetHeight):d.offsetHeight)-(parseInt(a(d).css("borderTopWidth"),
10)||0)-(parseInt(a(d).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top]}},_convertPositionTo:function(c,d){d||(d=this.position);var f="absolute"==c?1:-1,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,h=/(html|body)/i.test(e[0].tagName);return{top:d.top+this.offset.relative.top*f+this.offset.parent.top*f-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==
this.cssPosition?-this.scrollParent.scrollTop():h?0:e.scrollTop())*f),left:d.left+this.offset.relative.left*f+this.offset.parent.left*f-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():h?0:e.scrollLeft())*f)}},_generatePosition:function(c){var d=this.options,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,e=/(html|body)/i.test(f[0].tagName);
"relative"==this.cssPosition&&!(this.scrollParent[0]!=document&&this.scrollParent[0]!=this.offsetParent[0])&&(this.offset.relative=this._getRelativeOffset());var h=c.pageX,g=c.pageY;if(this.originalPosition&&(this.containment&&(c.pageX-this.offset.click.left<this.containment[0]&&(h=this.containment[0]+this.offset.click.left),c.pageY-this.offset.click.top<this.containment[1]&&(g=this.containment[1]+this.offset.click.top),c.pageX-this.offset.click.left>this.containment[2]&&(h=this.containment[2]+this.offset.click.left),
c.pageY-this.offset.click.top>this.containment[3]&&(g=this.containment[3]+this.offset.click.top)),d.grid))g=this.originalPageY+Math.round((g-this.originalPageY)/d.grid[1])*d.grid[1],g=this.containment?!(g-this.offset.click.top<this.containment[1]||g-this.offset.click.top>this.containment[3])?g:!(g-this.offset.click.top<this.containment[1])?g-d.grid[1]:g+d.grid[1]:g,h=this.originalPageX+Math.round((h-this.originalPageX)/d.grid[0])*d.grid[0],h=this.containment?!(h-this.offset.click.left<this.containment[0]||
...
e?0:f.scrollLeft())}},_rearrange:function(a,d,f,e){f?f[0].appendChild(this.placeholder[0]):d.item[0].parentNode.insertBefore(this.placeholder[0],"down"==this.direction?d.item[0]:d.item[0].nextSibling);this.counter=this.counter?++this.counter:1;var h=this,g=this.counter;m.setTimeout(function(){g==h.counter&&h.refreshPositions(!e)},0)},_clear:function(c,d){this.reverting=!1;var f=[];!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem);this._noFinalSort=null;
if(this.helper[0]==this.currentItem[0]){for(var e in this._storedCSS)if("auto"==this._storedCSS[e]||"static"==this._storedCSS[e])this._storedCSS[e]="";this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper")}else this.currentItem.show();this.fromOutside&&!d&&f.push(function(a){this._trigger("receive",a,this._uiHash(this.fromOutside))});(this.fromOutside||this.domPosition.prev!=this.currentItem.prev().not(".ui-sortable-helper")[0]||this.domPosition.parent!=this.currentItem.parent()[0])&&
!d&&f.push(function(a){this._trigger("update",a,this._uiHash())});if(!a.ui.contains(this.element[0],this.currentItem[0])){d||f.push(function(a){this._trigger("remove",a,this._uiHash())});for(e=this.containers.length-1;0<=e;e--)a.ui.contains(this.containers[e].element[0],this.currentItem[0])&&!d&&(f.push(function(a){return function(c){a._trigger("receive",c,this._uiHash(this))}}.call(this,this.containers[e])),f.push(function(a){return function(c){a._trigger("update",c,this._uiHash(this))}}.call(this,
this.containers[e])))}for(e=this.containers.length-1;0<=e;e--)d||f.push(function(a){return function(c){a._trigger("deactivate",c,this._uiHash(this))}}.call(this,this.containers[e])),this.containers[e].containerCache.over&&(f.push(function(a){return function(c){a._trigger("out",c,this._uiHash(this))}}.call(this,this.containers[e])),this.containers[e].containerCache.over=0);this._storedCursor&&a("body").css("cursor",this._storedCursor);this._storedOpacity&&this.helper.css("opacity",this._storedOpacity);
this._storedZIndex&&this.helper.css("zIndex","auto"==this._storedZIndex?"":this._storedZIndex);this.dragging=!1;if(this.cancelHelperRemoval){if(!d){this._trigger("beforeStop",c,this._uiHash());for(e=0;e<f.length;e++)f[e].call(this,c);this._trigger("stop",c,this._uiHash())}return!1}d||this._trigger("beforeStop",c,this._uiHash());this.placeholder[0].parentNode.removeChild(this.placeholder[0]);this.helper[0]!=this.currentItem[0]&&this.helper.remove();this.helper=null;if(!d){for(e=0;e<f.length;e++)f[e].call(this,
c);this._trigger("stop",c,this._uiHash())}this.fromOutside=!1;return!0},_trigger:function(){!1===a.Widget.prototype._trigger.apply(this,arguments)&&this.cancel()},_uiHash:function(c){var d=c||this;return{helper:d.helper,placeholder:d.placeholder||a([]),position:d.position,originalPosition:d.originalPosition,offset:d.positionAbs,item:d.currentItem,sender:c?c.element:null}}});a.extend(a.ui.sortable,{version:"1.8.20"})})(w);w.effects||function(a,c){function d(b){var c;return b&&b.constructor==Array&&
3==b.length?b:(c=/rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(b))?[parseInt(c[1],10),parseInt(c[2],10),parseInt(c[3],10)]:(c=/rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(b))?[2.55*parseFloat(c[1]),2.55*parseFloat(c[2]),2.55*parseFloat(c[3])]:(c=/#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(b))?[parseInt(c[1],16),parseInt(c[2],16),parseInt(c[3],16)]:(c=/#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(b))?
[parseInt(c[1]+c[1],16),parseInt(c[2]+c[2],16),parseInt(c[3]+c[3],16)]:/rgba\(0, 0, 0, 0\)/.exec(b)?k.transparent:k[a.trim(b).toLowerCase()]}function f(){var a=document.defaultView?document.defaultView.getComputedStyle(this,null):this.currentStyle,b={},c,d;if(a&&a.length&&a[0]&&a[a[0]])for(var e=a.length;e--;)c=a[e],"string"==typeof a[c]&&(d=c.replace(/\-(\w)/g,function(a,b){return b.toUpperCase()}),b[d]=a[c]);else for(c in a)"string"===typeof a[c]&&(b[c]=a[c]);return b}function e(b){var c,d;for(c in b)d=
b[c],(null==d||a.isFunction(d)||c in o||/scrollbar/.test(c)||!/color/i.test(c)&&isNaN(parseFloat(d)))&&delete b[c];return b}function h(a,b){var c={_:0},d;for(d in b)a[d]!=b[d]&&(c[d]=b[d]);return c}function g(b,c,d,e){"object"==typeof b&&(e=c,d=null,c=b,b=c.effect);a.isFunction(c)&&(e=c,d=null,c={});if("number"==typeof c||a.fx.speeds[c])e=d,d=c,c={};a.isFunction(d)&&(e=d,d=null);c=c||{};d=d||c.duration;d=a.fx.off?0:"number"==typeof d?d:d in a.fx.speeds?a.fx.speeds[d]:a.fx.speeds._default;e=e||c.complete;
return[b,c,d,e]}function b(b){return!b||"number"===typeof b||a.fx.speeds[b]||"string"===typeof b&&!a.effects[b]?!0:!1}a.effects={};a.each("backgroundColor,borderBottomColor,borderLeftColor,borderRightColor,borderTopColor,borderColor,color,outlineColor".split(","),function(b,c){a.fx.step[c]=function(b){if(!b.colorInit){var e;e=b.elem;var f=c,g;do{g=a.curCSS(e,f);if(g!=""&&g!="transparent"||a.nodeName(e,"body"))break;f="backgroundColor"}while(e=e.parentNode);e=d(g);b.start=e;b.end=d(b.end);b.colorInit=
true}b.elem.style[c]="rgb("+Math.max(Math.min(parseInt(b.pos*(b.end[0]-b.start[0])+b.start[0],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[1]-b.start[1])+b.start[1],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[2]-b.start[2])+b.start[2],10),255),0)+")"}});var k={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,
183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,
165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],o={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,g){a.isFunction(d)&&(g=d,d=null);return this.queue(function(){var k=a(this),o=k.attr("style")||" ",m=e(f.call(this)),A,C=k.attr("class")||"";a.each(l,function(a,
c){if(b[c])k[c+"Class"](b[c])});A=e(f.call(this));k.attr("class",C);k.animate(h(m,A),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])k[c+"Class"](b[c])});if(typeof k.attr("style")=="object"){k.attr("style").cssText="";k.attr("style").cssText=o}else k.attr("style",o);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,[{add:b},c,d,e]):this._addClass(b)},_removeClass:a.fn.removeClass,
...
b){for(var c=0;c<b.length;c++)null!==b[c]&&a.data("ec.storage."+b[c],a[0].style[b[c]])},restore:function(a,b){for(var c=0;c<b.length;c++)null!==b[c]&&a.css(b[c],a.data("ec.storage."+b[c]))},setMode:function(a,b){"toggle"==b&&(b=a.is(":hidden")?"show":"hide");return b},getBaseline:function(a,b){var c,d;switch(a[0]){case "top":c=0;break;case "middle":c=0.5;break;case "bottom":c=1;break;default:c=a[0]/b.height}switch(a[1]){case "left":d=0;break;case "center":d=0.5;break;case "right":d=1;break;default:d=
a[1]/b.width}return{x:d,y:c}},createWrapper:function(b){if(b.parent().is(".ui-effects-wrapper"))return b.parent();var c={width:b.outerWidth(!0),height:b.outerHeight(!0),"float":b.css("float")},d=a("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),e=document.activeElement;b.wrap(d);(b[0]===e||a.contains(b[0],e))&&a(e).focus();d=b.parent();"static"==b.css("position")?(d.css({position:"relative"}),b.css({position:"relative"})):
(a.extend(c,{position:b.css("position"),zIndex:b.css("z-index")}),a.each(["top","left","bottom","right"],function(a,d){c[d]=b.css(d);isNaN(parseInt(c[d],10))&&(c[d]="auto")}),b.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"}));return d.css(c).show()},removeWrapper:function(b){var c,d=document.activeElement;return b.parent().is(".ui-effects-wrapper")?(c=b.parent().replaceWith(b),(b[0]===d||a.contains(b[0],d))&&a(d).focus(),c):b},setTransition:function(b,c,d,e){e=e||{};a.each(c,function(a,
c){var f=b.cssUnit(c);0<f[0]&&(e[c]=f[0]*d+f[1])});return e}});a.fn.extend({effect:function(b,c,d,e){var f=g.apply(this,arguments),k={options:f[1],duration:f[2],callback:f[3]},f=k.options.mode,h=a.effects[b];return a.fx.off||!h?f?this[f](k.duration,k.callback):this.each(function(){k.callback&&k.callback.call(this)}):h.call(this,k)},_show:a.fn.show,show:function(a){if(b(a))return this._show.apply(this,arguments);var c=g.apply(this,arguments);c[1].mode="show";return this.effect.apply(this,c)},_hide:a.fn.hide,
hide:function(a){if(b(a))return this._hide.apply(this,arguments);var c=g.apply(this,arguments);c[1].mode="hide";return this.effect.apply(this,c)},__toggle:a.fn.toggle,toggle:function(c){if(b(c)||"boolean"===typeof c||a.isFunction(c))return this.__toggle.apply(this,arguments);var d=g.apply(this,arguments);d[1].mode="toggle";return this.effect.apply(this,d)},cssUnit:function(b){var c=this.css(b),d=[];a.each(["em","px","%","pt"],function(a,b){0<c.indexOf(b)&&(d=[parseFloat(c),b])});return d}});a.easing.jswing=
a.easing.swing;a.extend(a.easing,{def:"easeOutQuad",swing:function(b,c,d,e,f){return a.easing[a.easing.def](b,c,d,e,f)},easeInQuad:function(a,b,c,d,e){return d*(b/=e)*b+c},easeOutQuad:function(a,b,c,d,e){return-d*(b/=e)*(b-2)+c},easeInOutQuad:function(a,b,c,d,e){return 1>(b/=e/2)?d/2*b*b+c:-d/2*(--b*(b-2)-1)+c},easeInCubic:function(a,b,c,d,e){return d*(b/=e)*b*b+c},easeOutCubic:function(a,b,c,d,e){return d*((b=b/e-1)*b*b+1)+c},easeInOutCubic:function(a,b,c,d,e){return 1>(b/=e/2)?d/2*b*b*b+c:d/2*((b-=
2)*b*b+2)+c},easeInQuart:function(a,b,c,d,e){return d*(b/=e)*b*b*b+c},easeOutQuart:function(a,b,c,d,e){return-d*((b=b/e-1)*b*b*b-1)+c},easeInOutQuart:function(a,b,c,d,e){return 1>(b/=e/2)?d/2*b*b*b*b+c:-d/2*((b-=2)*b*b*b-2)+c},easeInQuint:function(a,b,c,d,e){return d*(b/=e)*b*b*b*b+c},easeOutQuint:function(a,b,c,d,e){return d*((b=b/e-1)*b*b*b*b+1)+c},easeInOutQuint:function(a,b,c,d,e){return 1>(b/=e/2)?d/2*b*b*b*b*b+c:d/2*((b-=2)*b*b*b*b+2)+c},easeInSine:function(a,b,c,d,e){return-d*Math.cos(b/e*
(Math.PI/2))+d+c},easeOutSine:function(a,b,c,d,e){return d*Math.sin(b/e*(Math.PI/2))+c},easeInOutSine:function(a,b,c,d,e){return-d/2*(Math.cos(Math.PI*b/e)-1)+c},easeInExpo:function(a,b,c,d,e){return 0==b?c:d*Math.pow(2,10*(b/e-1))+c},easeOutExpo:function(a,b,c,d,e){return b==e?c+d:d*(-Math.pow(2,-10*b/e)+1)+c},easeInOutExpo:function(a,b,c,d,e){return 0==b?c:b==e?c+d:1>(b/=e/2)?d/2*Math.pow(2,10*(b-1))+c:d/2*(-Math.pow(2,-10*--b)+2)+c},easeInCirc:function(a,b,c,d,e){return-d*(Math.sqrt(1-(b/=e)*b)-
1)+c},easeOutCirc:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c},easeInOutCirc:function(a,b,c,d,e){return 1>(b/=e/2)?-d/2*(Math.sqrt(1-b*b)-1)+c:d/2*(Math.sqrt(1-(b-=2)*b)+1)+c},easeInElastic:function(a,b,c,d,e){var a=1.70158,f=0,g=d;if(0==b)return c;if(1==(b/=e))return c+d;f||(f=0.3*e);g<Math.abs(d)?(g=d,a=f/4):a=f/(2*Math.PI)*Math.asin(d/g);return-(g*Math.pow(2,10*(b-=1))*Math.sin((b*e-a)*2*Math.PI/f))+c},easeOutElastic:function(a,b,c,d,e){var a=1.70158,f=0,g=d;if(0==b)return c;if(1==
(b/=e))return c+d;f||(f=0.3*e);g<Math.abs(d)?(g=d,a=f/4):a=f/(2*Math.PI)*Math.asin(d/g);return g*Math.pow(2,-10*b)*Math.sin((b*e-a)*2*Math.PI/f)+d+c},easeInOutElastic:function(a,b,c,d,e){var a=1.70158,f=0,g=d;if(0==b)return c;if(2==(b/=e/2))return c+d;f||(f=e*0.3*1.5);g<Math.abs(d)?(g=d,a=f/4):a=f/(2*Math.PI)*Math.asin(d/g);return 1>b?-0.5*g*Math.pow(2,10*(b-=1))*Math.sin((b*e-a)*2*Math.PI/f)+c:0.5*g*Math.pow(2,-10*(b-=1))*Math.sin((b*e-a)*2*Math.PI/f)+d+c},easeInBack:function(a,b,d,e,f,g){g==c&&
(g=1.70158);return e*(b/=f)*b*((g+1)*b-g)+d},easeOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return e*((b=b/f-1)*b*((g+1)*b+g)+1)+d},easeInOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return 1>(b/=f/2)?e/2*b*b*(((g*=1.525)+1)*b-g)+d:e/2*((b-=2)*b*(((g*=1.525)+1)*b+g)+2)+d},easeInBounce:function(b,c,d,e,f){return e-a.easing.easeOutBounce(b,f-c,0,e,f)+d},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*7.5625*b*b+c:b<2/2.75?d*(7.5625*(b-=1.5/2.75)*b+0.75)+c:b<2.5/2.75?d*(7.5625*(b-=2.25/
2.75)*b+0.9375)+c:d*(7.5625*(b-=2.625/2.75)*b+0.984375)+c},easeInOutBounce:function(b,c,d,e,f){return c<f/2?0.5*a.easing.easeInBounce(b,2*c,0,e,f)+d:0.5*a.easing.easeOutBounce(b,2*c-f,0,e,f)+0.5*e+d}})}(w);(function(a){a.effects.blind=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.direction||"vertical";a.effects.save(d,f);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),
b="vertical"==h?"height":"width",h="vertical"==h?g.height():g.width();"show"==e&&g.css(b,0);var k={};k[b]="show"==e?h:0;g.animate(k,c.duration,c.options.easing,function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(w);(function(a){a.effects.bounce=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"effect"),h=c.options.direction||
"up",g=c.options.distance||20,b=c.options.times||5,k=c.duration||250;/show|hide/.test(e)&&f.push("opacity");a.effects.save(d,f);d.show();a.effects.createWrapper(d);var l="up"==h||"down"==h?"top":"left",h="up"==h||"left"==h?"pos":"neg",g=c.options.distance||("top"==l?d.outerHeight({margin:!0})/3:d.outerWidth({margin:!0})/3);"show"==e&&d.css("opacity",0).css(l,"pos"==h?-g:g);"hide"==e&&(g/=2*b);"hide"!=e&&b--;if("show"==e){var o={opacity:1};o[l]=("pos"==h?"+=":"-=")+g;d.animate(o,k/2,c.options.easing);
g/=2;b--}for(o=0;o<b;o++){var n={},p={};n[l]=("pos"==h?"-=":"+=")+g;p[l]=("pos"==h?"+=":"-=")+g;d.animate(n,k/2,c.options.easing).animate(p,k/2,c.options.easing);g="hide"==e?2*g:g/2}"hide"==e?(o={opacity:0},o[l]=("pos"==h?"-=":"+=")+g,d.animate(o,k/2,c.options.easing,function(){d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)})):(n={},p={},n[l]=("pos"==h?"-=":"+=")+g,p[l]=("pos"==h?"+=":"-=")+g,d.animate(n,k/2,c.options.easing).animate(p,k/2,
c.options.easing,function(){a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(w);(function(a){a.effects.clip=function(c){return this.queue(function(){var d=a(this),f="position,top,bottom,left,right,height,width".split(","),e=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.direction||"vertical";a.effects.save(d,f);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),g="IMG"==
d[0].tagName?g:d,b="vertical"==h?"height":"width",k="vertical"==h?"top":"left",h="vertical"==h?g.height():g.width();"show"==e&&(g.css(b,0),g.css(k,h/2));var l={};l[b]="show"==e?h:0;l[k]="show"==e?0:h/2;g.animate(l,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){e=="hide"&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()}})})}})(w);(function(a){a.effects.drop=function(c){return this.queue(function(){var d=
a(this),f="position,top,bottom,left,right,opacity".split(","),e=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.direction||"left";a.effects.save(d,f);d.show();a.effects.createWrapper(d);var g="up"==h||"down"==h?"top":"left",h="up"==h||"left"==h?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0})/2:d.outerWidth({margin:!0})/2);"show"==e&&d.css("opacity",0).css(g,"pos"==h?-b:b);var k={opacity:"show"==e?1:0};k[g]=("show"==e?"pos"==h?"+=":"-=":"pos"==h?"-=":"+=")+b;d.animate(k,
{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.explode=function(c){return this.queue(function(){var d=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3,f=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3;c.options.mode="toggle"==c.options.mode?a(this).is(":visible")?"hide":"show":c.options.mode;
var e=a(this).show().css("visibility","hidden"),h=e.offset();h.top-=parseInt(e.css("marginTop"),10)||0;h.left-=parseInt(e.css("marginLeft"),10)||0;for(var g=e.outerWidth(!0),b=e.outerHeight(!0),k=0;k<d;k++)for(var l=0;l<f;l++)e.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(g/f),top:-k*(b/d)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:g/f,height:b/d,left:h.left+l*(g/f)+("show"==c.options.mode?(l-Math.floor(f/
2))*(g/f):0),top:h.top+k*(b/d)+("show"==c.options.mode?(k-Math.floor(d/2))*(b/d):0),opacity:"show"==c.options.mode?0:1}).animate({left:h.left+l*(g/f)+("show"==c.options.mode?0:(l-Math.floor(f/2))*(g/f)),top:h.top+k*(b/d)+("show"==c.options.mode?0:(k-Math.floor(d/2))*(b/d)),opacity:"show"==c.options.mode?1:0},c.duration||500);setTimeout(function(){"show"==c.options.mode?e.css({visibility:"visible"}):e.css({visibility:"visible"}).hide();c.callback&&c.callback.apply(e[0]);e.dequeue();a("div.ui-effects-explode").remove()},
c.duration||500)})}})(w);(function(a){a.effects.fade=function(c){return this.queue(function(){var d=a(this),f=a.effects.setMode(d,c.options.mode||"hide");d.animate({opacity:f},{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"hide"),h=c.options.size||
15,g=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,f);d.show();var k=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==e!=g,o=l?["width","height"]:["height","width"],l=l?[k.width(),k.height()]:[k.height(),k.width()],n=/([0-9]+)%/.exec(h);n&&(h=parseInt(n[1],10)/100*l["hide"==e?0:1]);"show"==e&&k.css(g?{height:0,width:h}:{height:h,width:0});g={};n={};g[o[0]]="show"==e?l[0]:h;n[o[1]]="show"==e?l[1]:0;k.animate(g,b,c.options.easing).animate(n,b,
c.options.easing,function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(w);(function(a){a.effects.highlight=function(c){return this.queue(function(){var d=a(this),f=["backgroundImage","backgroundColor","opacity"],e=a.effects.setMode(d,c.options.mode||"show"),h={backgroundColor:d.css("backgroundColor")};"hide"==e&&(h.opacity=0);a.effects.save(d,f);d.show().css({backgroundImage:"none",backgroundColor:c.options.color||
"#ffff99"}).animate(h,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){e=="hide"&&d.hide();a.effects.restore(d,f);e=="show"&&!a.support.opacity&&this.style.removeAttribute("filter");c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.pulsate=function(c){return this.queue(function(){var d=a(this),f=a.effects.setMode(d,c.options.mode||"show"),e=2*(c.options.times||5)-1,h=c.duration?c.duration/2:a.fx.speeds._default/2,g=d.is(":visible"),
b=0;g||(d.css("opacity",0).show(),b=1);("hide"==f&&g||"show"==f&&!g)&&e--;for(f=0;f<e;f++)d.animate({opacity:b},h,c.options.easing),b=(b+1)%2;d.animate({opacity:b},h,c.options.easing,function(){b==0&&d.hide();c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()}).dequeue()})}})(w);(function(a){a.effects.puff=function(c){return this.queue(function(){var d=a(this),f=a.effects.setMode(d,c.options.mode||"hide"),e=parseInt(c.options.percent,10)||150,h=e/100,g={height:d.height(),
width:d.width()};a.extend(c.options,{fade:!0,mode:f,percent:"hide"==f?e:100,from:"hide"==f?g:{height:g.height*h,width:g.width*h}});d.effect("scale",c.options,c.duration,c.callback);d.dequeue()})};a.effects.scale=function(c){return this.queue(function(){var d=a(this),f=a.extend(!0,{},c.options),e=a.effects.setMode(d,c.options.mode||"effect"),h=parseInt(c.options.percent,10)||(0==parseInt(c.options.percent,10)?0:"hide"==e?0:100),g=c.options.direction||"both",b=c.options.origin;"effect"!=e&&(f.origin=
b||["middle","center"],f.restore=!0);b={height:d.height(),width:d.width()};d.from=c.options.from||("show"==e?{height:0,width:0}:b);d.to={height:b.height*("horizontal"!=g?h/100:1),width:b.width*("vertical"!=g?h/100:1)};if(c.options.fade&&("show"==e&&(d.from.opacity=0,d.to.opacity=1),"hide"==e))d.from.opacity=1,d.to.opacity=0;f.from=d.from;f.to=d.to;f.mode=e;d.effect("size",f,c.duration,c.callback);d.dequeue()})};a.effects.size=function(c){return this.queue(function(){var d=a(this),f="position,top,bottom,left,right,width,height,overflow,opacity".split(","),
e="position,top,bottom,left,right,overflow,opacity".split(","),h=["width","height","overflow"],g=["fontSize"],b=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],k=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],l=a.effects.setMode(d,c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",p=c.options.origin,r={height:d.height(),width:d.width()};d.from=c.options.from||r;d.to=c.options.to||r;p&&(p=a.effects.getBaseline(p,r),d.from.top=(r.height-
d.from.height)*p.y,d.from.left=(r.width-d.from.width)*p.x,d.to.top=(r.height-d.to.height)*p.y,d.to.left=(r.width-d.to.width)*p.x);var s=d.from.height/r.height,m=d.from.width/r.width,q=d.to.height/r.height,B=d.to.width/r.width;if("box"==n||"both"==n)if(s!=q&&(f=f.concat(b),d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,q,d.to)),m!=B)f=f.concat(k),d.from=a.effects.setTransition(d,k,m,d.from),d.to=a.effects.setTransition(d,k,B,d.to);if(("content"==n||"both"==n)&&s!=q)f=
f.concat(g),d.from=a.effects.setTransition(d,g,s,d.from),d.to=a.effects.setTransition(d,g,q,d.to);a.effects.save(d,o?f:e);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(g),k=k.concat(["marginLeft","marginRight"]),h=f.concat(b).concat(k),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,h);var e=d.height(),f=d.width();d.from={height:e*s,width:f*m};d.to={height:e*q,width:f*B};if(s!=
q){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,q,d.to)}if(m!=B){d.from=a.effects.setTransition(d,k,m,d.from);d.to=a.effects.setTransition(d,k,B,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,h)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,o?f:e);a.effects.removeWrapper(d);c.callback&&
c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var e=c.options.direction||"left",h=c.options.distance||20,g=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,f);d.show();a.effects.createWrapper(d);var k="up"==e||"down"==e?"top":"left",l="up"==e||"left"==e?"pos":"neg",e={},o={},n={};e[k]=("pos"==
l?"-=":"+=")+h;o[k]=("pos"==l?"+=":"-=")+2*h;n[k]=("pos"==l?"-=":"+=")+2*h;d.animate(e,b,c.options.easing);for(h=1;h<g;h++)d.animate(o,b,c.options.easing).animate(n,b,c.options.easing);d.animate(o,b,c.options.easing).animate(e,b/2,c.options.easing,function(){a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(w);(function(a){a.effects.slide=function(c){return this.queue(function(){var d=a(this),f=["position",
"top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"show"),h=c.options.direction||"left";a.effects.save(d,f);d.show();a.effects.createWrapper(d).css({overflow:"hidden"});var g="up"==h||"down"==h?"top":"left",h="up"==h||"left"==h?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0}):d.outerWidth({margin:!0}));"show"==e&&d.css(g,"pos"==h?isNaN(b)?"-"+b:-b:b);var k={};k[g]=("show"==e?"pos"==h?"+=":"-=":"pos"==h?"-=":"+=")+b;d.animate(k,{queue:!1,duration:c.duration,
easing:c.options.easing,complete:function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(w);(function(a){a.effects.transfer=function(c){return this.queue(function(){var d=a(this),f=a(c.options.to),e=f.offset(),f={top:e.top,left:e.left,height:f.innerHeight(),width:f.innerWidth()},e=d.offset(),h=a('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(c.options.className).css({top:e.top,left:e.left,
height:d.innerHeight(),width:d.innerWidth(),position:"absolute"}).animate(f,c.duration,c.options.easing,function(){h.remove();c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(w);(function(a){a.widget("ui.accordion",{options:{active:0,animated:"slide",autoHeight:!0,clearStyle:!1,collapsible:!1,event:"click",fillSpace:!1,header:"> li > :first-child,> :not(li):even",icons:{header:"ui-icon-triangle-1-e",headerSelected:"ui-icon-triangle-1-s"},navigation:!1,navigationFilter:function(){return this.href.toLowerCase()===
location.href.toLowerCase()}},_create:function(){var c=this,d=c.options;c.running=0;c.element.addClass("ui-accordion ui-widget ui-helper-reset").children("li").addClass("ui-accordion-li-fix");c.headers=c.element.find(d.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all").bind("mouseenter.accordion",function(){d.disabled||a(this).addClass("ui-state-hover")}).bind("mouseleave.accordion",function(){d.disabled||a(this).removeClass("ui-state-hover")}).bind("focus.accordion",
function(){d.disabled||a(this).addClass("ui-state-focus")}).bind("blur.accordion",function(){d.disabled||a(this).removeClass("ui-state-focus")});c.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom");if(d.navigation){var f=c.element.find("a").filter(d.navigationFilter).eq(0);if(f.length){var e=f.closest(".ui-accordion-header");c.active=e.length?e:f.closest(".ui-accordion-content").prev()}}c.active=c._findActive(c.active||d.active).addClass("ui-state-default ui-state-active").toggleClass("ui-corner-all").toggleClass("ui-corner-top");
c.active.next().addClass("ui-accordion-content-active");c._createIcons();c.resize();c.element.attr("role","tablist");c.headers.attr("role","tab").bind("keydown.accordion",function(a){return c._keydown(a)}).next().attr("role","tabpanel");c.headers.not(c.active||"").attr({"aria-expanded":"false","aria-selected":"false",tabIndex:-1}).next().hide();c.active.length?c.active.attr({"aria-expanded":"true","aria-selected":"true",tabIndex:0}):c.headers.eq(0).attr("tabIndex",0);a.browser.safari||c.headers.find("a").attr("tabIndex",
...
destroy:function(){var c=this.options;this.element.removeClass("ui-accordion ui-widget ui-helper-reset").removeAttr("role");this.headers.unbind(".accordion").removeClass("ui-accordion-header ui-accordion-disabled ui-helper-reset ui-state-default ui-corner-all ui-state-active ui-state-disabled ui-corner-top").removeAttr("role").removeAttr("aria-expanded").removeAttr("aria-selected").removeAttr("tabIndex");this.headers.find("a").removeAttr("tabIndex");this._destroyIcons();var d=this.headers.next().css("display",
"").removeAttr("role").removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content ui-accordion-content-active ui-accordion-disabled ui-state-disabled");(c.autoHeight||c.fillHeight)&&d.css("height","");return a.Widget.prototype.destroy.call(this)},_setOption:function(c,d){a.Widget.prototype._setOption.apply(this,arguments);"active"==c&&this.activate(d);"icons"==c&&(this._destroyIcons(),d&&this._createIcons());if("disabled"==c)this.headers.add(this.headers.next())[d?"addClass":
"removeClass"]("ui-accordion-disabled ui-state-disabled")},_keydown:function(c){if(!this.options.disabled&&!c.altKey&&!c.ctrlKey){var d=a.ui.keyCode,f=this.headers.length,e=this.headers.index(c.target),h=!1;switch(c.keyCode){case d.RIGHT:case d.DOWN:h=this.headers[(e+1)%f];break;case d.LEFT:case d.UP:h=this.headers[(e-1+f)%f];break;case d.SPACE:case d.ENTER:this._clickHandler({target:c.target},c.target),c.preventDefault()}return h?(a(c.target).attr("tabIndex",-1),a(h).attr("tabIndex",0),h.focus(),
!1):!0}},resize:function(){var c=this.options,d;if(c.fillSpace){if(a.browser.msie){var f=this.element.parent().css("overflow");this.element.parent().css("overflow","hidden")}d=this.element.parent().height();a.browser.msie&&this.element.parent().css("overflow",f);this.headers.each(function(){d-=a(this).outerHeight(!0)});this.headers.next().each(function(){a(this).height(Math.max(0,d-a(this).innerHeight()+a(this).height()))}).css("overflow","auto")}else c.autoHeight&&(d=0,this.headers.next().each(function(){d=
Math.max(d,a(this).height("").height())}).height(d));return this},activate:function(a){this.options.active=a;a=this._findActive(a)[0];this._clickHandler({target:a},a);return this},_findActive:function(c){return c?"number"===typeof c?this.headers.filter(":eq("+c+")"):this.headers.not(this.headers.not(c)):!1===c?a([]):this.headers.filter(":eq(0)")},_clickHandler:function(c,d){var f=this.options;if(!f.disabled)if(c.target){var e=a(c.currentTarget||d),h=e[0]===this.active[0];f.active=f.collapsible&&h?
!1:this.headers.index(e);if(!(this.running||!f.collapsible&&h)){var g=this.active,b=e.next(),k=this.active.next(),l={options:f,newHeader:h&&f.collapsible?a([]):e,oldHeader:this.active,newContent:h&&f.collapsible?a([]):b,oldContent:k},o=this.headers.index(this.active[0])>this.headers.index(e[0]);this.active=h?a([]):e;this._toggle(b,k,l,h,o);g.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(f.icons.headerSelected).addClass(f.icons.header);
h||(e.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").children(".ui-icon").removeClass(f.icons.header).addClass(f.icons.headerSelected),e.next().addClass("ui-accordion-content-active"))}}else if(f.collapsible){this.active.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(f.icons.headerSelected).addClass(f.icons.header);this.active.next().addClass("ui-accordion-content-active");var k=this.active.next(),
l={options:f,newHeader:a([]),oldHeader:f.active,newContent:a([]),oldContent:k},b=this.active=a([]);this._toggle(b,k,l)}},_toggle:function(c,d,f,e,h){var g=this,b=g.options;g.toShow=c;g.toHide=d;g.data=f;var k=function(){return!g?void 0:g._completed.apply(g,arguments)};g._trigger("changestart",null,g.data);g.running=0===d.size()?c.size():d.size();if(b.animated){f={};f=b.collapsible&&e?{toShow:a([]),toHide:d,complete:k,down:h,autoHeight:b.autoHeight||b.fillSpace}:{toShow:c,toHide:d,complete:k,down:h,
autoHeight:b.autoHeight||b.fillSpace};b.proxied||(b.proxied=b.animated);b.proxiedDuration||(b.proxiedDuration=b.duration);b.animated=a.isFunction(b.proxied)?b.proxied(f):b.proxied;b.duration=a.isFunction(b.proxiedDuration)?b.proxiedDuration(f):b.proxiedDuration;var e=a.ui.accordion.animations,l=b.duration,o=b.animated;o&&!e[o]&&!a.easing[o]&&(o="slide");e[o]||(e[o]=function(a){this.slide(a,{easing:o,duration:l||700})});e[o](f)}else b.collapsible&&e?c.toggle():(d.hide(),c.show()),k(!0);d.prev().attr({"aria-expanded":"false",
...
animations:{slide:function(c,d){c=a.extend({easing:"swing",duration:300},c,d);if(c.toHide.size())if(c.toShow.size()){var f=c.toShow.css("overflow"),e=0,h={},g={},b,k=c.toShow;b=k[0].style.width;k.width(k.parent().width()-parseFloat(k.css("paddingLeft"))-parseFloat(k.css("paddingRight"))-(parseFloat(k.css("borderLeftWidth"))||0)-(parseFloat(k.css("borderRightWidth"))||0));a.each(["height","paddingTop","paddingBottom"],function(b,d){g[d]="hide";var e=(""+a.css(c.toShow[0],d)).match(/^([\d+-.]+)(.*)$/);
h[d]={value:e[1],unit:e[2]||"px"}});c.toShow.css({height:0,overflow:"hidden"}).show();c.toHide.filter(":hidden").each(c.complete).end().filter(":visible").animate(g,{step:function(a,b){"height"==b.prop&&(e=0===b.end-b.start?0:(b.now-b.start)/(b.end-b.start));c.toShow[0].style[b.prop]=e*h[b.prop].value+h[b.prop].unit},duration:c.duration,easing:c.easing,complete:function(){c.autoHeight||c.toShow.css("height","");c.toShow.css({width:b,overflow:f});c.complete()}})}else c.toHide.animate({height:"hide",
paddingTop:"hide",paddingBottom:"hide"},c);else c.toShow.animate({height:"show",paddingTop:"show",paddingBottom:"show"},c)},bounceslide:function(a){this.slide(a,{easing:a.down?"easeOutBounce":"swing",duration:a.down?1E3:200})}}})})(w);(function(a){var c=0;a.widget("ui.autocomplete",{options:{appendTo:"body",autoFocus:!1,delay:300,minLength:1,position:{my:"left top",at:"left bottom",collision:"none"},source:null},pending:0,_create:function(){var c=this,f=this.element[0].ownerDocument,e;this.isMultiLine=
this.element.is("textarea");this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete",function(f){if(!c.options.disabled&&!c.element.propAttr("readOnly")){e=!1;var g=a.ui.keyCode;switch(f.keyCode){case g.PAGE_UP:c._move("previousPage",f);break;case g.PAGE_DOWN:c._move("nextPage",f);break;case g.UP:c._keyEvent("previous",f);break;case g.DOWN:c._keyEvent("next",f);break;case g.ENTER:case g.NUMPAD_ENTER:c.menu.active&&
(e=!0,f.preventDefault());case g.TAB:if(!c.menu.active)break;c.menu.select(f);break;case g.ESCAPE:c.element.val(c.term);c.close(f);break;default:clearTimeout(c.searching),c.searching=setTimeout(function(){c.term!=c.element.val()&&(c.selectedItem=null,c.search(null,f))},c.options.delay)}}}).bind("keypress.autocomplete",function(a){e&&(e=!1,a.preventDefault())}).bind("focus.autocomplete",function(){c.options.disabled||(c.selectedItem=null,c.previous=c.element.val())}).bind("blur.autocomplete",function(a){c.options.disabled||
(clearTimeout(c.searching),c.closing=setTimeout(function(){c.close(a);c._change(a)},150))});this._initSource();this.menu=a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo||"body",f)[0]).mousedown(function(e){var f=c.menu.element[0];a(e.target).closest(".ui-menu-item").length||setTimeout(function(){a(document).one("mousedown",function(b){b.target!==c.element[0]&&b.target!==f&&!a.ui.contains(f,b.target)&&c.close()})},1);setTimeout(function(){clearTimeout(c.closing)},13)}).menu({focus:function(a,
e){var b=e.item.data("item.autocomplete");!1!==c._trigger("focus",a,{item:b})&&/^key/.test(a.originalEvent.type)&&c.element.val(b.value)},selected:function(a,e){var b=e.item.data("item.autocomplete"),k=c.previous;c.element[0]!==f.activeElement&&(c.element.focus(),c.previous=k,setTimeout(function(){c.previous=k;c.selectedItem=b},1));!1!==c._trigger("select",a,{item:b})&&c.element.val(b.value);c.term=c.element.val();c.close(a);c.selectedItem=b},blur:function(){c.menu.element.is(":visible")&&c.element.val()!==
c.term&&c.element.val(c.term)}}).zIndex(this.element.zIndex()+1).css({top:0,left:0}).hide().data("menu");a.fn.bgiframe&&this.menu.element.bgiframe();c.beforeunloadHandler=function(){c.element.removeAttr("autocomplete")};a(m).bind("beforeunload",c.beforeunloadHandler)},destroy:function(){this.element.removeClass("ui-autocomplete-input").removeAttr("autocomplete").removeAttr("role").removeAttr("aria-autocomplete").removeAttr("aria-haspopup");this.menu.element.remove();a(m).unbind("beforeunload",this.beforeunloadHandler);
a.Widget.prototype.destroy.call(this)},_setOption:function(c,f){a.Widget.prototype._setOption.apply(this,arguments);"source"===c&&this._initSource();"appendTo"===c&&this.menu.element.appendTo(a(f||"body",this.element[0].ownerDocument)[0]);"disabled"===c&&f&&this.xhr&&this.xhr.abort()},_initSource:function(){var c=this,f,e;a.isArray(this.options.source)?(f=this.options.source,this.source=function(c,d){d(a.ui.autocomplete.filter(f,c.term))}):"string"===typeof this.options.source?(e=this.options.source,
this.source=function(f,g){c.xhr&&c.xhr.abort();c.xhr=a.ajax({url:e,data:f,dataType:"json",success:function(a){g(a)},error:function(){g([])}})}):this.source=this.options.source},search:function(a,c){a=null!=a?a:this.element.val();this.term=this.element.val();if(a.length<this.options.minLength)return this.close(c);clearTimeout(this.closing);return!1===this._trigger("search",c)?void 0:this._search(a)},_search:function(a){this.pending++;this.element.addClass("ui-autocomplete-loading");this.source({term:a},
this._response())},_response:function(){var a=this,f=++c;return function(e){f===c&&a.__response(e);a.pending--;a.pending||a.element.removeClass("ui-autocomplete-loading")}},__response:function(a){!this.options.disabled&&a&&a.length?(a=this._normalize(a),this._suggest(a),this._trigger("open")):this.close()},close:function(a){clearTimeout(this.closing);this.menu.element.is(":visible")&&(this.menu.element.hide(),this.menu.deactivate(),this._trigger("close",a))},_change:function(a){this.previous!==this.element.val()&&
this._trigger("change",a,{item:this.selectedItem})},_normalize:function(c){return c.length&&c[0].label&&c[0].value?c:a.map(c,function(c){return"string"===typeof c?{label:c,value:c}:a.extend({label:c.label||c.value,value:c.value||c.label},c)})},_suggest:function(c){var f=this.menu.element.empty().zIndex(this.element.zIndex()+1);this._renderMenu(f,c);this.menu.deactivate();this.menu.refresh();f.show();this._resizeMenu();f.position(a.extend({of:this.element},this.options.position));this.options.autoFocus&&
this.menu.next(new a.Event("mouseover"))},_resizeMenu:function(){var a=this.menu.element;a.outerWidth(Math.max(a.width("").outerWidth()+1,this.element.outerWidth()))},_renderMenu:function(c,f){var e=this;a.each(f,function(a,f){e._renderItem(c,f)})},_renderItem:function(c,f){return a("<li></li>").data("item.autocomplete",f).append(a("<a></a>").text(f.label)).appendTo(c)},_move:function(a,c){if(this.menu.element.is(":visible"))if(this.menu.first()&&/^previous/.test(a)||this.menu.last()&&/^next/.test(a))this.element.val(this.term),
this.menu.deactivate();else this.menu[a](c);else this.search(null,c)},widget:function(){return this.menu.element},_keyEvent:function(a,c){if(!this.isMultiLine||this.menu.element.is(":visible"))this._move(a,c),c.preventDefault()}});a.extend(a.ui.autocomplete,{escapeRegex:function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")},filter:function(c,f){var e=RegExp(a.ui.autocomplete.escapeRegex(f),"i");return a.grep(c,function(a){return e.test(a.label||a.value||a)})}})})(w);(function(a){a.widget("ui.menu",
{_create:function(){var c=this;this.element.addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr({role:"listbox","aria-activedescendant":"ui-active-menuitem"}).click(function(d){a(d.target).closest(".ui-menu-item a").length&&(d.preventDefault(),c.select(d))});this.refresh()},refresh:function(){var c=this;this.element.children("li:not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role","menuitem").children("a").addClass("ui-corner-all").attr("tabindex",-1).mouseenter(function(d){c.activate(d,
a(this).parent())}).mouseleave(function(){c.deactivate()})},activate:function(a,d){this.deactivate();if(this.hasScroll()){var f=d.offset().top-this.element.offset().top,e=this.element.scrollTop(),h=this.element.height();0>f?this.element.scrollTop(e+f):f>=h&&this.element.scrollTop(e+f-h+d.height())}this.active=d.eq(0).children("a").addClass("ui-state-hover").attr("id","ui-active-menuitem").end();this._trigger("focus",a,{item:d})},deactivate:function(){this.active&&(this.active.children("a").removeClass("ui-state-hover").removeAttr("id"),
this._trigger("blur"),this.active=null)},next:function(a){this.move("next",".ui-menu-item:first",a)},previous:function(a){this.move("prev",".ui-menu-item:last",a)},first:function(){return this.active&&!this.active.prevAll(".ui-menu-item").length},last:function(){return this.active&&!this.active.nextAll(".ui-menu-item").length},move:function(a,d,f){this.active?(a=this.active[a+"All"](".ui-menu-item").eq(0),a.length?this.activate(f,a):this.activate(f,this.element.children(d))):this.activate(f,this.element.children(d))},
nextPage:function(c){if(this.hasScroll())if(!this.active||this.last())this.activate(c,this.element.children(".ui-menu-item:first"));else{var d=this.active.offset().top,f=this.element.height(),e=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d-f+a(this).height();return 10>c&&-10<c});e.length||(e=this.element.children(".ui-menu-item:last"));this.activate(c,e)}else this.activate(c,this.element.children(".ui-menu-item").filter(!this.active||this.last()?":first":":last"))},
previousPage:function(c){if(this.hasScroll())if(!this.active||this.first())this.activate(c,this.element.children(".ui-menu-item:last"));else{var d=this.active.offset().top,f=this.element.height(),e=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d+f-a(this).height();return 10>c&&-10<c});e.length||(e=this.element.children(".ui-menu-item:first"));this.activate(c,e)}else this.activate(c,this.element.children(".ui-menu-item").filter(!this.active||this.first()?":last":
":first"))},hasScroll:function(){return this.element.height()<this.element[a.fn.prop?"prop":"attr"]("scrollHeight")},select:function(a){this._trigger("selected",a,{item:this.active})}})})(w);(function(a){var c,d,f,e,h=function(){var b=a(this).find(":ui-button");setTimeout(function(){b.button("refresh")},1)},g=function(b){var c=b.name,d=b.form,e=a([]);c&&(e=d?a(d).find("[name='"+c+"']"):a("[name='"+c+"']",b.ownerDocument).filter(function(){return!this.form}));return e};a.widget("ui.button",{options:{disabled:null,
text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset.button").bind("reset.button",h);"boolean"!==typeof this.options.disabled?this.options.disabled=!!this.element.propAttr("disabled"):this.element.propAttr("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var b=this,k=this.options,l="checkbox"===this.type||"radio"===this.type,o="ui-state-hover"+(!l?" ui-state-active":"");null===
k.label&&(k.label=this.buttonElement.html());this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter.button",function(){if(!k.disabled){a(this).addClass("ui-state-hover");this===c&&a(this).addClass("ui-state-active")}}).bind("mouseleave.button",function(){k.disabled||a(this).removeClass(o)}).bind("click.button",function(a){if(k.disabled){a.preventDefault();a.stopImmediatePropagation()}});this.element.bind("focus.button",function(){b.buttonElement.addClass("ui-state-focus")}).bind("blur.button",
function(){b.buttonElement.removeClass("ui-state-focus")});l&&(this.element.bind("change.button",function(){e||b.refresh()}),this.buttonElement.bind("mousedown.button",function(a){if(!k.disabled){e=false;d=a.pageX;f=a.pageY}}).bind("mouseup.button",function(a){if(!k.disabled&&(d!==a.pageX||f!==a.pageY))e=true}));"checkbox"===this.type?this.buttonElement.bind("click.button",function(){if(k.disabled||e)return false;a(this).toggleClass("ui-state-active");b.buttonElement.attr("aria-pressed",b.element[0].checked)}):
"radio"===this.type?this.buttonElement.bind("click.button",function(){if(k.disabled||e)return false;a(this).addClass("ui-state-active");b.buttonElement.attr("aria-pressed","true");var c=b.element[0];g(c).not(c).map(function(){return a(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown.button",function(){if(k.disabled)return false;a(this).addClass("ui-state-active");c=this;a(document).one("mouseup",function(){c=null})}).bind("mouseup.button",
function(){if(k.disabled)return false;a(this).removeClass("ui-state-active")}).bind("keydown.button",function(b){if(k.disabled)return false;(b.keyCode==a.ui.keyCode.SPACE||b.keyCode==a.ui.keyCode.ENTER)&&a(this).addClass("ui-state-active")}).bind("keyup.button",function(){a(this).removeClass("ui-state-active")}),this.buttonElement.is("a")&&this.buttonElement.keyup(function(b){b.keyCode===a.ui.keyCode.SPACE&&a(this).click()}));this._setOption("disabled",k.disabled);this._resetButton()},_determineButtonType:function(){this.type=
this.element.is(":checkbox")?"checkbox":this.element.is(":radio")?"radio":this.element.is("input")?"input":"button";if("checkbox"===this.type||"radio"===this.type){var a=this.element.parents().filter(":last"),c="label[for='"+this.element.attr("id")+"']";this.buttonElement=a.find(c);this.buttonElement.length||(a=a.length?a.siblings():this.element.siblings(),this.buttonElement=a.filter(c),this.buttonElement.length||(this.buttonElement=a.find(c)));this.element.addClass("ui-helper-hidden-accessible");
...
minDate:null,maxDate:null,duration:"fast",beforeShowDay:null,beforeShow:null,onSelect:null,onChangeMonthYear:null,onClose:null,numberOfMonths:1,showCurrentAtPos:0,stepMonths:1,stepBigMonths:12,altField:"",altFormat:"",constrainInput:!0,showButtonPanel:!1,autoSize:!1,disabled:!1};a.extend(this._defaults,this.regional[""]);this.dpDiv=f(a('<div id="'+this._mainDivId+'" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>'))}function f(b){return b.bind("mouseout",
function(b){b=a(b.target).closest("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a");b.length&&b.removeClass("ui-state-hover ui-datepicker-prev-hover ui-datepicker-next-hover")}).bind("mouseover",function(c){c=a(c.target).closest("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a");if(!a.datepicker._isDisabledDatepicker(g.inline?b.parent()[0]:g.input[0])&&c.length)c.parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
c.addClass("ui-state-hover"),c.hasClass("ui-datepicker-prev")&&c.addClass("ui-datepicker-prev-hover"),c.hasClass("ui-datepicker-next")&&c.addClass("ui-datepicker-next-hover")})}function e(b,d){a.extend(b,d);for(var e in d)if(null==d[e]||d[e]==c)b[e]=d[e];return b}a.extend(a.ui,{datepicker:{version:"1.8.20"}});var h=(new Date).getTime(),g;a.extend(d.prototype,{markerClassName:"hasDatepicker",maxRows:4,log:function(){this.debug&&console.log.apply("",arguments)},_widgetDatepicker:function(){return this.dpDiv},
setDefaults:function(a){e(this._defaults,a||{});return this},_attachDatepicker:function(b,c){var d=null,e;for(e in this._defaults){var f=b.getAttribute("date:"+e);if(f){d=d||{};try{d[e]=eval(f)}catch(g){d[e]=f}}}e=b.nodeName.toLowerCase();f="div"==e||"span"==e;b.id||(this.uuid+=1,b.id="dp"+this.uuid);var h=this._newInst(a(b),f);h.settings=a.extend({},c||{},d||{});"input"==e?this._connectDatepicker(b,h):f&&this._inlineDatepicker(b,h)},_newInst:function(b,c){return{id:b[0].id.replace(/([^A-Za-z0-9_-])/g,
...
else{a.datepicker._datepickerShowing&&a.datepicker._lastInput!=b[0]&&a.datepicker._hideDatepicker();a.datepicker._showDatepicker(b[0])}return false})}},_autoSize:function(a){if(this._get(a,"autoSize")&&!a.inline){var c=new Date(2009,11,20),d=this._get(a,"dateFormat");if(d.match(/[DM]/)){var e=function(a){for(var b=0,c=0,d=0;d<a.length;d++)a[d].length>b&&(b=a[d].length,c=d);return c};c.setMonth(e(this._get(a,d.match(/MM/)?"monthNames":"monthNamesShort")));c.setDate(e(this._get(a,d.match(/DD/)?"dayNames":
...
this._dialogInput.val(c);this._pos=g?g.length?g:[g.pageX,g.pageY]:null;this._pos||(this._pos=[document.documentElement.clientWidth/2-100+(document.documentElement.scrollLeft||document.body.scrollLeft),document.documentElement.clientHeight/2-150+(document.documentElement.scrollTop||document.body.scrollTop)]);this._dialogInput.css("left",this._pos[0]+20+"px").css("top",this._pos[1]+"px");b.settings.onSelect=d;this._inDialog=!0;this.dpDiv.addClass(this._dialogClass);this._showDatepicker(this._dialogInput[0]);
...
d?a.extend({},a.datepicker._defaults):g?"all"==d?a.extend({},g.settings):this._get(g,d):null;var h=d||{};"string"==typeof d&&(h={},h[d]=f);if(g){this._curInst==g&&this._hideDatepicker();var p=this._getDateDatepicker(b,!0),r=this._getMinMaxDate(g,"min"),m=this._getMinMaxDate(g,"max");e(g.settings,h);null!==r&&h.dateFormat!==c&&h.minDate===c&&(g.settings.minDate=this._formatDate(g,r));null!==m&&h.dateFormat!==c&&h.maxDate===c&&(g.settings.maxDate=this._formatDate(g,m));this._attachments(a(b),g);this._autoSize(g);
this._setDate(g,p);this._updateAlternate(g);this._updateDatepicker(g)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,c,d)},_refreshDatepicker:function(a){(a=this._getInst(a))&&this._updateDatepicker(a)},_setDateDatepicker:function(a,c){var d=this._getInst(a);d&&(this._setDate(d,c),this._updateDatepicker(d),this._updateAlternate(d))},_getDateDatepicker:function(a,c){var d=this._getInst(a);d&&!d.inline&&this._setDateFromField(d,c);return d?this._getDate(d):null},_doKeyDown:function(b){var c=
...
break;case 37:if(b.ctrlKey||b.metaKey)a.datepicker._adjustDate(b.target,e?1:-1,"D");d=b.ctrlKey||b.metaKey;b.originalEvent.altKey&&a.datepicker._adjustDate(b.target,b.ctrlKey?-a.datepicker._get(c,"stepBigMonths"):-a.datepicker._get(c,"stepMonths"),"M");break;case 38:(b.ctrlKey||b.metaKey)&&a.datepicker._adjustDate(b.target,-7,"D");d=b.ctrlKey||b.metaKey;break;case 39:if(b.ctrlKey||b.metaKey)a.datepicker._adjustDate(b.target,e?-1:1,"D");d=b.ctrlKey||b.metaKey;b.originalEvent.altKey&&a.datepicker._adjustDate(b.target,
...
c?b.keyCode:b.charCode);return b.ctrlKey||b.metaKey||" ">e||!d||-1<d.indexOf(e)}},_doKeyUp:function(b){b=a.datepicker._getInst(b.target);if(b.input.val()!=b.lastVal)try{if(a.datepicker.parseDate(a.datepicker._get(b,"dateFormat"),b.input?b.input.val():null,a.datepicker._getFormatConfig(b)))a.datepicker._setDateFromField(b),a.datepicker._updateAlternate(b),a.datepicker._updateDatepicker(b)}catch(c){a.datepicker.log(c)}return!0},_showDatepicker:function(b){b=b.target||b;"input"!=b.nodeName.toLowerCase()&&
...
(b.value="");a.datepicker._pos||(a.datepicker._pos=a.datepicker._findPos(b),a.datepicker._pos[1]+=b.offsetHeight);var f=!1;a(b).parents().each(function(){f=f|a(this).css("position")=="fixed";return!f});f&&a.browser.opera&&(a.datepicker._pos[0]-=document.documentElement.scrollLeft,a.datepicker._pos[1]-=document.documentElement.scrollTop);d={left:a.datepicker._pos[0],top:a.datepicker._pos[1]};a.datepicker._pos=null;c.dpDiv.empty();c.dpDiv.css({position:"absolute",display:"block",top:"-1000px"});a.datepicker._updateDatepicker(c);
d=a.datepicker._checkOffset(c,d,f);c.dpDiv.css({position:a.datepicker._inDialog&&a.blockUI?"static":f?"fixed":"absolute",display:"none",left:d.left+"px",top:d.top+"px"});if(!c.inline){var d=a.datepicker._get(c,"showAnim"),g=a.datepicker._get(c,"duration"),h=function(){var b=c.dpDiv.find("iframe.ui-datepicker-cover");if(b.length){var d=a.datepicker._getBorders(c.dpDiv);b.css({left:-d[0],top:-d[1],width:c.dpDiv.outerWidth(),height:c.dpDiv.outerHeight()})}};c.dpDiv.zIndex(a(b).zIndex()+1);a.datepicker._datepickerShowing=
!0;if(a.effects&&a.effects[d])c.dpDiv.show(d,a.datepicker._get(c,"showOptions"),g,h);else c.dpDiv[d||"show"](d?g:null,h);(!d||!g)&&h();c.input.is(":visible")&&!c.input.is(":disabled")&&c.input.focus();a.datepicker._curInst=c}}}},_updateDatepicker:function(b){this.maxRows=4;var c=a.datepicker._getBorders(b.dpDiv);g=b;b.dpDiv.empty().append(this._generateHTML(b));var d=b.dpDiv.find("iframe.ui-datepicker-cover");d.length&&d.css({left:-c[0],top:-c[1],width:b.dpDiv.outerWidth(),height:b.dpDiv.outerHeight()});
...
!b.input.is(":disabled")&&b.input[0]!=document.activeElement&&b.input.focus();if(b.yearshtml){var e=b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),f=b.dpDiv.outerHeight(),
g=b.input?b.input.outerWidth():0,h=b.input?b.input.outerHeight():0,m=document.documentElement.clientWidth+a(document).scrollLeft(),x=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-g:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+h?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>m&&m>e?Math.abs(c.left+e-m):0);c.top-=Math.min(c.top,c.top+f>x&&x>f?Math.abs(f+h):0);return c},_findPos:function(b){for(var c=
this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=b[c?"previousSibling":"nextSibling"];b=a(b).offset();return[b.left,b.top]},_hideDatepicker:function(b){var c=this._curInst;if(c&&!(b&&c!=a.data(b,"datepicker"))&&this._datepickerShowing){var b=this._get(c,"showAnim"),d=this._get(c,"duration"),e=function(){a.datepicker._tidyDialog(c)};if(a.effects&&a.effects[b])c.dpDiv.hide(b,a.datepicker._get(c,"showOptions"),d,e);else c.dpDiv["slideDown"==b?"slideUp":
...
_clearDate:function(b){b=a(b);this._getInst(b[0]);this._selectDate(b,"")},_selectDate:function(b,c){var d=this._getInst(a(b)[0]),c=null!=c?c:this._formatDate(d);d.input&&d.input.val(c);this._updateAlternate(d);var e=this._get(d,"onSelect");e?e.apply(d.input?d.input[0]:null,[c,d]):d.input&&d.input.trigger("change");d.inline?this._updateDatepicker(d):(this._hideDatepicker(),this._lastInput=d.input[0],"object"!=typeof d.input[0]&&d.input.focus(),this._lastInput=null)},_updateAlternate:function(b){var c=
this._get(b,"altField");if(c){var d=this._get(b,"altFormat")||this._get(b,"dateFormat"),e=this._getDate(b),f=this.formatDate(d,e,this._getFormatConfig(b));a(c).each(function(){a(this).val(f)})}},noWeekends:function(a){a=a.getDay();return[0<a&&6>a,""]},iso8601Week:function(a){a=new Date(a.getTime());a.setDate(a.getDate()+4-(a.getDay()||7));var c=a.getTime();a.setMonth(0);a.setDate(1);return Math.floor(Math.round((c-a)/864E5)/7)+1},parseDate:function(b,c,d){if(null==b||null==c)throw"Invalid arguments";
c="object"==typeof c?c.toString():c+"";if(""==c)return null;for(var e=(d?d.shortYearCutoff:null)||this._defaults.shortYearCutoff,e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,h=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,m=(d?d.monthNames:null)||this._defaults.monthNames,x=d=-1,q=-1,B=-1,A=!1,C=function(a){(a=Q+1<b.length&&b.charAt(Q+1)==a)&&Q++;return a},w=function(a){var b=
C(a),a=c.substring(D).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+D;D+=a[0].length;return parseInt(a[0],10)},y=function(b,d,e){var b=a.map(C(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(D,d.length).toLowerCase()==d.toLowerCase())return f=b[0],D+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+D;},F=function(){if(c.charAt(D)!=
b.charAt(Q))throw"Unexpected literal at position "+D;D++},D=0,Q=0;Q<b.length;Q++)if(A)"'"==b.charAt(Q)&&!C("'")?A=!1:F();else switch(b.charAt(Q)){case "d":q=w("d");break;case "D":y("D",f,g);break;case "o":B=w("o");break;case "m":x=w("m");break;case "M":x=y("M",h,m);break;case "y":d=w("y");break;case "@":var J=new Date(w("@")),d=J.getFullYear(),x=J.getMonth()+1,q=J.getDate();break;case "!":J=new Date((w("!")-this._ticksTo1970)/1E4);d=J.getFullYear();x=J.getMonth()+1;q=J.getDate();break;case "'":C("'")?
F():A=!0;break;default:F()}if(D<c.length)throw"Extra/unparsed characters found in date: "+c.substring(D);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<B){x=1;q=B;do{e=this._getDaysInMonth(d,x-1);if(q<=e)break;x++;q-=e}while(1)}J=this._daylightSavingAdjust(new Date(d,x-1,q));if(J.getFullYear()!=d||J.getMonth()+1!=x||J.getDate()!=q)throw"Invalid date";return J},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",
RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,h=function(c){(c=A+1<
a.length&&a.charAt(A+1)==c)&&A++;return c},m=function(a,b,c){b=""+b;if(h(a))for(;b.length<c;)b="0"+b;return b},x=function(a,b,c,d){return h(a)?d[b]:c[b]},q="",B=!1;if(c)for(var A=0;A<a.length;A++)if(B)"'"==a.charAt(A)&&!h("'")?B=!1:q+=a.charAt(A);else switch(a.charAt(A)){case "d":q+=m("d",c.getDate(),2);break;case "D":q+=x("D",c.getDay(),e,f);break;case "o":q+=m("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;
case "m":q+=m("m",c.getMonth()+1,2);break;case "M":q+=x("M",c.getMonth(),g,d);break;case "y":q+=h("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":q+=c.getTime();break;case "!":q+=1E4*c.getTime()+this._ticksTo1970;break;case "'":h("'")?q+="'":B=!0;break;default:q+=a.charAt(A)}return q},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+=
"0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(f)}return c},_get:function(a,d){return a.settings[d]!==c?a.settings[d]:this._defaults[d]},_setDateFromField:function(a,c){if(a.input.val()!=a.lastVal){var d=this._get(a,"dateFormat"),e=a.lastVal=a.input?a.input.val():null,f,g;f=g=this._getDefaultDate(a);var h=this._getFormatConfig(a);try{f=this.parseDate(d,e,h)||g}catch(m){this.log(m),e=c?"":e}a.selectedDay=f.getDate();a.drawMonth=a.selectedMonth=
f.getMonth();a.drawYear=a.selectedYear=f.getFullYear();a.currentDay=e?f.getDate():0;a.currentMonth=e?f.getMonth():0;a.currentYear=e?f.getFullYear():0;this._adjustInstDate(a)}},_getDefaultDate:function(a){return this._restrictMinMax(a,this._determineDate(a,this._get(a,"defaultDate"),new Date))},_determineDate:function(b,c,d){var e=function(a){var b=new Date;b.setDate(b.getDate()+a);return b};if(c=(c=null==c||""===c?d:"string"==typeof c?function(c){try{return a.datepicker.parseDate(a.datepicker._get(b,
...
g))}k=h.exec(c)}return new Date(f,g,e)}(c):"number"==typeof c?isNaN(c)?d:e(c):new Date(c.getTime()))&&"Invalid Date"==c.toString()?d:c)c.setHours(0),c.setMinutes(0),c.setSeconds(0),c.setMilliseconds(0);return this._daylightSavingAdjust(c)},_daylightSavingAdjust:function(a){if(!a)return null;a.setHours(12<a.getHours()?a.getHours()+2:0);return a},_setDate:function(a,c,d){var e=!c,f=a.selectedMonth,g=a.selectedYear,c=this._restrictMinMax(a,this._determineDate(a,c,new Date));a.selectedDay=a.currentDay=
c.getDate();a.drawMonth=a.selectedMonth=a.currentMonth=c.getMonth();a.drawYear=a.selectedYear=a.currentYear=c.getFullYear();(f!=a.selectedMonth||g!=a.selectedYear)&&!d&&this._notifyChange(a);this._adjustInstDate(a);a.input&&a.input.val(e?"":this._formatDate(a))},_getDate:function(a){return!a.currentYear||a.input&&""==a.input.val()?null:this._daylightSavingAdjust(new Date(a.currentYear,a.currentMonth,a.currentDay))},_generateHTML:function(b){var c=new Date,c=this._daylightSavingAdjust(new Date(c.getFullYear(),
c.getMonth(),c.getDate())),d=this._get(b,"isRTL"),e=this._get(b,"showButtonPanel"),f=this._get(b,"hideIfNoPrevNext"),g=this._get(b,"navigationAsDateFormat"),m=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),x=this._get(b,"stepMonths"),q=1!=m[0]||1!=m[1],B=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),A=this._getMinMaxDate(b,"min"),w=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,E=b.drawYear;0>s&&(s+=12,E--);if(w)for(var y=
this._daylightSavingAdjust(new Date(w.getFullYear(),w.getMonth()-m[0]*m[1]+1,w.getDate())),y=A&&y<A?A:y;this._daylightSavingAdjust(new Date(E,s,1))>y;)s--,0>s&&(s=11,E--);b.drawMonth=s;b.drawYear=E;var y=this._get(b,"prevText"),y=!g?y:this.formatDate(y,this._daylightSavingAdjust(new Date(E,s-x,1)),this._getFormatConfig(b)),y=this._canAdjustMonth(b,-1,E,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', -"+x+", 'M');\" title=\""+y+'"><span class="ui-icon ui-icon-circle-triangle-'+
(d?"e":"w")+'">'+y+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+y+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+y+"</span></a>",F=this._get(b,"nextText"),F=!g?F:this.formatDate(F,this._daylightSavingAdjust(new Date(E,s+x,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,E,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', +"+x+", 'M');\" title=\""+F+'"><span class="ui-icon ui-icon-circle-triangle-'+
(d?"w":"e")+'">'+F+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+F+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+F+"</span></a>",x=this._get(b,"currentText"),F=this._get(b,"gotoCurrent")&&b.currentDay?B:c,x=!g?x:this.formatDate(x,F,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+h+'.datepicker._hideDatepicker();">'+this._get(b,
"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,F)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._gotoToday('#"+b.id+"');\">"+x+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,x=this._get(b,"showWeek"),F=this._get(b,"dayNames");this._get(b,"dayNamesShort");var D=this._get(b,"dayNamesMin"),Q=
this._get(b,"monthNames"),J=this._get(b,"monthNamesShort"),v=this._get(b,"beforeShowDay"),V=this._get(b,"showOtherMonths"),M=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var i=this._getDefaultDate(b),T="",H=0;H<m[0];H++){var t="";this.maxRows=4;for(var R=0;R<m[1];R++){var P=this._daylightSavingAdjust(new Date(E,s,b.selectedDay)),I=" ui-corner-all",G="";if(q){G+='<div class="ui-datepicker-group';if(1<m[1])switch(R){case 0:G+=" ui-datepicker-group-first";I=" ui-corner-"+(d?"right":
"left");break;case m[1]-1:G+=" ui-datepicker-group-last";I=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",I=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+I+'">'+(/all|left/.test(I)&&0==H?d?f:y:"")+(/all|right/.test(I)&&0==H?d?y:f:"")+this._generateMonthYearHeader(b,s,E,A,w,0<H||0<R,Q,J)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),O=x?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":
"",I=0;7>I;I++)var N=(I+g)%7,O=O+("<th"+(5<=(I+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+F[N]+'">'+D[N]+"</span></th>");G+=O+"</tr></thead><tbody>";O=this._getDaysInMonth(E,s);E==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,O));I=(this._getFirstDayOfMonth(E,s)-g+7)%7;O=Math.ceil((I+O)/7);this.maxRows=O=q?this.maxRows>O?this.maxRows:O:O;for(var N=this._daylightSavingAdjust(new Date(E,s,1-I)),W=0;W<O;W++){for(var G=G+"<tr>",X=!x?"":'<td class="ui-datepicker-week-col">'+
this._get(b,"calculateWeek")(N)+"</td>",I=0;7>I;I++){var S=v?v.apply(b.input?b.input[0]:null,[N]):[!0,""],j=N.getMonth()!=s,u=j&&!M||!S[0]||A&&N<A||w&&N>w,X=X+('<td class="'+(5<=(I+g+6)%7?" ui-datepicker-week-end":"")+(j?" ui-datepicker-other-month":"")+(N.getTime()==P.getTime()&&s==b.selectedMonth&&b._keyEvent||i.getTime()==N.getTime()&&i.getTime()==P.getTime()?" "+this._dayOverClass:"")+(u?" "+this._unselectableClass+" ui-state-disabled":"")+(j&&!V?"":" "+S[1]+(N.getTime()==B.getTime()?" "+this._currentClass:
"")+(N.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!j||V)&&S[2]?' title="'+S[2]+'"':"")+(u?"":' onclick="DP_jQuery_'+h+".datepicker._selectDay('#"+b.id+"',"+N.getMonth()+","+N.getFullYear()+', this);return false;"')+">"+(j&&!V?"&#xa0;":u?'<span class="ui-state-default">'+N.getDate()+"</span>":'<a class="ui-state-default'+(N.getTime()==c.getTime()?" ui-state-highlight":"")+(N.getTime()==B.getTime()?" ui-state-active":"")+(j?" ui-priority-secondary":"")+'" href="#">'+N.getDate()+"</a>")+
"</td>");N.setDate(N.getDate()+1);N=this._daylightSavingAdjust(N)}G+=X+"</tr>"}s++;11<s&&(s=0,E++);G+="</tbody></table>"+(q?"</div>"+(0<m[0]&&R==m[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");t+=G}T+=t}T+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return T},_generateMonthYearHeader:function(a,c,d,e,f,g,m,s){var x=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),
w=this._get(a,"showMonthAfterYear"),A='<div class="ui-datepicker-title">',C="";if(g||!x)C+='<span class="ui-datepicker-month">'+m[c]+"</span>";else{for(var m=e&&e.getFullYear()==d,E=f&&f.getFullYear()==d,C=C+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+h+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),y=0;12>y;y++)if((!m||y>=e.getMonth())&&(!E||y<=f.getMonth()))C+='<option value="'+y+'"'+(y==c?' selected="selected"':"")+">"+s[y]+"</option>";C+="</select>"}w||(A+=C+(g||
!x||!q?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!q)A+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,"yearRange").split(":"),F=(new Date).getFullYear(),m=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?F+parseInt(a,10):parseInt(a,10);return isNaN(a)?F:a},c=m(s[0]),s=Math.max(c,m(s[1]||"")),c=e?Math.max(c,e.getFullYear()):c,s=f?Math.min(s,f.getFullYear()):s;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+
h+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=s;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':"")+">"+c+"</option>";a.yearshtml+="</select>";A+=a.yearshtml;a.yearshtml=null}A+=this._get(a,"yearSuffix");w&&(A+=(g||!x||!q?"&#xa0;":"")+C);return A+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,
f,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||"Y"==d)&&this._notifyChange(a)},_restrictMinMax:function(a,c){var d=this._getMinMaxDate(a,"min"),e=this._getMinMaxDate(a,"max"),d=d&&c<d?d:c;return e&&d>e?e:d},_notifyChange:function(a){var c=this._get(a,"onChangeMonthYear");c&&c.apply(a.input?a.input[0]:null,[a.selectedYear,a.selectedMonth+1,a])},_getNumberOfMonths:function(a){a=this._get(a,"numberOfMonths");return null==a?
[1,1]:"number"==typeof a?[1,a]:a},_getMinMaxDate:function(a,c){return this._determineDate(a,this._get(a,c+"Date"),null)},_getDaysInMonth:function(a,c){return 32-this._daylightSavingAdjust(new Date(a,c,32)).getDate()},_getFirstDayOfMonth:function(a,c){return(new Date(a,c,1)).getDay()},_canAdjustMonth:function(a,c,d,e){var f=this._getNumberOfMonths(a),d=this._daylightSavingAdjust(new Date(d,e+(0>c?c:f[0]*f[1]),1));0>c&&d.setDate(this._getDaysInMonth(d.getFullYear(),d.getMonth()));return this._isInRange(a,
d)},_isInRange:function(a,c){var d=this._getMinMaxDate(a,"min"),e=this._getMinMaxDate(a,"max");return(!d||c.getTime()>=d.getTime())&&(!e||c.getTime()<=e.getTime())},_getFormatConfig:function(a){var c=this._get(a,"shortYearCutoff"),c="string"!=typeof c?c:(new Date).getFullYear()%100+parseInt(c,10);return{shortYearCutoff:c,dayNamesShort:this._get(a,"dayNamesShort"),dayNames:this._get(a,"dayNames"),monthNamesShort:this._get(a,"monthNamesShort"),monthNames:this._get(a,"monthNames")}},_formatDate:function(a,
c,d,e){c||(a.currentDay=a.selectedDay,a.currentMonth=a.selectedMonth,a.currentYear=a.selectedYear);c=c?"object"==typeof c?c:this._daylightSavingAdjust(new Date(e,d,c)):this._daylightSavingAdjust(new Date(a.currentYear,a.currentMonth,a.currentDay));return this.formatDate(this._get(a,"dateFormat"),c,this._getFormatConfig(a))}});a.fn.datepicker=function(b){if(!this.length)return this;a.datepicker.initialized||(a(document).mousedown(a.datepicker._checkExternalClick).find("body").append(a.datepicker.dpDiv),
a.datepicker.initialized=!0);var c=Array.prototype.slice.call(arguments,1);return"string"==typeof b&&("isDisabled"==b||"getDate"==b||"widget"==b)||"option"==b&&2==arguments.length&&"string"==typeof arguments[1]?a.datepicker["_"+b+"Datepicker"].apply(a.datepicker,[this[0]].concat(c)):this.each(function(){typeof b=="string"?a.datepicker["_"+b+"Datepicker"].apply(a.datepicker,[this].concat(c)):a.datepicker._attachDatepicker(this,b)})};a.datepicker=new d;a.datepicker.initialized=!1;a.datepicker.uuid=
(new Date).getTime();a.datepicker.version="1.8.20";m["DP_jQuery_"+h]=a})(w);(function(a,c){var d={buttons:!0,height:!0,maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0,width:!0},f={maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0},e=a.attrFn||{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0,click:!0};a.widget("ui.dialog",{options:{autoOpen:!0,buttons:{},closeOnEscape:!0,closeText:"close",dialogClass:"",draggable:!0,hide:null,height:"auto",maxHeight:!1,maxWidth:!1,minHeight:150,
minWidth:150,modal:!1,position:{my:"center",at:"center",collision:"fit",using:function(c){var d=a(this).css(c).offset().top;0>d&&a(this).css("top",c.top-d)}},resizable:!0,show:null,stack:!0,title:"",width:300,zIndex:1E3},_create:function(){this.originalTitle=this.element.attr("title");"string"!==typeof this.originalTitle&&(this.originalTitle="");this.options.title=this.options.title||this.originalTitle;var c=this,d=c.options,b=d.title||"&#160;",e=a.ui.dialog.getTitleId(c.element),f=(c.uiDialog=a("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+
d.dialogClass).css({zIndex:d.zIndex}).attr("tabIndex",-1).css("outline",0).keydown(function(b){if(d.closeOnEscape&&!b.isDefaultPrevented()&&b.keyCode&&b.keyCode===a.ui.keyCode.ESCAPE){c.close(b);b.preventDefault()}}).attr({role:"dialog","aria-labelledby":e}).mousedown(function(a){c.moveToTop(false,a)});c.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(f);var o=(c.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(f),
n=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role","button").hover(function(){n.addClass("ui-state-hover")},function(){n.removeClass("ui-state-hover")}).focus(function(){n.addClass("ui-state-focus")}).blur(function(){n.removeClass("ui-state-focus")}).click(function(a){c.close(a);return false}).appendTo(o);(c.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(n);a("<span></span>").addClass("ui-dialog-title").attr("id",
e).html(b).prependTo(o);a.isFunction(d.beforeclose)&&!a.isFunction(d.beforeClose)&&(d.beforeClose=d.beforeclose);o.find("*").add(o).disableSelection();d.draggable&&a.fn.draggable&&c._makeDraggable();d.resizable&&a.fn.resizable&&c._makeResizable();c._createButtons(d.buttons);c._isOpen=!1;a.fn.bgiframe&&f.bgiframe()},_init:function(){this.options.autoOpen&&this.open()},destroy:function(){this.overlay&&this.overlay.destroy();this.uiDialog.hide();this.element.unbind(".dialog").removeData("dialog").removeClass("ui-dialog-content ui-widget-content").hide().appendTo("body");
this.uiDialog.remove();this.originalTitle&&this.element.attr("title",this.originalTitle);return this},widget:function(){return this.uiDialog},close:function(c){var d=this,b,e;if(!1!==d._trigger("beforeClose",c))return d.overlay&&d.overlay.destroy(),d.uiDialog.unbind("keypress.ui-dialog"),d._isOpen=!1,d.options.hide?d.uiDialog.hide(d.options.hide,function(){d._trigger("close",c)}):(d.uiDialog.hide(),d._trigger("close",c)),a.ui.dialog.overlay.resize(),d.options.modal&&(b=0,a(".ui-dialog").each(function(){if(this!==
d.uiDialog[0]){e=a(this).css("z-index");isNaN(e)||(b=Math.max(b,e))}}),a.ui.dialog.maxZ=b),d},isOpen:function(){return this._isOpen},moveToTop:function(c,d){var b=this.options;if(b.modal&&!c||!b.stack&&!b.modal)return this._trigger("focus",d);b.zIndex>a.ui.dialog.maxZ&&(a.ui.dialog.maxZ=b.zIndex);this.overlay&&(a.ui.dialog.maxZ+=1,this.overlay.$el.css("z-index",a.ui.dialog.overlay.maxZ=a.ui.dialog.maxZ));b={scrollTop:this.element.scrollTop(),scrollLeft:this.element.scrollLeft()};a.ui.dialog.maxZ+=
...
!1;if(b.target===d[0]&&b.shiftKey)return c.focus(1),!1}});a(this.element.find(":tabbable").get().concat(d.find(".ui-dialog-buttonpane :tabbable").get().concat(d.get()))).eq(0).focus();this._isOpen=!0;this._trigger("open");return this}},_createButtons:function(c){var d=this,b=!1,f=a("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),l=a("<div></div>").addClass("ui-dialog-buttonset").appendTo(f);d.uiDialog.find(".ui-dialog-buttonpane").remove();"object"===typeof c&&
null!==c&&a.each(c,function(){return!(b=!0)});b&&(a.each(c,function(b,c){var c=a.isFunction(c)?{click:c,text:b}:c,f=a('<button type="button"></button>').click(function(){c.click.apply(d.element[0],arguments)}).appendTo(l);a.each(c,function(a,b){if("click"!==a)if(a in e)f[a](b);else f.attr(a,b)});a.fn.button&&f.button()}),f.appendTo(d.uiDialog))},_makeDraggable:function(){function c(a){return{position:a.position,offset:a.offset}}var d=this,b=d.options,e=a(document),f;d.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",
handle:".ui-dialog-titlebar",containment:"document",start:function(e,k){f="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(k))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(o,n){b.position=[n.position.left-e.scrollLeft(),n.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(f);d._trigger("dragStop",o,c(n));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
originalSize:a.originalSize,position:a.position,size:a.size}}var d=d===c?this.options.resizable:d,b=this,f=b.options,l=b.uiDialog.css("position"),d="string"===typeof d?d:"n,e,s,w,se,sw,ne,nw";b.uiDialog.resizable({cancel:".ui-dialog-content",containment:"document",alsoResize:b.element,maxWidth:f.maxWidth,maxHeight:f.maxHeight,minWidth:f.minWidth,minHeight:b._minHeight(),handles:d,start:function(c,d){a(this).addClass("ui-dialog-resizing");b._trigger("resizeStart",c,e(d))},resize:function(a,c){b._trigger("resize",
a,e(c))},stop:function(c,d){a(this).removeClass("ui-dialog-resizing");f.height=a(this).height();f.width=a(this).width();b._trigger("resizeStop",c,e(d));a.ui.dialog.overlay.resize()}}).css("position",l).find(".ui-resizable-se").addClass("ui-icon ui-icon-grip-diagonal-se")},_minHeight:function(){var a=this.options;return"auto"===a.height?a.minHeight:Math.min(a.minHeight,a.height)},_position:function(c){var d=[],b=[0,0],e;if(c){if("string"===typeof c||"object"===typeof c&&"0"in c)d=c.split?c.split(" "):
[c[0],c[1]],1===d.length&&(d[1]=d[0]),a.each(["left","top"],function(a,c){+d[a]===d[a]&&(b[a]=d[a],d[a]=c)}),c={my:d.join(" "),at:d.join(" "),offset:b.join(" ")};c=a.extend({},a.ui.dialog.prototype.options.position,c)}else c=a.ui.dialog.prototype.options.position;(e=this.uiDialog.is(":visible"))||this.uiDialog.show();this.uiDialog.css({top:0,left:0}).position(a.extend({of:m},c));e||this.uiDialog.hide()},_setOptions:function(c){var e=this,b={},k=!1;a.each(c,function(a,c){e._setOption(a,c);a in d&&
(k=!0);a in f&&(b[a]=c)});k&&this._size();this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option",b)},_setOption:function(c,d){var b=this.uiDialog;switch(c){case "beforeclose":c="beforeClose";break;case "buttons":this._createButtons(d);break;case "closeText":this.uiDialogTitlebarCloseText.text(""+d);break;case "dialogClass":b.removeClass(this.options.dialogClass).addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+d);break;case "disabled":d?b.addClass("ui-dialog-disabled"):
b.removeClass("ui-dialog-disabled");break;case "draggable":var e=b.is(":data(draggable)");e&&!d&&b.draggable("destroy");!e&&d&&this._makeDraggable();break;case "position":this._position(d);break;case "resizable":(e=b.is(":data(resizable)"))&&!d&&b.resizable("destroy");e&&"string"===typeof d&&b.resizable("option","handles",d);!e&&!1!==d&&this._makeResizable(d);break;case "title":a(".ui-dialog-title",this.uiDialogTitlebar).html(""+(d||"&#160;"))}a.Widget.prototype._setOption.apply(this,arguments)},
_size:function(){var c=this.options,d,b,e=this.uiDialog.is(":visible");this.element.show().css({width:"auto",minHeight:0,height:0});c.minWidth>c.width&&(c.width=c.minWidth);d=this.uiDialog.css({height:"auto",width:c.width}).height();b=Math.max(0,c.minHeight-d);"auto"===c.height?a.support.minHeight?this.element.css({minHeight:b,height:"auto"}):(this.uiDialog.show(),c=this.element.css("height","auto").height(),e||this.uiDialog.hide(),this.element.height(Math.max(c,b))):this.element.height(Math.max(c.height-
d,0));this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option","minHeight",this._minHeight())}});a.extend(a.ui.dialog,{version:"1.8.20",uuid:0,maxZ:0,getTitleId:function(a){a=a.attr("id");a||(a=this.uuid+=1);return"ui-dialog-title-"+a},overlay:function(c){this.$el=a.ui.dialog.overlay.create(c)}});a.extend(a.ui.dialog.overlay,{instances:[],oldInstances:[],maxZ:0,events:a.map("focus,mousedown,mouseup,keydown,keypress,click".split(","),function(a){return a+".dialog-overlay"}).join(" "),
create:function(c){0===this.instances.length&&(setTimeout(function(){a.ui.dialog.overlay.instances.length&&a(document).bind(a.ui.dialog.overlay.events,function(b){if(a(b.target).zIndex()<a.ui.dialog.overlay.maxZ)return!1})},1),a(document).bind("keydown.dialog-overlay",function(b){c.options.closeOnEscape&&!b.isDefaultPrevented()&&b.keyCode&&b.keyCode===a.ui.keyCode.ESCAPE&&(c.close(b),b.preventDefault())}),a(m).bind("resize.dialog-overlay",a.ui.dialog.overlay.resize));var d=(this.oldInstances.pop()||
a("<div></div>").addClass("ui-widget-overlay")).appendTo(document.body).css({width:this.width(),height:this.height()});a.fn.bgiframe&&d.bgiframe();this.instances.push(d);return d},destroy:function(c){var d=a.inArray(c,this.instances);-1!=d&&this.oldInstances.push(this.instances.splice(d,1)[0]);0===this.instances.length&&a([document,m]).unbind(".dialog-overlay");c.remove();var b=0;a.each(this.instances,function(){b=Math.max(b,this.css("z-index"))});this.maxZ=b},height:function(){var c,d;return a.browser.msie&&
7>a.browser.version?(c=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight),d=Math.max(document.documentElement.offsetHeight,document.body.offsetHeight),c<d?a(m).height()+"px":c+"px"):a(document).height()+"px"},width:function(){var c,d;return a.browser.msie?(c=Math.max(document.documentElement.scrollWidth,document.body.scrollWidth),d=Math.max(document.documentElement.offsetWidth,document.body.offsetWidth),c<d?a(m).width()+"px":c+"px"):a(document).width()+"px"},resize:function(){var c=
a([]);a.each(a.ui.dialog.overlay.instances,function(){c=c.add(this)});c.css({width:0,height:0}).css({width:a.ui.dialog.overlay.width(),height:a.ui.dialog.overlay.height()})}});a.extend(a.ui.dialog.overlay.prototype,{destroy:function(){a.ui.dialog.overlay.destroy(this.$el)}})})(w);(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,f,e=a.fn.position,h=a.fn.offset;a.fn.position=function(g){if(!g||!g.of)return e.apply(this,arguments);var g=a.extend({},g),b=a(g.of),h=b[0],l=(g.collision||
"flip").split(" "),o=g.offset?g.offset.split(" "):[0,0],n,m,r;9===h.nodeType?(n=b.width(),m=b.height(),r={top:0,left:0}):h.setTimeout?(n=b.width(),m=b.height(),r={top:b.scrollTop(),left:b.scrollLeft()}):h.preventDefault?(g.at="left top",n=m=0,r={top:g.of.pageY,left:g.of.pageX}):(n=b.outerWidth(),m=b.outerHeight(),r=b.offset());a.each(["my","at"],function(){var a=(g[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=
c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";g[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===g.at[0]?r.left+=n:"center"===g.at[0]&&(r.left+=n/2);"bottom"===g.at[1]?r.top+=m:"center"===g.at[1]&&(r.top+=m/2);r.left+=o[0];r.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),e=parseInt(a.curCSS(this,"marginLeft",true))||0,h=parseInt(a.curCSS(this,"marginTop",true))||0,k=c+e+
(parseInt(a.curCSS(this,"marginRight",true))||0),w=d+h+(parseInt(a.curCSS(this,"marginBottom",true))||0),y=a.extend({},r),F;if(g.my[0]==="right")y.left=y.left-c;else if(g.my[0]==="center")y.left=y.left-c/2;if(g.my[1]==="bottom")y.top=y.top-d;else if(g.my[1]==="center")y.top=y.top-d/2;if(!f){y.left=Math.round(y.left);y.top=Math.round(y.top)}F={left:y.left-e,top:y.top-h};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](y,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,
collisionPosition:F,collisionWidth:k,collisionHeight:w,offset:o,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(y,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(m),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();c.left=0<d?c.left-d:Math.max(c.left-b.collisionPosition.left,c.left)},top:function(c,b){var d=a(m),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop();c.top=0<d?c.top-d:Math.max(c.top-b.collisionPosition.top,c.top)}},
flip:{left:function(c,b){if("center"!==b.at[0]){var d=a(m),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft(),e="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,f="left"===b.at[0]?b.targetWidth:-b.targetWidth,h=-2*b.offset[0];c.left+=0>b.collisionPosition.left?e+f+h:0<d?e+f+h:0}},top:function(c,b){if("center"!==b.at[1]){var d=a(m),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop(),e="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,f=
"top"===b.at[1]?b.targetHeight:-b.targetHeight,h=-2*b.offset[1];c.top+=0>b.collisionPosition.top?e+f+h:0<d?e+f+h:0}}}};a.offset.setOffset||(a.offset.setOffset=function(c,b){/static/.test(a.curCSS(c,"position"))&&(c.style.position="relative");var d=a(c),e=d.offset(),f=parseInt(a.curCSS(c,"top",!0),10)||0,h=parseInt(a.curCSS(c,"left",!0),10)||0,e={top:b.top-e.top+f,left:b.left-e.left+h};"using"in b?b.using.call(c,e):d.css(e)},a.fn.offset=function(c){var b=this[0];return!b||!b.ownerDocument?null:c?this.each(function(){a.offset.setOffset(this,
c)}):h.call(this)});(function(){var c=document.getElementsByTagName("body")[0],b=document.createElement("div"),d,e;d=document.createElement(c?"div":"body");e={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};c&&a.extend(e,{position:"absolute",left:"-1000px",top:"-1000px"});for(var h in e)d.style[h]=e[h];d.appendChild(b);e=c||document.documentElement;e.insertBefore(d,e.firstChild);b.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";
b=a(b).offset(function(a,b){return b}).offset();d.innerHTML="";e.removeChild(d);c=b.top+b.left+(c?2E3:0);f=c>21&&c<22})()})(w);(function(a,c){a.widget("ui.progressbar",{options:{value:0,max:100},min:0,_create:function(){this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min,"aria-valuemax":this.options.max,"aria-valuenow":this._value()});this.valueDiv=a("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element);
this.oldValue=this._value();this._refreshValue()},destroy:function(){this.element.removeClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow");this.valueDiv.remove();a.Widget.prototype.destroy.apply(this,arguments)},value:function(a){if(a===c)return this._value();this._setOption("value",a);return this},_setOption:function(c,f){"value"===c&&(this.options.value=f,this._refreshValue(),this._value()===
this.options.max&&this._trigger("complete"));a.Widget.prototype._setOption.apply(this,arguments)},_value:function(){var a=this.options.value;"number"!==typeof a&&(a=0);return Math.min(this.options.max,Math.max(this.min,a))},_percentage:function(){return 100*this._value()/this.options.max},_refreshValue:function(){var a=this.value(),c=this._percentage();this.oldValue!==a&&(this.oldValue=a,this._trigger("change"));this.valueDiv.toggle(a>this.min).toggleClass("ui-corner-right",a===this.options.max).width(c.toFixed(0)+
"%");this.element.attr("aria-valuenow",a)}});a.extend(a.ui.progressbar,{version:"1.8.20"})})(w);(function(a){a.widget("ui.slider",a.ui.mouse,{widgetEventPrefix:"slide",options:{animate:!1,distance:0,max:100,min:0,orientation:"horizontal",range:!1,step:1,value:0,values:null},_create:function(){var c=this,d=this.options,f=this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),e=d.values&&d.values.length||1,h=[];this._mouseSliding=this._keySliding=!1;this._animateOff=!0;this._handleIndex=
null;this._detectOrientation();this._mouseInit();this.element.addClass("ui-slider ui-slider-"+this.orientation+" ui-widget ui-widget-content ui-corner-all"+(d.disabled?" ui-slider-disabled ui-disabled":""));this.range=a([]);if(d.range){if(!0===d.range&&(d.values||(d.values=[this._valueMin(),this._valueMin()]),d.values.length&&2!==d.values.length))d.values=[d.values[0],d.values[0]];this.range=a("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header"+("min"===d.range||"max"===
d.range?" ui-slider-range-"+d.range:""))}for(var g=f.length;g<e;g+=1)h.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");this.handles=f.add(a(h.join("")).appendTo(c.element));this.handle=this.handles.eq(0);this.handles.add(this.range).filter("a").click(function(a){a.preventDefault()}).hover(function(){d.disabled||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).focus(function(){d.disabled?a(this).blur():(a(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),
a(this).addClass("ui-state-focus"))}).blur(function(){a(this).removeClass("ui-state-focus")});this.handles.each(function(b){a(this).data("index.ui-slider-handle",b)});this.handles.keydown(function(b){var d=a(this).data("index.ui-slider-handle"),e,f,g;if(!c.options.disabled){switch(b.keyCode){case a.ui.keyCode.HOME:case a.ui.keyCode.END:case a.ui.keyCode.PAGE_UP:case a.ui.keyCode.PAGE_DOWN:case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(b.preventDefault(),
!c._keySliding&&(c._keySliding=!0,a(this).addClass("ui-state-active"),e=c._start(b,d),!1===e))return}g=c.options.step;e=c.options.values&&c.options.values.length?f=c.values(d):f=c.value();switch(b.keyCode){case a.ui.keyCode.HOME:f=c._valueMin();break;case a.ui.keyCode.END:f=c._valueMax();break;case a.ui.keyCode.PAGE_UP:f=c._trimAlignValue(e+(c._valueMax()-c._valueMin())/5);break;case a.ui.keyCode.PAGE_DOWN:f=c._trimAlignValue(e-(c._valueMax()-c._valueMin())/5);break;case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:if(e===
c._valueMax())return;f=c._trimAlignValue(e+g);break;case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(e===c._valueMin())return;f=c._trimAlignValue(e-g)}c._slide(b,d,f)}}).keyup(function(b){var d=a(this).data("index.ui-slider-handle");c._keySliding&&(c._keySliding=!1,c._stop(b,d),c._change(b,d),a(this).removeClass("ui-state-active"))});this._refreshValue();this._animateOff=!1},destroy:function(){this.handles.remove();this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-slider-disabled ui-widget ui-widget-content ui-corner-all").removeData("slider").unbind(".slider");
this._mouseDestroy();return this},_mouseCapture:function(c){var d=this.options,f,e,h,g,b;if(d.disabled)return!1;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();f=this._normValueFromMouse({x:c.pageX,y:c.pageY});e=this._valueMax()-this._valueMin()+1;g=this;this.handles.each(function(c){var d=Math.abs(f-g.values(c));e>d&&(e=d,h=a(this),b=c)});!0===d.range&&this.values(1)===d.min&&(b+=1,h=a(this.handles[b]));if(!1===this._start(c,
b))return!1;this._mouseSliding=!0;g._handleIndex=b;h.addClass("ui-state-active").focus();d=h.offset();this._clickOffset=!a(c.target).parents().andSelf().is(".ui-slider-handle")?{left:0,top:0}:{left:c.pageX-d.left-h.width()/2,top:c.pageY-d.top-h.height()/2-(parseInt(h.css("borderTopWidth"),10)||0)-(parseInt(h.css("borderBottomWidth"),10)||0)+(parseInt(h.css("marginTop"),10)||0)};this.handles.hasClass("ui-state-hover")||this._slide(c,b,f);return this._animateOff=!0},_mouseStart:function(){return!0},
...
a.extend({},a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var d in this.options.bind)this.bind(d,this.options.bind[d]);this.history=[];this.present=0;this.historyEnabled=!0;b(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.options.replace&&(this.replaceOriginal(),
this.options.replace=!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){F(a.target)},this));
this.getElement().bind("mouseup."+this.widgetName,b);this.getElement().bind("keyup."+this.widgetName,b);a(c).bind("beforeunload",a.proxy(a.ui.editor.unloadWarning,a.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct();this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},
replaceOriginal:function(){if(!this.target){for(var b=a("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",this.getUniqueId()).addClass(this.element.attr("class")),c=this.options.domTools.getStyles(this.element),d=0;d<this.options.replaceStyle.length;d++)b.css(this.options.replaceStyle[d],c[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):
this.element.html(this.getHtml())});this.target=b}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());var b=this.getHtml(),c=this.options.domTools[a].apply(this.options.domTools,arguments);b!==this.getHtml()&&this.change();return c}}(a))},checkChange:function(){var a=d.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),
b=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),b!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},destruct:function(){this.hideToolbar();this.disableEditing();this.fire("destroy",!1);this.events={};this.getElement().unbind("."+this.widgetName);this.wrapper&&this.wrapper.remove()},destroy:function(){this.destruct();a.Widget.prototype.destroy.call(this)},persist:function(b,c){return!this.options.persistence?
null:a.ui.editor.persist(b,c,this.options.namespace)},enableEditing:function(){this.isToolbarLoaded()||this.loadToolbar();this.enabled||(this.enabled=!0,this.getElement().addClass(this.options.baseClass+"-editing"),this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},
disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;C(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();
f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(F(d[c[0]][c[1]]),b.updateTagTree()):F(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=
a.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==this&&d[e].options.unify&&b(d[e])},getUniqueId:function(){return a.ui.editor.getUniqueId()},loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(b,d,e){var e=a.extend({},this.options.message,e),f;f={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=c.setTimeout(function(){this.timer=null;f.hide()},e.delay,this)},hide:function(){this.timer&&(c.clearTimeout(this.timer),
this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(e.hide)&&e.hide.call(this);this.element.remove()},this))}};f.element=a(this.getTemplate("message",{type:b,message:d})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){f.hide()}).end();f.show();return f},showLoading:function(a,b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",a,b)},showError:function(a,b){return this.showMessage("circle-close",a,
b)},showConfirm:function(a,b){return this.showMessage("circle-check",a,b)},showWarning:function(a,b){return this.showMessage("alert",a,b)},loadToolbar:function(){var b=this.toolbar=a("<div/>").addClass(this.options.baseClass+"-toolbar"),b=this.toolbarWrapper=a("<div/>").addClass(this.options.baseClass+"-toolbar-wrapper").addClass("ui-widget-content").append(b),d=this.path=a("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),e=this.wrapper=
a("<div/>").addClass(this.options.baseClass+"-wrapper").css("display","none").append(d).append(b);a.fn.draggable&&this.options.draggable&&(e.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:a.proxy(function(){var a=this.persist("position",[e.css("top"),e.css("left")]);e.css({top:Math.abs(a[0]),left:Math.abs(a[1])})},this)}),e.css("position",""),(b=this.persist("position")||this.options.dialogPosition)||(b=[10,10]),parseInt(b[0],10)+e.outerHeight()>a(c).height()&&(b[0]=a(c).height()-
e.outerHeight()),parseInt(b[1],10)+e.outerWidth()>a(c).width()&&(b[1]=a(c).width()-e.outerWidth()),e.css({top:Math.abs(parseInt(b[0],10)),left:Math.abs(parseInt(b[1],10))}),this.loadMessages());a(function(){e.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return null!==this.wrapper},showToolbar:function(b){this.isToolbarLoaded()||this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(!0);this.visible=!0;this.wrapper.css("display","");this.fire("resize");"undefined"===
typeof this.getElement().attr("tabindex")&&this.getElement().attr("tabindex",-1);if(b)if(b.select)b.select();else{var d=c.getSelection();d.removeAllRanges();d.addRange(b)}var e=this;a(function(){e.fire("show");e.getElement().focus()})}},hideToolbar:function(){this.visible&&(this.visible=!1,this.wrapper.hide(),this.fire("hide"),this.fire("resize"))},hideOtherToolbars:function(a){this.unify(function(b){b.hideToolbar(a)},!1)},isVisible:function(){return this.visible},getTemplate:function(b,c){var d;
d=this.templates[b]?this.templates[b]:a.ui.editor.getTemplate(b,this.options.urlPrefix);d=d.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return g(b)});c=a.extend({},this.options,c||{});c=this.getTemplateVars(c);return d=d.replace(/\{\{(.*?)\}\}/g,function(a,b){return c[b]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var d={},e;for(e in a)if("object"===typeof a[e]&&
5>c){var f=this.getTemplateVars(a[e],b+e,++c),g;for(g in f)d[g]=f[g]}else d[b+e]=a[e];return d},historyPush:function(){this.historyEnabled&&this.getHtml()!==this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),
this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},historyForward:function(){this.present<this.history.length-1&&(this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},registerHotkey:function(b,c,d){if("string"===typeof b)this.hotkeys[b]=a.extend({},{context:d,restoreSelection:!0},c);else for(var e in b)this.registerHotkey(e,b[e],d)},bindHotkeys:function(){for(var a in this.hotkeys){var b=this,c=this.hotkeys[a].force||!1;(this.options.enableHotkeys||
c)&&this.getElement().bind("keydown."+this.widgetName,a,function(a){q();var c=b.hotkeys[a.data];!0!==c.action.call(c.context)&&a.preventDefault();c.restoreSelection&&B();b.checkChange()})}},uiEnabled:function(b){return!1===this.options.enableUi&&"undefined"===typeof this.options.ui[b]||!1===this.options.ui[b]||-1!==a.inArray(b,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var b=0,c=this.options.uiOrder.length;b<c;b++){for(var d=this.options.uiOrder[b],
e=a("<div/>"),f=0,g=d.length;f<g;f++)if(this.uiEnabled(d[f])){var h=d[f].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(a.ui.editor.ui[d[f]]){var i=a.extend({},a.ui.editor.ui[d[f]]),h=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+h},i.options,this.options.ui[d[f]]);i.editor=this;i.options=h;i.ui=i.init(this,h);i.hotkeys&&(this.registerHotkey(i.hotkeys,null,i),i.ui.title+=" ("+a.map(i.hotkeys,function(a,b){return b})[0]+")");i.ui.init(d[f],this,h,i).appendTo(e);
this.uiObjects[d[f]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}a("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(b){return a.extend({button:null,options:{},init:function(b,c,d,e){var f=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=a.extend({},c.options,{baseClass:c.options.baseClass+"-"+f+"-button"},this.options,c.options.ui[b]);this.title||(this.title=g("Unnamed Button"));this.button=
a("<div/>").html(this.label||this.title).addClass(d.baseClass).attr("name",b).attr("title",this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var j=this;this.button.bind("mouseup."+e.editor.widgetName,function(a){a.preventDefault();j.click.apply(e,arguments)});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+f},disabled:d.disabled?
!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(e);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},b)},uiSelectMenu:function(b){return a.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(b,c){var d=this,e=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});a.extend({},c.options,{baseClass:c.options.baseClass+
e+"-select-menu"},d.options,c.options.ui[b]);d.title||(d.title=g("Unnamed Select Menu"));d.wrapper=a('<div class="ui-editor-selectmenu-wrapper"/>').append(d.select.hide()).addClass(d.select.attr("class"));d.selectMenu=a('<div class="ui-editor-selectmenu"/>').appendTo(d.wrapper);d.menu=a('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(d.wrapper);d.select.find("option, .ui-editor-selectmenu-option").each(function(){a("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(a(this).html()).appendTo(d.menu).bind("mouseenter."+
c.widgetName,function(){a(this).addClass("ui-state-focus")}).bind("mouseleave."+c.widgetName,function(){a(this).removeClass("ui-state-focus")}).bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){var b=d.select.find("option, .ui-editor-selectmenu-option").eq(a(this).index()),b=b.attr("value")||b.val();d.select.val(b);d.update();d.wrapper.removeClass("ui-editor-selectmenu-visible");d.button.addClass("ui-corner-all").removeClass("ui-corner-top");d.change(b);
return false})});var e=a("<div/>").addClass("ui-editor-selectmenu-text"),f=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");d.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",d.title).append(e).append(f).prependTo(d.selectMenu);d.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(d.menu.css("min-width"),10)<d.button.outerWidth()+
10&&d.menu.css("min-width",d.button.outerWidth()+10);d.wrapper.toggleClass("ui-editor-selectmenu-visible");return false}}).bind("mouseenter."+c.widgetName,function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover",a(this).hasClass("ui-state-disabled"))}).bind("mouseleave."+c.widgetName,function(){a(this).removeClass("ui-state-hover")});e=d.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html()||d.select.find("option, .ui-editor-selectmenu-option").first().html();
d.button.find(".ui-editor-selectmenu-text").html(e);return d.wrapper},update:function(){var a=this.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html();this.button.find(".ui-editor-selectmenu-text").html(a)},val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},b)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){this.options.plugins||(this.options.plugins={});
for(var b in a.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[b]||!1===this.options.plugins[b])&&-1===a.inArray(b,this.options.disabledPlugins)){var c=a.extend({},a.ui.editor.plugins[b]),d=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+d},c.options,this.options.plugins[b]);c.editor=this;c.options=d;c.init(this,d);c.hotkeys&&this.registerHotkey(c.hotkeys,null,c);this.plugins[b]=
c}},isDirty:function(){return this.dirty},getHtml:function(){var b=this.getElement().html(),b=a("<div/>").html(b);b.find(".rangySelectionBoundary").remove();return b=b.html()},getCleanHtml:function(){this.fire("clean");var b=this.getElement().html();this.fire("restore");b=a("<div/>").html(b);b.find(".rangySelectionBoundary").remove();return b=b.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml());this.fire("cleaned")},
getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(b,c,d){var e=this.events;a.each(b.split(","),function(b,f){f=a.trim(f);e[f]||(e[f]=[]);e[f].push({context:d,callback:c})})},unbind:function(a,b,c){for(var d=0,e=this.events[a].length;d<e;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===
c&&this.events[a].splice(d,1)},fire:function(b,c,d){d||this.fire("before:"+b,c,!0);if(this.events[b])for(var e=0,f=this.events[b].length;e<f;e++){var g=this.events[b][e];"undefined"!==typeof g.callback&&g.callback.call(g.context||this)}!1!==c&&a.ui.editor.fire(b);d||this.fire("after:"+b,c,!0)}});a.extend(a.ui.editor,{elementRemoveComments:function(b){b.contents().each(function(){8==this.nodeType&&a(this).remove()});b.children().each(function(){element.removeComments(a(this))});return b},elementRemoveAttributes:function(b,
c){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,c))return b.name}),d=a(this);a.each(b,function(a,b){d.removeAttr(b)});element.removeAttributes(a(this),c)});return b},elementBringToTop:k,elementOuterHtml:l,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===m(a.tagName)},elementDefaultDisplay:m,elementIsValid:n,fragmentToHtml:p,fragmentInsertBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<
f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:s,rangeIsEmpty:x,selectionSave:q,selectionRestore:B,selectionDestroy:A,selectionEachRange:C,selectionReplace:E,selectionSelectInner:y,selectionSelectOuter:F,selectionSelectEdge:D,selectionSelectEnd:Q,selectionSelectStart:J,selectionGetHtml:v,selectionGetElements:M,
selectionToggleWrapper:H,selectionExists:function(a){var b=!1;C(function(a){x(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:R,selectionReplaceWithinValidTags:P,stringStripTags:I,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},
unwrapParentTag:function(b){M().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){C(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){C(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){C(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){C(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===
c?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(b,c){C(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)},wrapInner:function(b,c){q();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());b.html(d)});B()},inverseWrapWithTagClass:function(b,c,e,f){q();var g="domTools"+
Math.ceil(1E7*Math.random());C(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});B()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):a(b).css(c,d)})},getStyles:function(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=
a.getPropertyValue(a.item(d));return b},swapStyles:function(a,b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,disabledUi:[],message:{delay:5E3},replace:!1,replaceStyle:"display,position,float,width,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-right,margin-top,margin-bottom".split(","),baseClass:"ui-editor",
...
messages:'<div class="{{baseClass}}-messages" />\n'},getTemplate:function(b,c){var d;if(this.templates[b])d=this.templates[b];else{var e=c||this.urlPrefix,f=b.split("."),e=1===f.length?e+("templates/"+f[0]+".html"):e+("plugins/"+f[0]+"/templates/"+f.splice(1).join("/")+".html");a.ajax({url:e,type:"GET",async:!1,timeout:15E3,error:function(){d=null},success:function(a){d=a}});this.templates[b]=d}return d},getUniqueId:function(){for(var b=a.ui.editor.defaults.baseClass+"-uid-"+(new Date).getTime()+
"-"+Math.floor(1E5*Math.random());a("#"+b).length;)b=a.ui.editor.defaults.baseClass+"-uid-"+(new Date).getTime()+"-"+Math.floor(1E5*Math.random());return b},isDirty:function(){for(var a=this.getInstances(),b=0;b<a.length;b++)if(a[b].isDirty())return!0;return!1},unloadWarning:function(){for(var a=this.getInstances(),b=0;b<a.length;b++)if(a[b].isDirty()&&a[b].isEditing()&&a[b].options.unloadWarning)return g("\nThere are unsaved changes on this page. \nIf you navigate away from this page you will lose your unsaved changes")},
defaultUi:{ui:null,editor:null,options:null,init:function(){},persist:function(a,b){return this.editor.persist(a,b)},bind:function(a,b,c){this.editor.bind(a,b,c||this)},unbind:function(a,b,c){this.editor.unbind(a,b,c||this)}},registerUi:function(b,c){if("string"===typeof b)this.ui[b]=a.extend({},this.defaultUi,c);else for(var d in b)this.registerUi(d,b[d])},defaultPlugin:{editor:null,options:null,init:function(){},persist:function(a,b){return this.editor.persist(a,b)},bind:function(a,b,c){this.editor.bind(a,
b,c||this)},unbind:function(a,b,c){this.editor.unbind(a,b,c||this)}},registerPlugin:function(b,c){if("string"===typeof b)this.plugins[b]=a.extend({},this.defaultPlugin,c);else for(var d in b)this.registerPlugin(d,b[d])},bind:function(a,b){this.events[a]||(this.events[a]=[]);this.events[a].push(b)},unbind:function(b){a.each(this.events,function(a){for(var c=0;c<this.length;c++)this[c]===b&&this.events[a].splice(c,1)})},fire:function(a){if(this.events[a])for(var b=0,c=this.events[a].length;b<c;b++)this.events[a][b].call(this)},
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===f)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var W,X;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:g("Left Align"),click:function(){a.toggleBlockStyle({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:g("Justify"),click:function(){a.toggleBlockStyle({"text-align":"justify"},
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){H("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){H("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){H("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:g("Strikethrough"),click:function(){H("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:g("Sub script"),click:function(){H("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){H("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),
icon:"ui-icon-quote",click:function(){H("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{esc:{action:function(){this.confirm()}}},init:function(a){return a.uiButton({name:"cancel",title:g("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor;c.isDirty()?(this.dialog||(this.dialog=a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,
resizable:!1,title:g("Confirm Cancel Editing"),dialogClass:c.options.dialogClass+" "+c.options.baseClass,show:c.options.dialogShowAnimation,hide:c.options.dialogHideAnimation,buttons:[{text:g("OK"),click:function(){b.cancel();a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},
close:function(){a(this).dialog("destroy").remove()}})):b.cancel()}}});a.ui.editor.registerPlugin({cancel:{cancel:function(){this.editor.unify(function(a){a.fire("cancel");a.resetHtml();a.hideToolbar();a.disableEditing();A()})}}});a.ui.editor.registerPlugin("clean",{options:{stripAttrs:["_moz_dirty"],stripAttrContent:{type:"_moz"},stripEmptyTags:"span,h1,h2,h3,h4,h5,h6,p,b,i,u,strong,em,big,small,div".split(","),stripEmptyAttrs:["class","id","style"],stripDomains:[{selector:"a",attributes:["href"]},
{selector:"img",attributes:["src"]}]},init:function(a){a.bind("change",this.clean,this)},clean:function(){var b,d=this.editor;for(b=0;b<this.options.stripAttrs.length;b++)d.getElement().find("["+this.options.stripAttrs[b]+"]").removeAttr(this.options.stripAttrs[b]);for(b=0;b<this.options.stripAttrContent.length;b++)d.getElement().find("["+b+'="'+this.options.stripAttrs[b]+'"]').removeAttr(this.options.stripAttrs[b]);for(b=0;b<this.options.stripEmptyTags.length;b++)d.getElement().find(this.options.stripEmptyTags[b]).filter(function(){if(a(this).hasClass(d.options.supplementaryClass))return!1;
if(a(this).hasClass("rangySelectionBoundary")&&!1===(!1!==S)||""===a.trim(a(this).html()))return!0}).remove();for(b=0;b<this.options.stripEmptyAttrs.length;b++){var e=this.options.stripEmptyAttrs[b];d.getElement().find("["+this.options.stripEmptyAttrs[b]+"]").filter(function(){return""===a.trim(a(this).attr(e))}).removeAttr(this.options.stripEmptyAttrs[b])}var f=c.location.protocol+"//"+c.location.host,g="//"+c.location.host;for(b=0;b<this.options.stripDomains.length;b++){var h=this.options.stripDomains[b];
this.editor.getElement().find(h.selector).each(function(){for(var b=0;b<h.attributes.length;b++){var c=a(this).attr(h.attributes[b]);"undefined"!==typeof c&&(0===c.indexOf(f)?a(this).attr(h.attributes[b],c.substr(f.length)):0===c.indexOf(g)&&a(this).attr(h.attributes[b],c.substr(g.length)))}})}this.editor.getElement().find("ul, ol").each(function(){a(this).find(" > :not(li)").each(function(){m(a(this).attr("tag"))?a(this).replaceWith(a("<li>"+a(this).html()+"</li>").appendTo("body")):a(this).wrap(a("<li>"))})})}});
a.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:g("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});a.ui.editor.registerUi({clearFormatting:{init:function(b){return this.editor.uiButton({title:g("Clear Formatting"),click:function(){var c=d.getSelection();if(0<c.rangeCount){var e=c.getRangeAt(0).cloneRange(),f=e.extractContents();""==p(f)&&(b.expandToParent(e),c.setSingleRange(e),f=e.extractContents());f=a("<div/>").append(p(f)).text();
for(c=e.commonAncestorContainer;c&&c.parentNode!=b.getElement().get(0);)c=c.parentNode;if(c){e.setEndAfter(c);var g=e.extractContents();e.collapseAfter(c);e.insertNode(g);e.collapseAfter(c)}e.insertNode(document.createTextNode(f))}b.checkChange()}})}}});a.ui.editor.registerPlugin("clickButtonToEdit",{hovering:!1,buttonClass:null,buttonSelector:null,button:!1,options:{button:{text:!0,icons:{primary:"ui-icon-pencil"}}},init:function(b,d){var e=this;this.buttonClass=this.options.baseClass+"-button-element";
this.buttonSelector="."+this.buttonClass;this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){if(!b.isEditing()){b.getElement().addClass(d.baseClass+"-highlight");b.getElement().addClass(d.baseClass+"-hover");var f=e.getButton();var g=b.getElement(),g=a(g),h=Math.round(g.offset().top),i=Math.round(g.offset().left),k=Math.round(g.outerWidth()),g=Math.round(g.outerHeight()),
l=a(c).scrollTop(),m=a(c).height(),n=l+m,o=Math.round(g+h);l<h&&n>o||(l>h&&(h=l),g=n<o?n-h:m-(n-o));f.css({position:"absolute",top:h+(g/2-a(f).outerHeight()/2),left:i+k/2-a(f).outerWidth()/2})}};this.hide=function(c){var f=e.getButton();if(!c||!(c.relatedTarget===f.get(0)||f.get(0)===a(c.relatedTarget).parent().get(0)))b.getElement().removeClass(d.baseClass+"-highlight"),b.getElement().removeClass(d.baseClass+"-hover"),e.destroyButton()};this.edit=function(){e.hide();b.isEditing()||b.enableEditing();
b.isVisible()||b.showToolbar(e.selection())};this.buttonOut=function(c){c.relatedTarget===e.getButton().get(0)||c.relatedTarget===b.getElement().get(0)||a.contains(b.getElement().get(0),c.relatedTarget)||e.hide()};b.getElement().addClass("ui-editor-click-button-to-edit");b.bind("ready, hide, cancel",function(){b.getElement().bind("mouseenter."+b.widgetName,e.show);b.getElement().bind("mouseleave."+b.widgetName,e.hide)});b.bind("show",function(){e.destroyButton();b.getElement().unbind("mouseenter."+
b.widgetName,e.show);b.getElement().unbind("mouseleave."+b.widgetName,e.hide)})},getButton:function(){a(this.buttonSelector).length||(this.button=a(this.editor.getTemplate("clickbuttontoedit.edit-button",this.options)).appendTo("body").addClass(this.buttonClass),this.button.button(this.options.button));this.button=a(this.buttonSelector);this.button.unbind("click."+this.editor.widgetName).bind("click."+this.editor.widgetName,this.edit);this.button.unbind("mouseleave."+this.editor.widgetName).bind("mouseleave."+
this.editor.widgetName,this.buttonOut);return this.button},destroyButton:function(){"undefined"===typeof this.button||!1===this.button||(this.button.button("destroy").remove(),this.button=!1)}});a.ui.editor.registerUi("colorPickerBasic",{init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);var c=this;return b.uiSelectMenu({name:"colorPickerBasic",title:g("Change the color of the selected text."),select:a(b.getTemplate("color-picker-basic.menu")),change:function(b){"automatic"===
b?M().parents("."+c.options.cssPrefix+"color").andSelf().each(function(){var b=a(this),c=a(this).attr("class").match(/(cms-(.*?))( |$)/ig);a.each(c,function(c,d){d=a.trim(d);b.removeClass(d)})}):H("span",{classes:c.options.classes||c.options.cssPrefix+"color "+c.options.cssPrefix+b})}})},change:function(){this.ui.val("automatic");var b=M()[0];if(b&&(b=a(b).closest("."+this.options.cssPrefix+"color"))){var c=b.attr("class");c&&(c=b.attr("class").replace(RegExp(this.options.cssPrefix+"color","g"),""),
...
this.editor.fire("resize"))},hideSpacers:function(){this.topSpacer&&(this.topSpacer.remove(),this.topSpacer=null);this.bottomSpacer&&(this.bottomSpacer.remove(),this.bottomSpacer=null);this.editor.fire("resize")},swapStyle:function(a,b,c){var d={},e;for(e in c)a.css(e,b.css(e)),d[e]=b.css(e),b.css(e,c[e]);return d},revertStyle:function(a,b){for(var c in b)a.css(c,b[c])},dockToElement:function(){var b=a("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper");
...
init:function(a){return a.uiButton({title:a.getPlugin("dock").getTitle(),icon:a.getPlugin("dock").isDocked()?"ui-icon-pin-w":"ui-icon-pin-s",click:function(){var b=a.getPlugin("dock");b.isDocked()?b.undock():b.dock();a.unify(function(a){b.isDocked()?a.getPlugin("dock").dock():a.getPlugin("dock").undock()})}})}}});a.ui.editor.registerUi({embed:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({icon:"ui-icon-youtube",title:g("Embed object"),click:function(){this.show()}})},
hide:function(){this.dialog&&a(this.dialog).dialog("destroy").remove();this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var b=this;q();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){B();
E(a(this).find("textarea").val());a(this).dialog("close")}},{text:g("Close"),click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var c=a(this).find(".ui-editor-embed-panel-tabs");c.find("ul li").click(function(){c.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");a(this).addClass("ui-state-active").addClass("ui-tabs-selected");
c.children("div").hide().eq(a(this).index()).show()});var d=a(this).find(".ui-editor-embed-preview");a(this).find("textarea").change(function(){a(d).html(a(this).val())})},close:function(){b.hide()}})}}}});a.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var b=this;this.textNodes(this.editor.getElement()).each(function(){a(this).wrap(a(b.options.tag));Q(this)});this.editor.checkChange()},textNodes:function(b){return a(b).contents().filter(function(){return 3==
this.nodeType&&a.trim(this.nodeValue).length})}});a(function(){a.ui.editor.registerUi({insertFile:{fileManager:null,imageTypes:["jpg","jpeg","png","gif"],init:function(b,c){return b.uiButton({title:"Insert image or uploaded file",icon:"ui-icon-image",click:function(){var b=this;q();null===this.fileManager&&(this.fileManager=a.ui.filemanager.create({enablePlugins:!1,plugins:{datatables:!XMod.FileManager.Permissions.insert?!1:{ajaxSource:"/filemanager/admin/datatables",insertionCallback:function(d){B();
if(!d.length)return true;var e=function(){b.editor.fire("change");return true};if(d.length===1){var f=d[0];if(b.isImage(f)){E(b.createImage(f,c.cssPrefix+f.type));return e()}if(b.editor.selectionExists()){t("a",{href:f.url,className:b.options.cssPrefix+"file "+b.options.cssPrefix+f.type});return e()}E(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type));return e()}for(var g=[],j=0;j<d.length;j++){f=d[j];b.isImage(f)?g.push(a("<div/>").html(b.createImage(f,c.cssPrefix+f.type)).html()):
g.push(a("<div/>").html(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type)).html())}E(g.join(", "));return e()}},plupload:!XMod.FileManager.Permissions.upload?!1:{url:"/filemanager/admin/plupload"}}}));a(this.fileManager).filemanager("show")}})},isImage:function(b){return-1!==a.inArray(b.type.toLowerCase(),this.imageTypes)?!0:!1},createImage:function(b,c){return a("<img/>").attr({src:b.url,title:b.name,"class":c})},createAnchor:function(b,c){return a("<a/>").attr({href:b.url,
title:b.name,"class":c}).html(b.name)}}})});a.ui.editor.registerUi({floatLeft:{init:function(b){return b.uiButton({title:g("Float Image Left"),click:function(){C(function(b){a(b.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(b){return b.uiButton({title:g("Float Image Right"),click:function(){C(function(b){a(b.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(b){return b.uiButton({title:g("Remove Image Float"),click:function(){C(function(b){a(b.commonAncestorContainer).find("img").css("float",
...
this.cancel,this);return a.uiButton({title:g("Show Guides"),icon:"ui-icon-pencil",click:function(){a.getElement().toggleClass(b.baseClass+"-visible")}})},cancel:function(){this.editor.getElement().removeClass(this.options.baseClass+"-visible")}}});a.ui.editor.registerUi({undo:{options:{disabled:!0},hotkeys:{"ctrl+z":{action:function(){this.editor.historyBack()}}},init:function(a){a.bind("change",this.change,this);return a.uiButton({title:g("Step Back"),click:function(){a.historyBack()}})},change:function(){0===
this.editor.present?this.ui.disable():this.ui.enable()}},redo:{options:{disabled:!0},hotkeys:{"ctrl+shift+z":{action:function(){this.editor.historyForward()}},"ctrl+y":{action:function(){this.editor.historyForward()}}},init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:g("Step Forward"),click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),
click:function(){E("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&h(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in O){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(N[e]);G===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){h(c.persist("locale",a))}})}}});e("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.",
...
"{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} characters, {{charactersRemaining}} over the recommended limit","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} characters, {{charactersRemaining}} remaining","{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});e("es","Espa\u00f1ol",{"A preview of your embedded object is displayed below.":"A continuaci\u00f3n se muestra una vista previa de su objeto incrustado.",
...
"{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} car\u00e1cter(es), {{charactersRemaining}} sobre el l\u00edmite recomendado","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} car\u00e1cter(es), queda(n) {{charactersRemaining}}","{{sentences}} sentences":"{{sentences}} oraciones","{{words}} word":"{{words}} palabra","{{words}} words":"{{words}} palabras"});e("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.",
...
e=0;e<b.length;e++){var f=b[e],g=f.outerWidth();f.outerHeight();var h=Math.min(c/g),g=Math.round(Math.abs(h*(g-(f.outerWidth()-f.width()))));f.addClass(this.options.resizingClass);d=d.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));a(f).css({width:g});var i=this;this.showOversizeWarning(l(a(d)),{hide:function(){f.removeClass(i.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);
this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,b){this.editor.showInfo(g("The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.",{image:a}),b)},removeClasses:function(b){b||(b=[this.options.resizingClass,this.options.manuallyResizingClass]);a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},manuallyResizeImage:function(b){this.removeToolsButtons();var c=this.editor.getElement().find("img."+
this.options.manuallyResizingClass),d=a(c).innerWidth(),e=a(c).innerHeight(),f="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,k=function(b){b=Math.round(b||a(f).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:e,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){k(a(this).find(f).val());a(this).dialog("close")}},
{text:g("Cancel"),click:function(){k(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(f),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(e/d*a(this).val())));k()});c.keyup(function(){b.val(Math.round(Math.abs(d/e*a(this).val())));k()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=a("<button>"+g("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,
...
this.displayToolsButtonRelativeToImage(b.target)},imageMouseLeave:function(b){a(b.relatedTarget).hasClass(this.options.resizeButtonClass)||(a(b.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:g("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);
...
this.plugin.editor.showWarning(g("The url for the link you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||b.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-url",message:g("The URL does not look well formed")}))),
b.find(c).not(":visible").show(),d=!1);return d}},{type:"email",title:g("Email address"),focusSelector:'input[name="email"]',init:function(){this.content=this.plugin.editor.getTemplate("link.email",this.options);return this},show:function(a,b){var c=this;a.find('input[name="email"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="email"]').val(this.plugin.selectedElement.attr("href").replace(/(mailto:)|(\?Subject.*)/gi,"")).trigger("keyup"),/\?Subject\=/i.test(this.plugin.selectedElement.attr("href"))&&
a.find('input[name="subject"]').val(decodeURIComponent(this.plugin.selectedElement.attr("href").replace(/(.*\?Subject=)/i,""))));return this},attributes:function(a){var b={href:"mailto:"+a.find('input[name="email"]').val()};if(a=a.find('input[name="subject"]').val())b.href=b.href+"?Subject="+encodeURIComponent(a);return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-email",d=!0;this.options.regexEmail.test(b.find('input[name="email"]').val())?b.find(c).has(":visible").hide():
(b.find(c).size()||b.find('input[name="email"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-email",message:g("The email address does not look well formed")}))),b.find(c).not(":visible").show(),d=!1);return d}},{type:"fileUrl",title:g("Document or other file"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.file-url",this.options);return this},show:function(a,
b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("click"),"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(g("The url for the file you inserted doesn't look well formed"));
return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-file-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||b.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-file-url",message:g("The URL does not look well formed")}))),b.find(c).not(":visible").show(),d=!1);return d}}],init:function(b,
...
{};for(var b={type:null,title:null,content:null,plugin:this,options:this.options,attributes:function(){},init:function(){return this},show:function(){},editing:function(b){if(b.attr("class"))for(var c=this.classes.split(/\s/gi),d=0;d<c.length;d++)if(c[d].trim()&&a(b).hasClass(c[d]))return!0;return!1},focusSelector:null,focus:function(){if(this.focusSelector){var b=a(this.focusSelector),c=b.val();b.val("");b.focus().val(c)}}},c=null,c=this.options.replaceTypes?this.options.customTypes:a.merge(this.defaultLinkTypes,
this.options.customTypes),d,e=0;e<c.length;e++)d=a.extend({},b,c[e],{classes:this.options.baseClass+"-"+c[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){q();this.selectedElement=M().first();var b=this.selectedElement.is("a"),c=this.options,d=this,e=this.dialog=a(this.editor.getTemplate("link.dialog",c)).appendTo("body");this.initTypes();var f=this.dialog.find("fieldset"),h;for(h in this.types)a(this.editor.getTemplate("link.label",this.types[h])).appendTo(f);f.find('input[type="radio"]').bind("change."+
this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],b)});e.dialog({autoOpen:!1,modal:!0,resizable:!0,width:c.dialogWidth,minWidth:c.dialogMinWidth,height:c.dialogHeight,title:b?g("Edit Link"):g("Insert Link"),dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?g("Update Link"):g("Insert Link"),click:function(){B();d.apply(b)&&a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+
"-content").hide()},open:function(){d.visible=!0;var c=e.parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var f=e.find('.ui-editor-link-menu input[type="radio"]');f.first().attr("checked","checked");var g=!1;if(b)for(var h in d.types)if(g=d.types[h].editing(d.selectedElement)){f.filter('[value="'+h+'"]').attr("checked","checked");d.typeChange(d.types[h],b);break}(!b||
b&&!g)&&d.typeChange(d.types[f.filter(":checked").val()],b);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(b){13==b.keyCode&&(b=d.types[f.filter(":checked").val()],(!a.isFunction(b.validate)||b.validate(d.dialog.find("."+d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){B();d.visible=!1;e.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],
d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;B();var e=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(t("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(g("Added link: {{link}}",
{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);F(this.selectedElement);q();return!0},typeChange:function(b,c){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=b.ajaxUri&&!this.types[b.type].content;f&&e.addClass(this.options.baseClass+"-loading");var g=this;d.hide(this.options.panelAnimation,function(){f?a.ajax({url:b.ajaxUri,type:"get",success:function(f){d.html(f);
g.types[b.type].content=f;e.removeClass(g.options.baseClass+"-loading");b.show(d,c);d.show(g.options.panelAnimation,a.proxy(b.focus,b))}}):(d.html(b.content),b.show(d,c),d.show(g.options.panelAnimation,a.proxy(b.focus,b)))})},remove:function(){this.editor.unwrapParentTag("a")},repairLinks:function(){var b=this;this.editor.getElement().find('a[class^="'+this.options.baseClass+'"]').each(function(){a(this).data(b.options.baseClass+"-href")&&a(this).attr("href",a(this).data(b.options.baseClass+"-href"))})},
cancel:function(){this.dialog&&a(this.dialog.dialog("close"))}});a.ui.editor.registerUi({link:{hotkeys:{"ctrl+l":{action:function(){this.editor.getPlugin("link").show()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);return a.uiButton({title:g("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){M().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){M().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(b){a(M()).is("li")&&a(M()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){q();var b=[],c=[],d=i(),e=T();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();
for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),B(),b=M()[0],F(b)):(f?a(d).before(b.join("")):e?a(d).after(b.join("")):R(b.join("")),B(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(v())&&y(M());var c=a("<div>").html(v()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===m(this.tagName)?I(a(this).html(),e.validChildren):I(l(a(this)),e.validChildren);b=a("<li>"+
b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+"</"+b+">";B();var f=a(M()[0]).parent(),g=this.editor.getElement()[0];f===g||M()[0]===g?E(b):P(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));y(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=i();if(null===e||!e.length)e=
this.editor.getElement();var f=T();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),k=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(k&&l&&g){g=a(s());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],
e)&&a.contains(h[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=a.uiButton({title:g("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=a.uiButton({title:g("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",
b)});return b}}});a.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:g("Learn More About the Raptor WYSIWYG Editor"),click:function(){c.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var b=function(c){var d=typeof c;if("object"!=d||null===c)return"string"==d&&(c='"'+c+'"'),""+c;var e=[],f=c&&a.isArray(c);a.each(c,function(a,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=b(c));e.push((f?"":'"'+a+'":')+(""+
...
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){A();var b=""===d.getSelection().toHtml(),c;c=d.getSelection();var e=c.isBackwards()?c.focusNode:c.anchorNode;(c.isBackwards()?c.focusOffset:0!==
c.anchorOffset)?c=!1:(c=e.previousSibling,c=!c||""===a(c).html()?!0:!1);var f;e=d.getSelection();f=e.isBackwards()?e.anchorNode:e.focusNode;(e.isBackwards()?e.focusOffset:e.anchorOffset)!==f.textContent.length?f=!1:(e=f.nextSibling,f=!e||""===a(e).html()?!0:!1);var g=this.options.baseClass+"-enter-break",e=a(this.options.enter).attr("id",g);P(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?J(e.next()):f?J(e):(J(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&
e.remove()):(J(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){A();var b=this.options.baseClass+"-enter-break",c=a(this.shiftEnter).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?P(this.options.shiftEnter,this.options.shiftEnterValidTags):E(c);b=a("#"+b).removeAttr("id").next();J(b)},restoreSelection:!1}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
"title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var e=!1,f=!1,h=this;b.getElement().bind("paste."+b.widgetName,a.proxy(function(){if(e)return!1;e=!0;q();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),
c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=I(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var b=
null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);B();E(b);e=!1;a(this).dialog("close")}},{text:g("Cancel"),click:function(){B();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
a(this).addClass("ui-state-active").addClass("ui-tabs-selected");b.children("div").hide().eq(a(this).index()).show()});var c=f.parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){e=!1;a(this).dialog("destroy").remove()}});a(".uiWidgetEditorPasteBin").remove()},0);return!0},this))},filterAttributes:function(b){a.each([{regexp:/(<meta\s*[^>]*\s*>)|(<\s*link\s* href="file:[^>]*\s*>)|(<\/?\s*\w+:[^>]*\s*>)/gi,
...
" ")},stripAttributes:function(b){var b=a("<div/>").html(b),c=this.options.allowedAttributes;a(b.find("*")).each(function(){var b=[];a.each(this.attributes,function(d,e){-1===a.inArray(e.nodeName,c)&&b.push(e.nodeName)});for(var d=0;d<b.length;d++)a(this).attr(b[d],null)});return b.html()},stripEmpty:function(b){var b=a("<div/>").html(b),c=this.options.allowedEmptyTags;b.find("*").filter(function(){return-1!==a.inArray(this.tagName.toLowerCase(),c)||a(this).find(c.join(",")).length?!1:""===a.trim(a(this).text())}).remove();
return b.html()},updateAreas:function(b,c){var d=a(b).is("textarea")?a(b).val():a(b).html();a(b).hasClass("ui-editor-paste-plain")||c.find(".ui-editor-paste-plain").val(a("<div/>").html(d).text());a(b).hasClass("ui-editor-paste-rich")||c.find(".ui-editor-paste-rich").html(d);a(b).hasClass("ui-editor-paste-source")||c.find(".ui-editor-paste-source").html(d);a(b).hasClass("ui-editor-paste-markup")||c.find(".ui-editor-paste-markup").html(this.stripAttributes(d))}});a.ui.editor.registerPlugin("placeholder",
{init:function(b,c){c=a.extend({},{content:"[Your content here]",tag:"p",select:!0},c);this.show=function(){if(!a.trim(b.getElement().html())){var d=a(document.createElement(c.tag)).html(c.content);b.getElement().html(d);c.select&&y(d)}};b.bind("show",this.show)}});a.ui.editor.registerUi({raptorize:{init:function(a){var b=a.uiButton({title:g("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});a.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",
...
var b={},c=0;this.editor.unify(function(d){d.isDirty()&&(c++,d=d.getPlugin("saveJson"),a.extend(b,d.getData()))});this.dirty=c;this.requests=this.failed=this.saved=0;this.ajax(b)},done:function(a){this.options.multiple?this.saved++:this.saved=this.dirty;this.options.showResponse&&this.editor.showConfirm(a,{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})},fail:function(a){this.options.multiple?this.failed++:this.failed=this.dirty;this.options.showResponse&&
...
this.message.hide(),this.message=null)},ajax:function(b,c){var d=a.extend(!0,{},this.options.ajax);a.isFunction(d.data)?d.data=d.data.apply(this,[c,b]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(b));a.isFunction(d.url)&&(d.url=d.url.apply(this,[c]));this.requests++;a.ajax(d).done(a.proxy(this.done,this)).fail(a.proxy(this.fail,this)).always(a.proxy(this.always,this))}});a.ui.editor.registerPlugin("saveRest",{options:{showResponse:!1,ajax:{url:"/",type:"post",cache:!1}},
